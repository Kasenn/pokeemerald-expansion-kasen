...
+   TRAINER_PIC_NEW_ONE,
    TRAINER_PIC_COUNT,
    TRAINER_BACK_PIC_BRENDAN = TRAINER_PIC_COUNT, // The player back pics are assumed to alternate according to the gender values (MALE/FEMALE)
    TRAINER_BACK_PIC_MAY,
```
Remember to add new front pics before `TRAINER_PIC_COUNT`!
