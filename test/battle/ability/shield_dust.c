...
SINGLE_BATTLE_TEST("Shield Dust blocks secondary effects")
{
    ...
    GIVEN {
        ...
        HP_BAR(opponent);
        NONE_OF {
            MESSAGE("The foe Vivillon is paralyzed! It may be unable to move!");
            MESSAGE("The foe Vivillon was burned!");
            MESSAGE("The foe Vivillon was poisoned!");
            MESSAGE("The foe Vivillon flinched!");
            ANIMATION(ANIM_TYPE_GENERAL, B_ANIM_STATS_CHANGE, opponent);
            MESSAGE("The foe Vivillon was prevented from healing!");
        }
    ...
    GIVEN {
        ...
        switch (move)
        {
            case MOVE_INFESTATION:
                MESSAGE("The foe Vivillon has been afflicted with an infestation!");
                break;
            case MOVE_THOUSAND_ARROWS:
                MESSAGE("The foe Vivillon fell straight down!");
                break;
            case MOVE_JAW_LOCK:
...
DOUBLE_BATTLE_TEST("Shield Dust does or does not block Sparkling Aria depending on number of targets hit")
{
    ...
    GIVEN {
        ...
        if (moveToUse == MOVE_SCRATCH) {
            MESSAGE("The foe Vivillon's burn was healed!");
