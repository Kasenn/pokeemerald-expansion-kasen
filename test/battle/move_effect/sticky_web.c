...
DOUBLE_BATTLE_TEST("Sticky Web has correct interactions with Mirror Armor - the battler which set up Sticky Web has its Speed lowered instead")
{
    ...
    GIVEN {
        ...
        MESSAGE("A sticky web spreads out all around your team's feet!");
        ...
        if (opponentSetUpper == 0) {
            MESSAGE("The foe Caterpie's Speed fell!");
            NONE_OF {
                MESSAGE("The foe Caterpie was caught in a Sticky Web!");
            }
        } else {
            MESSAGE("The foe Weedle's Speed fell!");
            NONE_OF {
                MESSAGE("The foe Weedle was caught in a Sticky Web!");
            }
        }
    }
}
...
DOUBLE_BATTLE_TEST("Sticky Web setter has their speed lowered with Mirror Armor even after Ally Switch")
{
    GIVEN {
        ...
        MESSAGE("A sticky web spreads out all around your team's feet!");
        // Turn 2 - ally switch
        MESSAGE("The foe Natu used Ally Switch!");
