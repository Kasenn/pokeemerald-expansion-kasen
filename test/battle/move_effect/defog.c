...
SINGLE_BATTLE_TEST("Defog lowers evasiveness by 1 stage")
{
    GIVEN {
        ...
        MESSAGE("The foe Wobbuffet's evasiveness fell!");
    }
}
...
DOUBLE_BATTLE_TEST("Defog removes Reflect and Light Screen from target's side", s16 damagePhysical, s16 damageSpecial)
{
    ...
    GIVEN {
        ...
        if (move == MOVE_DEFOG) {
            MESSAGE("The foe's Reflect wore off!");
            MESSAGE("The foe's Light Screen wore off!");
        }
...
DOUBLE_BATTLE_TEST("Defog removes Mist and Safeguard from target's side")
{
    ...
    GIVEN {
        ...
        if (move == MOVE_DEFOG) {
            ...
            MESSAGE("The foe's Safeguard wore off!");
        }
        ...
        if (move == MOVE_DEFOG) {
            ...
            MESSAGE("The foe Wobbuffet is protected by mist!");
        ...
        if (move == MOVE_DEFOG) {
            ...
            MESSAGE("The foe's team is protected by Safeguard!");
...
DOUBLE_BATTLE_TEST("Defog removes Aurora Veil from target's side", s16 damagePhysical, s16 damageSpecial)
{
    ...
    GIVEN {
        ...
        MESSAGE("The foe Glalie used Scratch!");
        HP_BAR(playerLeft, captureDamage: &results[i].damagePhysical);
        MESSAGE("The foe Glalie used Gust!");
...
DOUBLE_BATTLE_TEST("Defog removes everything it can")
{
    GIVEN {
        ...
        MESSAGE("The foe Glalie used Defog!");
