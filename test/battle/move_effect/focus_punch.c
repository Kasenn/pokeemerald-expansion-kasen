...
DOUBLE_BATTLE_TEST("Focus Punch activation is based on Speed")
{
    ...
    SCENE {
        ...
        MESSAGE("The foe Wynaut is tightening its focus!");
        ...
        MESSAGE("The foe Wobbuffet is tightening its focus!");

        MESSAGE("The foe Wynaut used Focus Punch!");
        ...
        MESSAGE("Wobbuffet lost its focus and couldn't move!");
        MESSAGE("The foe Wobbuffet lost its focus and couldn't move!");
    }
}
