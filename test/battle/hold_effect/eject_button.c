...
SINGLE_BATTLE_TEST("Eject Button will not activate under Substitute")
{
    GIVEN {
        ...
        MESSAGE("The foe Raichu put in a substitute!");
        ANIMATION(ANIM_TYPE_MOVE, MOVE_SCRATCH, player);
        MESSAGE("The substitute took damage for the foe Raichu!");
        NONE_OF {
            ANIMATION(ANIM_TYPE_GENERAL, B_ANIM_HELD_ITEM_EFFECT, opponent);
            MESSAGE("The foe Raichu is switched out with the Eject Button!");
        }
    }
}
...
SINGLE_BATTLE_TEST("Eject Button is not triggered after given to player by Picketpocket")
{
    GIVEN {
        ...
        MESSAGE("The foe Sneasel stole Regieleki's Eject Button!");
        ANIMATION(ANIM_TYPE_MOVE, MOVE_SCRATCH, opponent);
    }
}
...
SINGLE_BATTLE_TEST("Eject Button has no chance to activate after Dragon Tail")
{
    GIVEN {
        ...
        MESSAGE("The foe Chansey was dragged out!");
        NONE_OF {
            ANIMATION(ANIM_TYPE_GENERAL, B_ANIM_HELD_ITEM_EFFECT, opponent);
            MESSAGE("The foe Chansey is switched out with the Eject Button!");
        }
    }
}
...
SINGLE_BATTLE_TEST("Eject Button is activated before Emergency Exit")
{
    GIVEN {
        ...
        ANIMATION(ANIM_TYPE_GENERAL, B_ANIM_HELD_ITEM_EFFECT, opponent);
        MESSAGE("The foe Golisopod is switched out with the Eject Button!");
    }
}
...
SINGLE_BATTLE_TEST("Eject Button is not triggered after High Jump Kick crash damage")
{
    GIVEN {
        ...
        MESSAGE("The foe Wobbuffet kept going and crashed!");
        NONE_OF {
            ANIMATION(ANIM_TYPE_GENERAL, B_ANIM_HELD_ITEM_EFFECT, opponent);
            MESSAGE("The foe Wobbuffet is switched out with the Eject Button!");
        }
