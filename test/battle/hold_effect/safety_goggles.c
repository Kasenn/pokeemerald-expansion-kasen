...
SINGLE_BATTLE_TEST("Safety Goggles block powder and spore moves")
{
    GIVEN {
        ...
        MESSAGE("The foe Abra is not affected thanks to its Safety Goggles!");
    }
}
...
SINGLE_BATTLE_TEST("Safety Goggles blocks damage from Hail")
{
    GIVEN {
        ...
        NOT MESSAGE("The foe Wobbuffet is pelted by hail!");
    }
}
...
SINGLE_BATTLE_TEST("Safety Goggles blocks damage from Sandstorm")
{
    GIVEN {
        ...
        NOT MESSAGE("The foe Wobbuffet is buffeted by the sandstorm!");
    }
}
...
SINGLE_BATTLE_TEST("Safety Goggles blocks Effect Spore's effect")
{
    ...
    GIVEN {
        ...
        NONE_OF {
            ...
            MESSAGE("Wobbuffet was poisoned by the foe Breloom's Effect Spore!");
            STATUS_ICON(player, poison: TRUE);

            ANIMATION(ANIM_TYPE_STATUS, B_ANIM_STATUS_PRZ, player);
            MESSAGE("The foe Breloom's Effect Spore paralyzed Wobbuffet! It may be unable to move!");
            STATUS_ICON(player, paralysis: TRUE);

            ANIMATION(ANIM_TYPE_STATUS, B_ANIM_STATUS_SLP, player);
            MESSAGE("The foe Breloom's Effect Spore made Wobbuffet sleep!");
