...
DOUBLE_BATTLE_TEST("Expansion Ability Shield prevents Receiver/Power of Alchemy holder from copying ally's ability")
{
    u32 species;
    enum Ability ability;
...
DOUBLE_BATTLE_TEST("Expansion Ability Shield on fainted ally does not block Receiver/Power of Alchemy")
{
    u32 species;
    enum Ability ability;
