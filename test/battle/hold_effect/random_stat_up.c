...
SINGLE_BATTLE_TEST("Starf Berry randomly raises the holder's Attack, Defense, Sp. Atk, Sp. Def, or Speed by two stages2")
{
    ...
    GIVEN {
        ...
        MESSAGE("The Starf Berry sharply raised Wobbuffet's Attack!");
    } THEN {
