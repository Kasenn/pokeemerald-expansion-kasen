...
SINGLE_BATTLE_TEST("Syrup Bomb covers the the foe in sticky syrup for 3 turns")
{
    u8 j;
...
SINGLE_BATTLE_TEST("Sticky Syrup isn't applied again if the target is already covered")
{
    GIVEN {
        ...
        ANIMATION(ANIM_TYPE_MOVE, MOVE_SYRUP_BOMB, player);
        HP_BAR(opponent);
        NOT MESSAGE("The foe Wobbuffet got covered in sticky candy syrup!");
    }
}
...
SINGLE_BATTLE_TEST("Syrup Bomb is prevented by Bulletproof")
{
    GIVEN {
        ...
        MESSAGE("The foe Chespin's Bulletproof blocks Syrup Bomb!");
        NONE_OF {
            ANIMATION(ANIM_TYPE_MOVE, MOVE_SYRUP_BOMB, player);
            HP_BAR(opponent);
        }
...
SINGLE_BATTLE_TEST("Sticky syrup will not decrease speed further then minus six")
{
    ...
    GIVEN {
        ...
        MESSAGE("The foe Wobbuffet got covered in sticky candy syrup!");
        ANIMATION(ANIM_TYPE_GENERAL, B_ANIM_SYRUP_BOMB_SPEED_DROP, opponent);
        MESSAGE("The foe Wobbuffet's Speed won't go any lower!");
        NONE_OF {
            MESSAGE("The foe Wobbuffet's Speed fell!");
        }
    }
