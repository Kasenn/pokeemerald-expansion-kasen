...
SINGLE_BATTLE_TEST("Sandstorm damage does not hurt Ground, Rock, and Steel-type Pokémon")
{
    ...
    GIVEN {
        ...
        case SPECIES_SANDSLASH:
            NOT MESSAGE("The foe Sandslash is buffeted by the sandstorm!");
            break;
        case SPECIES_NOSEPASS:
            NOT MESSAGE("The foe Nosepass is buffeted by the sandstorm!");
            break;
        case SPECIES_REGISTEEL:
            NOT MESSAGE("The foe Registeel is buffeted by the sandstorm!");
            break;
        }
    }
}
