...
{
    u32 offspring = 0, species1 = 0, item1 = 0, species2 = 0, item2 = 0;

    ZeroPlayerPartyMons();

    PARAMETRIZE { offspring=SPECIES_MEOWTH;          species1=SPECIES_MEOWTH;           item1=ITEM_NONE;      species2=SPECIES_MEOWTH_OUTSIDER,  item2=ITEM_NONE;      }
    PARAMETRIZE { offspring=SPECIES_MEOWTH_OUTSIDER; species1=SPECIES_MEOWTH;           item1=ITEM_NONE;      species2=SPECIES_MEOWTH_OUTSIDER,  item2=ITEM_EVERSTONE; }
    ...
    PARAMETRIZE { offspring=SPECIES_MEOWTH;          species1=SPECIES_PERSIAN_OUTSIDER; item1=ITEM_EVERSTONE; species2=SPECIES_PERSIAN,          item2=ITEM_EVERSTONE; }
    ...
    PARAMETRIZE { offspring=SPECIES_WOOPER;          species1=SPECIES_WOOPER;           item1=ITEM_NONE;      species2=SPECIES_WOOPER_OUTSIDER,  item2=ITEM_NONE;      }
    PARAMETRIZE { offspring=SPECIES_WOOPER;          species1=SPECIES_WOOPER;           item1=ITEM_EVERSTONE; species2=SPECIES_WOOPER_OUTSIDER,  item2=ITEM_NONE;      }
    PARAMETRIZE { offspring=SPECIES_WOOPER_OUTSIDER; species1=SPECIES_WOOPER;           item1=ITEM_NONE;      species2=SPECIES_WOOPER_OUTSIDER,  item2=ITEM_EVERSTONE; }
    PARAMETRIZE { offspring=SPECIES_WOOPER_OUTSIDER; species1=SPECIES_CLODSIRE;         item1=ITEM_EVERSTONE; species2=SPECIES_QUAGSIRE,         item2=ITEM_EVERSTONE; }
