...
{
    [MAPSEC_LITTLEROOT_TOWN] = {MAP_GROUP(PEARLWOOD_POINT), MAP_NUM(PEARLWOOD_POINT), HEAL_LOCATION_PEARLWOOD_POINT},
    [MAPSEC_OLDALE_TOWN] = {MAP_GROUP(PRIMROSE_TOWN), MAP_NUM(PRIMROSE_TOWN), HEAL_LOCATION_PRIMROSE_TOWN},
    ...
    [MAPSEC_RUSTBORO_CITY] = {MAP_GROUP(CORALGROVE_CITY), MAP_NUM(CORALGROVE_CITY), HEAL_LOCATION_CORALGROVE_CITY},
    [MAPSEC_ALDELEAF_CITY] = {MAP_GROUP(WIP_CITY1), MAP_NUM(WIP_CITY1), HEAL_LOCATION_ALDELEAF_CITY},
    [MAPSEC_SHORESLATE_CITY] = {MAP_GROUP(SHORESLATE_CITY), MAP_NUM(SHORESLATE_CITY), HEAL_LOCATION_SHORESLATE_CITY},
    [MAPSEC_SKYLOCH_VILLAGE] = {MAP_GROUP(SHORESLATE_CITY), MAP_NUM(SHORESLATE_CITY), HEAL_LOCATION_SKYLOCH_VILLAGE},
    [MAPSEC_MARIGORGE_TOWN] = {MAP_GROUP(MARIGORGE_TOWN), MAP_NUM(MARIGORGE_TOWN), HEAL_LOCATION_MARIGORGE_TOWN},
    [MAPSEC_KAOLISLE_CITY] = {MAP_GROUP(KAOLISLE_CITY), MAP_NUM(KAOLISLE_CITY), HEAL_LOCATION_KAOLISLE_CITY},
    ...
    [MAPSEC_FROSTFIRE_CITY] = {MAP_GROUP(FROSTFIRE_CITY), MAP_NUM(FROSTFIRE_CITY), HEAL_LOCATION_FROSTFIRE_CITY},
    [MAPSEC_CRYSTALPINE_TOWN] = {MAP_GROUP(CRYSTALPINE_TWON), MAP_NUM(CRYSTALPINE_TWON), HEAL_LOCATION_CRYSTALPINE_TWON},
    ...
    [MAPSEC_PEARLWOOD_POINT] = {MAP_GROUP(PEARLWOOD_POINT), MAP_NUM(PEARLWOOD_POINT), HEAL_LOCATION_PEARLWOOD_POINT},
    [MAPSEC_AZURETIDE_TOWN] = {MAP_GROUP(COAST_TOWN), MAP_NUM(COAST_TOWN), HEAL_LOCATION_COAST_TOWN},
    ...
    [MAPSEC_SINKO_ROUTE_1] = {MAP_GROUP(ROUTE101), MAP_NUM(ROUTE101), HEAL_LOCATION_NONE},
    [MAPSEC_PRIMROSE_MEADOW] = {MAP_GROUP(ROUTE102), MAP_NUM(ROUTE102), HEAL_LOCATION_NONE},
    // [MAPSEC_SINKO_ROUTE_2] = {MAP_GROUP(ROUTE103), MAP_NUM(ROUTE103), HEAL_LOCATION_NONE},
