...
static const u32 sRegionMapBg_TilemapLZEmpty[] = INCGFX_U32("graphics/pokenav/region_map/map_empty.bin", ".smolTM");
...
static const mapsec_u16_t sRegionMap_SpecialPlaceLocations[][2] =
{
    ...
    {MAPSEC_HIDDENGROTTO_ROUTE21,           MAPSEC_SINKO_ROUTE_21},
...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_PROF_GLADE] = {MAP_GROUP(MAP_PALLET_TOWN), MAP_NUM(MAP_PALLET_TOWN), HEAL_LOCATION_NONE},
