...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_CITY_WIP2] = {MAP_GROUP(SHORESLATE_CITY), MAP_NUM(SHORESLATE_CITY), HEAL_LOCATION_SHORESLATE_CITY},
    ...
    [MAPSEC_SHORESLATE_CITY] = {MAP_GROUP(TOWN_WIP2), MAP_NUM(TOWN_WIP2), HEAL_LOCATION_SHORESLATE_CITY},
