...
static const mapsec_u16_t sRegionMap_SpecialPlaceLocations[][2] =
{
    ...
    {MAPSEC_POKE_RANCH,                 MAPSEC_SINKO_ROUTE_4},
    {MAPSEC_BASALEK_TUNNELS,                 MAPSEC_BASALEK_TOWN},
    {MAPSEC_SUNKEN_CAVERN,                 MAPSEC_SINKO_ROUTE_14},
    {MAPSEC_HOUNDOOM_CAVE,              MAPSEC_DESERT},
    {MAPSEC_FLOWER_FIELDS,              MAPSEC_SINKO_ROUTE_5},
    {MAPSEC_DESERT_CLIFFS,              MAPSEC_SINKO_ROUTE_6},
    {MAPSEC_HIDDEN_CLEARING,              MAPSEC_SINKO_ROUTE_12},
    {MAPSEC_SNOWY_RIDGE,              MAPSEC_SINKO_ROUTE_18},
    {MAPSEC_BERRY_FIELDS,                 MAPSEC_SINKO_ROUTE_15},
    {MAPSEC_SERPENT_CAVE,                 MAPSEC_SINKO_ROUTE_10},
    {MAPSEC_WINDPLUME_MOUNTAIN,                 MAPSEC_WINDPLUME_VALLEY},
    {MAPSEC_KAOLISLE_MINES,             MAPSEC_KAOLISLE_CITY},
    {MAPSEC_FLOODED_CAVES,             MAPSEC_SINKO_ROUTE_12},
    {MAPSEC_WEIRDCAVE,                  MAPSEC_SINKO_ROUTE_6},
    {MAPSEC_PETALBURG_WOODS2,                 MAPSEC_PETALBURG_WOODS},
    {MAPSEC_UNDERWATER_SEALED_CHAMBER,  MAPSEC_ROUTE_134},
    {MAPSEC_HIDDENGROTTO_WW,              MAPSEC_SINKO_ROUTE_2},
    {MAPSEC_WINDPLUME_VALLEY,                MAPSEC_SINKO_ROUTE_30},
    {MAPSEC_JAGGED_PASS,                MAPSEC_ROUTE_112},
    {MAPSEC_HIDDENGROTTO_ROUTE7,              MAPSEC_SINKO_ROUTE_8},
    {MAPSEC_HIDDENGROTTO_AZURETIDE,     MAPSEC_AZURETIDE_TOWN},
    {MAPSEC_HIDDENGROTTO_ROUTE15,      MAPSEC_SINKO_ROUTE_15},
    ...
    {MAPSEC_DESERT_RUINS,               MAPSEC_DESERT},
    {MAPSEC_ALTERING_CAVE,              MAPSEC_SINKO_ROUTE_2},
    {MAPSEC_ARTISAN_CAVE,               MAPSEC_SINKO_ROUTE_2},
    {MAPSEC_HIDDENGROTTO_ROUTE14,             MAPSEC_SINKO_ROUTE_14},
...
{
    [MAPSEC_LITTLEROOT_TOWN] = {MAP_GROUP(MAP_PEARLWOOD_POINT), MAP_NUM(MAP_PEARLWOOD_POINT), HEAL_LOCATION_PEARLWOOD_POINT},
    [MAPSEC_OLDALE_TOWN] = {MAP_GROUP(MAP_PRIMROSE_TOWN), MAP_NUM(MAP_PRIMROSE_TOWN), HEAL_LOCATION_PRIMROSE_TOWN},
    ...
    [MAPSEC_RUSTBORO_CITY] = {MAP_GROUP(MAP_CORALGROVE_CITY), MAP_NUM(MAP_CORALGROVE_CITY), HEAL_LOCATION_CORALGROVE_CITY},
    [MAPSEC_ALDELEAF_CITY] = {MAP_GROUP(MAP_WIP_CITY1), MAP_NUM(MAP_WIP_CITY1), HEAL_LOCATION_ALDELEAF_CITY},
    [MAPSEC_SHORESLATE_CITY] = {MAP_GROUP(MAP_SHORESLATE_CITY), MAP_NUM(MAP_SHORESLATE_CITY), HEAL_LOCATION_SHORESLATE_CITY},
    [MAPSEC_SKYLOCH_VILLAGE] = {MAP_GROUP(MAP_SHORESLATE_CITY), MAP_NUM(MAP_SHORESLATE_CITY), HEAL_LOCATION_SKYLOCH_VILLAGE},
    [MAPSEC_MARIGORGE_TOWN] = {MAP_GROUP(MAP_MARIGORGE_TOWN), MAP_NUM(MAP_MARIGORGE_TOWN), HEAL_LOCATION_MARIGORGE_TOWN},
    [MAPSEC_KAOLISLE_CITY] = {MAP_GROUP(MAP_KAOLISLE_CITY), MAP_NUM(MAP_KAOLISLE_CITY), HEAL_LOCATION_KAOLISLE_CITY},
    [MAPSEC_TOWN_WIP6] = {MAP_GROUP(MAP_FISHING_VILLAGE), MAP_NUM(MAP_FISHING_VILLAGE), HEAL_LOCATION_FISHING_VILLAGE},
    [MAPSEC_TOWN_WIP9] = {MAP_GROUP(MAP_DRISLEDGE_TOWN), MAP_NUM(MAP_DRISLEDGE_TOWN), HEAL_LOCATION_DRISLEDGE_TOWN},
    [MAPSEC_TOWN_WIP5] = {MAP_GROUP(MAP_AMBEROCK_TOWN), MAP_NUM(MAP_AMBEROCK_TOWN), HEAL_LOCATION_AMBEROCK_TOWN},
    [MAPSEC_BASALEK_TOWN] = {MAP_GROUP(MAP_BASALUFF_TOWN), MAP_NUM(MAP_BASALUFF_TOWN), HEAL_LOCATION_BASALUFF_TOWN},
    [MAPSEC_ROCKLIFFE_TOWN] = {MAP_GROUP(MAP_ROCKLIFFE_TOWN), MAP_NUM(MAP_ROCKLIFFE_TOWN), HEAL_LOCATION_ROCKLIFFE_TOWN},
    [MAPSEC_FROSTFIRE_CITY] = {MAP_GROUP(MAP_FROSTFIRE_CITY), MAP_NUM(MAP_FROSTFIRE_CITY), HEAL_LOCATION_FROSTFIRE_CITY},
    [MAPSEC_CRYSTALPINE_TOWN] = {MAP_GROUP(MAP_CRYSTALPINE_TWON), MAP_NUM(MAP_CRYSTALPINE_TWON), HEAL_LOCATION_CRYSTALPINE_TWON},
    [MAPSEC_SANDSTONE_CITY] = {MAP_GROUP(MAP_SANDSTONE_CITY), MAP_NUM(MAP_SANDSTONE_CITY), HEAL_LOCATION_SANDSTONE_CITY},
    ...
    [MAPSEC_PEARLWOOD_POINT] = {MAP_GROUP(MAP_PEARLWOOD_POINT), MAP_NUM(MAP_PEARLWOOD_POINT), HEAL_LOCATION_PEARLWOOD_POINT},
    [MAPSEC_AZURETIDE_TOWN] = {MAP_GROUP(MAP_COAST_TOWN), MAP_NUM(MAP_COAST_TOWN), HEAL_LOCATION_COAST_TOWN},
    ...
    [MAPSEC_SINKO_ROUTE_1] = {MAP_GROUP(MAP_ROUTE101), MAP_NUM(MAP_ROUTE101), HEAL_LOCATION_NONE},
    ...
    [MAPSEC_PALLET_TOWN] = {MAP_GROUP(MAP_PALLET_TOWN), MAP_NUM(MAP_PALLET_TOWN), 0},
    [MAPSEC_VIRIDIAN_CITY] = {MAP_GROUP(MAP_VIRIDIAN_CITY), MAP_NUM(MAP_VIRIDIAN_CITY), 0},
    [MAPSEC_PEWTER_CITY] = {MAP_GROUP(MAP_PEWTER_CITY), MAP_NUM(MAP_PEWTER_CITY), 0},
    [MAPSEC_CERULEAN_CITY] = {MAP_GROUP(MAP_CERULEAN_CITY), MAP_NUM(MAP_CERULEAN_CITY), 0},
    [MAPSEC_LAVENDER_TOWN] = {MAP_GROUP(MAP_LAVENDER_TOWN), MAP_NUM(MAP_LAVENDER_TOWN), 0},
    [MAPSEC_VERMILION_CITY] = {MAP_GROUP(MAP_VERMILION_CITY), MAP_NUM(MAP_VERMILION_CITY), 0},
    [MAPSEC_CELADON_CITY] = {MAP_GROUP(MAP_CELADON_CITY), MAP_NUM(MAP_CELADON_CITY), 0},
    [MAPSEC_FUCHSIA_CITY] = {MAP_GROUP(MAP_FUCHSIA_CITY), MAP_NUM(MAP_FUCHSIA_CITY), 0},
    [MAPSEC_CINNABAR_ISLAND] = {MAP_GROUP(MAP_CINNABAR_ISLAND), MAP_NUM(MAP_CINNABAR_ISLAND), 0},
    [MAPSEC_INDIGO_PLATEAU] = {MAP_GROUP(MAP_INDIGO_PLATEAU_EXTERIOR), MAP_NUM(MAP_INDIGO_PLATEAU_EXTERIOR), 0},
    [MAPSEC_SAFFRON_CITY] = {MAP_GROUP(MAP_SAFFRON_CITY), MAP_NUM(MAP_SAFFRON_CITY), 0},
    [MAPSEC_ROUTE_4_POKECENTER] = {MAP_GROUP(MAP_ROUTE4), MAP_NUM(MAP_ROUTE4), 0},
    [MAPSEC_ROUTE_10_POKECENTER] = {MAP_GROUP(MAP_ROUTE10), MAP_NUM(MAP_ROUTE10), 0},
...
static void  RegionMap_InitializeStateBasedOnSSTidalLocation(void)
{
    ...
    sRegionMap->playerIsInCave = FALSE;
    sRegionMap->cursorPosX = 14 + MAPCURSOR_X_MIN;
    sRegionMap->cursorPosY = 7 + MAPCURSOR_Y_MIN;
}
...
static void DrawFlyDestTextWindow(void)
{
    ...
    if (gOnLatiIslands && !gOpenedMapFromItem)
    {
        ...
        // if (sFlyMap->regionMap.mapSecId == MAPSEC_DESERT)
            AddTextPrinterParameterized(WIN_MAPSEC_NAME, FONT_NORMAL, COMPOUND_STRING("BACK TO SURFACE"), 0, 1, 0, NULL);
        else
            AddTextPrinterParameterized(WIN_MAPSEC_NAME, FONT_NORMAL, COMPOUND_STRING("UNKNOWN AREA"), 0, 1, 0, NULL);
    }
    else if (sFlyMap->regionMap.mapSecType > MAPSECTYPE_NONE && sFlyMap->regionMap.mapSecType < NUM_MAPSEC_TYPES)
    {
        namePrinted = FALSE;
...
static const struct FlyLocation sFlyLocations[] =
{
    ...
    },
    {
        ...
        .flag = FLAG_VISITED_PRIMROSE_TOWN,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
    ...
    },
    {
        ...
        .flag = FLAG_VISITED_CORALGROVE_CITY,
    },
    {
        .regionMapType = REGION_MAP_HOENN,
...
static void TryCreateRedOutlineFlyDestIcons(void)
{
    ...
    u16 width;
    u16 height;
    u16 mapSecId = MAPSEC_DESERT;
    u8 spriteId;

    GetMapSecDimensions(MAPSEC_DESERT, &x, &y, &width, &height);
