...
static const u16 sRegionMap_SpecialPlaceLocations[][2] =
{
    ...
    {MAPSEC_PETALBURG_WOODS,                 MAPSEC_ROUTE_103},
    {MAPSEC_PETALBURG_WOODS2,                 MAPSEC_ROUTE_103},
    {MAPSEC_UNDERWATER_SEALED_CHAMBER,  MAPSEC_ROUTE_134},
    {MAPSEC_HIDDEN_GROTTO,              MAPSEC_ROUTE_103},
...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_CITY_WIP1] = {MAP_GROUP(WIP_CITY1), MAP_NUM(WIP_CITY1), HEAL_LOCATION_ALDELEAF_CITY},
    [MAPSEC_SHORESLATE_CITY] = {MAP_GROUP(SHORESLATE_CITY), MAP_NUM(SHORESLATE_CITY), HEAL_LOCATION_SHORESLATE_CITY},
    [MAPSEC_TOWN_WIP2] = {MAP_GROUP(SHORESLATE_CITY), MAP_NUM(SHORESLATE_CITY), HEAL_LOCATION_TOWN_WIP2},
    [MAPSEC_TOWN_WIP3] = {MAP_GROUP(MARIGORGE_TOWN), MAP_NUM(MARIGORGE_TOWN), HEAL_LOCATION_MARIGORGE_TOWN},
    [MAPSEC_CITY_WIP2] = {MAP_GROUP(KAOLISLE_CITY), MAP_NUM(KAOLISLE_CITY), HEAL_LOCATION_KAOLISLE_CITY},
    ...
    [MAPSEC_TOWN_WIP1] = {MAP_GROUP(COAST_TOWN), MAP_NUM(COAST_TOWN), HEAL_LOCATION_COAST_TOWN},
