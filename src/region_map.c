...
{
    [MAPSEC_LITTLEROOT_TOWN] = {MAP_GROUP(PEARLWOOD_POINT), MAP_NUM(PEARLWOOD_POINT), HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE_2F},
    ...
    [MAPSEC_PEARLWOOD_POINT] = {MAP_GROUP(PEARLWOOD_POINT), MAP_NUM(PEARLWOOD_POINT), HEAL_LOCATION_PLAYER_HOUSE2F},
};
