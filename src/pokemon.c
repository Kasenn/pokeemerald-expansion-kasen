...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_DECIDUEYE_MEGA - 1] = NATIONAL_DEX_DECIDUEYE,
...
const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_DECIDUEYE_MEGA -1] = ANIM_H_VIBRATE,
    [SPECIES_EMPOLEON_MEGA -1]  = ANIM_V_STRETCH,
    [SPECIES_CHESNAUGHT_MEGA -1] = ANIM_GROW_IN_STAGES,
    [SPECIES_INCINEROAR_MEGA -1] = ANIM_V_SHAKE,
    ...
    [SPECIES_EXPBOT - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_HPBOT - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ATKBOT - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DEFBOT - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SPATKBOT - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SPDEFBOT - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_SPEEDBOT - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
