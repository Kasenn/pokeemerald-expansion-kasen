...
{
    [BATTLE_ENVIRONMENT_LONG_GRASS_AUTUMN] = BattleIntroSlide1,
    [BATTLE_ENVIRONMENT_MUD]        = BattleIntroSlide3,
    [BATTLE_ENVIRONMENT_SNOW]       = BattleIntroSlide2,
...
static void BattleIntroSlide1(u8 taskId)
{
    ...
    case 3:
        ...
        {
            if (gTasks[taskId].tEnvironment == BATTLE_ENVIRONMENT_LONG_GRASS || gTasks[taskId].tTerrain == BATTLE_ENVIRONMENT_LONG_GRASS_AUTUMN)
            {
