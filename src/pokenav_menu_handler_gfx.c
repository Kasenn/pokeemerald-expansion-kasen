...
{
    [POKENAV_MENUITEM_MAP]                     = COMPOUND_STRING("Check Pokémon in detail."),
    [POKENAV_MENUITEM_CONDITION]               = COMPOUND_STRING("Check obtained Ribbons."),
    [POKENAV_MENUITEM_MATCH_CALL]              = COMPOUND_STRING("Call a registered TRAINER."),
    [POKENAV_MENUITEM_RIBBONS]                 = COMPOUND_STRING("."),
    ...
    [POKENAV_MENUITEM_CONDITION_CANCEL]        = COMPOUND_STRING("Return to the previous menu."),
