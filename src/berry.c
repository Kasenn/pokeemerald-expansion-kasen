...
const struct Berry gBerries[NUM_BERRIES + 1] =
{
    ...
    [BERRY_ID_RAZZ] =
    {
        .info = {
            ...
            .color = BERRY_COLOR_RED,
            .size = 120,
            .maxYield = YIELD_RATE(3, 10, 15, 20),
            .minYield = YIELD_RATE(2, 2, 3, 4),
    ...
    [BERRY_ID_ROSTE] =
    {
        .info = {
            ...
            .minYield = YIELD_RATE(2, 2, 2, 2),
            .description1 = COMPOUND_STRING("A rejuvenating and delicious Berry"),
            .description2 = COMPOUND_STRING("that causes sleepiness when ingested."),
            .growthDuration = GROWTH_DURATION(16, 16, 24, 24, 16, 24),
            .spicy = 0,
            .dry = 0,
            .sweet = 30,
        ...
        .berryCrushDifficulty = 80,
        .berryCrushPowder = 70,
        .berryPic = gBerryPic_Roste,
        .berryPal = gBerryPalette_Roste,
        .berryTreePicTable = gPicTable_RosteBerryTree,
        .berryTreePaletteSlotTable = gBerryTreePaletteSlotTable_Roste,
    },
};
