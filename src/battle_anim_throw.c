...
#define TAG_PARTICLES_DIRE_BALL    65058
...
static const struct PokeBallParticles sBallParticles[POKEBALL_COUNT] =
{
    ...
    [BALL_DIRE] =
    {
        POKE_BALL_ANIMATION(TAG_PARTICLES_DIRE_BALL, gBattleAnimSpriteGfx_Particles, gBattleAnimSpritePal_CircleImpact),
        .openFadeColor = RGB(28, 4, 0),
        .animNums = 5,
        .particleAnimationFunc = UltraBallOpenParticleAnimation,
    },
};
