...
static const struct MatchCallStructTrainer sNormanMatchCallHeader =
{
    ...
    .textData = (const match_call_text_data_t[]) {
        ...
        { MatchCall_Text_Norman5,                  FLAG_OLD_WORLD_FLAG, NO_FLAG_TO_SET },
...
static const struct MatchCallStructNPC sStevenMatchCallHeader =
{
    ...
    .textData = (const match_call_text_data_t[]) {
        ...
        { MatchCall_Text_Steven2, FLAG_OLD_WORLD_FLAG,          NO_FLAG_TO_SET },
        { MatchCall_Text_Steven3, FLAG_OLD_WORLD_FLAG,       NO_FLAG_TO_SET },
        { MatchCall_Text_Steven4, FLAG_OLD_WORLD_FLAG, NO_FLAG_TO_SET },
        { MatchCall_Text_Steven5, FLAG_DEFEATED_MOSSDEEP_GYM,          NO_FLAG_TO_SET },
        { MatchCall_Text_Steven6, FLAG_OLD_WORLD_FLAG, NO_FLAG_TO_SET },
...
static const struct MatchCallRival sMayMatchCallHeader =
{
    ...
    .textData = (const match_call_text_data_t[]) {
        ...
        { MatchCall_Text_May3,  FLAG_OLD_WORLD_FLAG,          NO_FLAG_TO_SET },
        ...
        { MatchCall_Text_May8,  FLAG_OLD_WORLD_FLAG,              NO_FLAG_TO_SET },
        { MatchCall_Text_May9,  FLAG_OLD_WORLD_FLAG,       NO_FLAG_TO_SET },
        { MatchCall_Text_May10, FLAG_OLD_WORLD_FLAG, NO_FLAG_TO_SET },
        { MatchCall_Text_May11, ALWAYS_AVAILABLE,           NO_FLAG_TO_SET },
        { MatchCall_Text_May12, FLAG_OLD_WORLD_FLAG, NO_FLAG_TO_SET },
        { MatchCall_Text_May13, FLAG_OLD_WORLD_FLAG, NO_FLAG_TO_SET },
...
static const struct MatchCallRival sBrendanMatchCallHeader =
{
    ...
    .textData = (const match_call_text_data_t[]) {
        ...
        { MatchCall_Text_Brendan3,  FLAG_OLD_WORLD_FLAG,          NO_FLAG_TO_SET },
        ...
        { MatchCall_Text_Brendan8,  FLAG_OLD_WORLD_FLAG,              NO_FLAG_TO_SET },
        { MatchCall_Text_Brendan9,  FLAG_OLD_WORLD_FLAG,       NO_FLAG_TO_SET },
        { MatchCall_Text_Brendan10, FLAG_OLD_WORLD_FLAG, NO_FLAG_TO_SET },
        { MatchCall_Text_Brendan11, ALWAYS_AVAILABLE,           NO_FLAG_TO_SET },
        { MatchCall_Text_Brendan12, FLAG_OLD_WORLD_FLAG, NO_FLAG_TO_SET },
        { MatchCall_Text_Brendan13, FLAG_OLD_WORLD_FLAG, NO_FLAG_TO_SET },
...
static const struct MatchCallWally sWallyMatchCallHeader =
{
    ...
    .textData = (const match_call_text_data_t[]) {
        ...
        { MatchCall_Text_Wally2, FLAG_OLD_WORLD_FLAG,          NO_FLAG_TO_SET },
        { MatchCall_Text_Wally3, FLAG_DEFEATED_LAVARIDGE_GYM,         NO_FLAG_TO_SET },
        { MatchCall_Text_Wally4, FLAG_OLD_WORLD_FLAG,              NO_FLAG_TO_SET },
        { MatchCall_Text_Wally5, FLAG_OLD_WORLD_FLAG, NO_FLAG_TO_SET },
        { MatchCall_Text_Wally6, FLAG_OLD_WORLD_FLAG, NO_FLAG_TO_SET },
        { MatchCall_Text_Wally7, FLAG_OLD_WORLD_FLAG,    NO_FLAG_TO_SET },
        MATCH_CALL_TEXT_END
    },
    .locationData = (const struct MatchCallLocationOverride[]) {
        { FLAG_HIDE_MAUVILLE_CITY_WALLY,          MAPSEC_VERDANTURF_TOWN },
        { FLAG_OLD_WORLD_FLAG,    MAPSEC_NONE },
...
static const struct MatchCallStructNPC sScottMatchCallHeader =
{
    ...
    .textData = (const match_call_text_data_t[]) {
        ...
        { MatchCall_Text_Scott2, FLAG_OLD_WORLD_FLAG,  NO_FLAG_TO_SET },
        { MatchCall_Text_Scott3, FLAG_OLD_WORLD_FLAG,              NO_FLAG_TO_SET },
        { MatchCall_Text_Scott4, FLAG_OLD_WORLD_FLAG,       NO_FLAG_TO_SET },
        { MatchCall_Text_Scott5, FLAG_OLD_WORLD_FLAG, NO_FLAG_TO_SET },
