...
static const union AnimCmd sSpriteAnim_Bag_MegaPocket[] =
{
    ANIMCMD_FRAME(384, 4),
    ANIMCMD_END
};
...
{
    [POCKET_FREESPACE]  = sSpriteAnim_Bag_Closed,
    [POCKET_ITEMS]      = sSpriteAnim_Bag_Items,
    [POCKET_MEDICINE]   = sSpriteAnim_Bag_Pokeballs,
    [POCKET_POKE_BALLS] = sSpriteAnim_Bag_TMsHMs,
    [POCKET_TM_HM]      = sSpriteAnim_Bag_Berries,
...
{
    gBagMaleTiles, 14336, TAG_BAG_GFX
};

const struct CompressedSpriteSheet gBagFemaleSpriteSheet =
{
    gBagFemaleTiles, 14336, TAG_BAG_GFX
};
...
static const struct TilesPal sBerryPicTable[] =
{
    ...
    [ITEM_TO_BERRY(ITEM_ROSTE_BERRY)  - 1]          = {gBerryPic_Roste, gBerryPalette_Roste},
