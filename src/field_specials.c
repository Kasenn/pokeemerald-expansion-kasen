        ...
        graphicsId == OBJ_EVENT_GFX_RIVAL_MAY_NORMAL)
    {
        ...
        if (obj != OBJECT_EVENTS_COUNT)
        {
            ...
            case OBJ_EVENT_GFX_LINK_RS_BRENDAN:
                LoadPalette(gObjectEventPalette_Brendan_Unused, OBJ_PLTT_ID(adjustedPaletteNum), PLTT_SIZE_4BPP);
                break;
            case OBJ_EVENT_GFX_LINK_RS_MAY:
                LoadPalette(gObjectEventPalette_May_Unused, OBJ_PLTT_ID(adjustedPaletteNum), PLTT_SIZE_4BPP);
                break;
            case OBJ_EVENT_GFX_RIVAL_BRENDAN_NORMAL:
                LoadPalette(gObjectEventPalette_Brendan, OBJ_PLTT_ID(adjustedPaletteNum), PLTT_SIZE_4BPP);
                break;
            case OBJ_EVENT_GFX_RIVAL_MAY_NORMAL:
                LoadPalette(gObjectEventPalette_May, OBJ_PLTT_ID(adjustedPaletteNum), PLTT_SIZE_4BPP);
                break;
            }
        }
    }
...
static bool32 IsBuildingPCTile3(u32 tileId)
{
    return gMapHeader.mapLayout->primaryTileset == &gTileset_PokemonWorldTournament && (tileId == METATILE_Building2_PC_On || tileId == METATILE_Building2_PC_Off);
}
...
static bool8 IsPlayerInFrontOfPC(void)
{
    ...
    return IsBuildingPCTile(tileInFront) || IsPlayerHousePCTile(tileInFront) || IsBuildingPCTile2(tileInFront) || IsBuildingPCTile3(tileInFront);
}
...
void CreateAbnormalWeatherEvent(void)
{
    ...
    else if (FlagGet(FLAG_OLD_WORLD_FLAG) == TRUE)
    {
...
bool8 InPokemonCenter(void)
{
    static const u16 sPokemonCenters[] =
    {
        ...
        MAP_ALDELEAF_POKE_CENTER1F,
        MAP_SHORESLATE_POKECENTER_1F,
        MAP_MARIGORGE_POKECENTER_1F,
        MAP_KAOLISLE_POKECENTER_1F,
        MAP_ROCKLIFFE_POKECENTER_1F,
        MAP_SANDSTONE_POKECENTER_1F,
        MAP_DRISLEDGE_POKECENTER_1F,
        MAP_AMBEROCK_POKE_CENTER1F,
        MAP_FROSTHEARTH_CITY_POKE_CENTER,
        MAP_UNDEFINED
    };
