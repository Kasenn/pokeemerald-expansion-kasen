    ...
    [DIFFICULTY_NORMAL][PARTNER_MAY_ROWLET] =
    {
        ...
        .trainerPic = TRAINER_PIC_BACK_MAY,
    ...
    [DIFFICULTY_NORMAL][PARTNER_MAY_ORAS_ROWLET] =
    {
        ...
        .gender = FEMALE,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .trainerPic = TRAINER_PIC_BACK_MAY_ORAS,
        .trainerBackPic = TRAINER_PIC_BACK_MAY_ORAS,
        .trainerName = _("May"),
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY,
    },
    ...
    [DIFFICULTY_NORMAL][PARTNER_BRENDAN_ORAS_ROWLET] =
    {
        ...
        .trainerClass = TRAINER_CLASS_RIVAL,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_MALE,
        .trainerPic = TRAINER_PIC_BACK_BRENDAN_ORAS,
        .trainerBackPic = TRAINER_PIC_BACK_BRENDAN_ORAS,
        .trainerName = _("Brendan"),
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY,
    },
