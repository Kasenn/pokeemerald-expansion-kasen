...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_IDLE_AROUND] =
    {
        .name = COMPOUND_STRING("Hold Out"),
        .description = COMPOUND_STRING("Has no effect."),
        .effect = EFFECT_HIT,
        .power = 0,
        .type = TYPE_NORMAL,
        .accuracy = 0,
    ...
    [MOVE_ANCIENT_POWER] =
    {
        ...
        .makesContact = B_UPDATED_MOVE_DATA < GEN_4,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_OMNIBOOST,
            .attack = 1,
            .defense = 1,
            .spDef = 1,
            .spAtk = 1,
    ...
    [MOVE_TRICK] =
    {
        ...
        .bpCost = (B_MOVE_TUTOR_COSTS <= GEN_5) ? 48 : 10,
        .description = COMPOUND_STRING(
    ...
    [MOVE_RAZOR_GALE] =
    {
        .name = COMPOUND_STRING("Razor Gale"),
        .description = COMPOUND_STRING(
            "This attack does Steel\n"
            "and Flying-type damage."),
        .effect = EFFECT_TWO_TYPED_MOVE,
        .power = B_UPDATED_MOVE_DATA >= GEN_7 ? 85 : 85,
        .type = TYPE_STEEL,
        .accuracy = 100,
        .pp = 10,
        .target = TARGET_SELECTED,
