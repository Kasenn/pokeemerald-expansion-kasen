const struct FormChange *const gFormChangeTablePointers[NUM_SPECIES] =
{
    ...
    [SPECIES_EMPOLEON] = sEmpoleonFormChangeTable,
    [SPECIES_EMPOLEON_MEGA] = sEmpoleonFormChangeTable,
    [SPECIES_DECIDUEYE] = sDecidueyeFormChangeTable,
    [SPECIES_DECIDUEYE_MEGA] = sDecidueyeFormChangeTable,
    [SPECIES_INCINEROAR] = sIncineroarFormChangeTable,
    [SPECIES_INCINEROAR_MEGA] = sIncineroarFormChangeTable,
    [SPECIES_CHESNAUGHT] = sChesnaughtFormChangeTable,
    [SPECIES_CHESNAUGHT_MEGA] = sChesnaughtFormChangeTable,
