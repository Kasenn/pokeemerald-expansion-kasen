const u16 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_BROTHER] = TRAINER_PIC_FRONT_BROTHER,
    ...
    [FACILITY_CLASS_BRENDAN_2] = TRAINER_PIC_FRONT_BRENDAN_ORAS,
    [FACILITY_CLASS_BRENDAN_3] = TRAINER_PIC_FRONT_BRENDAN,
    [FACILITY_CLASS_MAY] = TRAINER_PIC_FRONT_MAY,
    [FACILITY_CLASS_MAY_2] = TRAINER_PIC_FRONT_MAY_ORAS,
    ...
    [FACILITY_CLASS_SALON_MAIDEN_ANABEL] = TRAINER_PIC_FRONT_BROTHER,
    ...
    [FACILITY_CLASS_CONTEST_BRENDAN] = TRAINER_PIC_FRONT_BRENDAN_CONTEST,
    [FACILITY_CLASS_CONTEST_MAY] = TRAINER_PIC_FRONT_MAY_CONTEST,
};
...
const enum TrainerClassID gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_BROTHER] = TRAINER_CLASS_BROTHER,
    ...
    [FACILITY_CLASS_CONTEST_BRENDAN] = TRAINER_CLASS_RS_PROTAG,
    [FACILITY_CLASS_CONTEST_MAY] = TRAINER_CLASS_RS_PROTAG,
};
