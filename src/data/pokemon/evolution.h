const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_SCRAGGY]               = {{EVO_LEVEL, 34, SPECIES_SCRAFTY}},
    ...
    [SPECIES_GOTHITA]               = {{EVO_LEVEL, 26, SPECIES_GOTHORITA}},
    [SPECIES_GOTHORITA]             = {{EVO_LEVEL, 35, SPECIES_GOTHITELLE}},
    [SPECIES_SOLOSIS]               = {{EVO_LEVEL, 26, SPECIES_DUOSION}},
    ...
    [SPECIES_VANILLISH]             = {{EVO_LEVEL, 43, SPECIES_VANILLUXE}},
    ...
    [SPECIES_FRILLISH]              = {{EVO_LEVEL, 38, SPECIES_JELLICENT}},
    ...
    [SPECIES_KLANG]                 = {{EVO_LEVEL, 41, SPECIES_KLINKLANG}},
    ...
    [SPECIES_AXEW]                  = {{EVO_LEVEL, 32, SPECIES_FRAXURE}},
    [SPECIES_FRAXURE]               = {{EVO_LEVEL, 44, SPECIES_HAXORUS}},
    ...
    [SPECIES_GOLETT]                = {{EVO_LEVEL, 41, SPECIES_GOLURK}},
    ...
    [SPECIES_DEINO]                 = {{EVO_LEVEL, 32, SPECIES_ZWEILOUS}},
