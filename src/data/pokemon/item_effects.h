...
const u8 gItemEffect_SpecialSoup[10] = {
    [4] = ITEM4_HEAL_HP,
    [5] = ITEM5_FRIENDSHIP_ALL,
    [6] = 20, // Amount of HP to recover
    [7] = -30, // Friendship change, low
...
const u8 *const gItemEffectTable[ITEMS_COUNT] =
{
    ...
    [ITEM_SPECIAL_SOUP]         = gItemEffect_SpecialSoup,
    ...
    [ITEM_TROPICAL_STONE]         = gItemEffect_EvoItem,
    [ITEM_ANCIENT_STONE]         = gItemEffect_EvoItem,
