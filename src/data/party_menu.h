...
} static const sCursorOptions[MENU_FIELD_MOVES] =
{
    ...
    [MENU_ENTER]           = {COMPOUND_STRING("Toss"),            CursorCb_Enter},
    [MENU_TOSS_EGG]        = {COMPOUND_STRING("Toss"),            CursorCb_TossEgg},
    [MENU_NO_ENTRY]        = {COMPOUND_STRING("Return"),          CursorCb_NoEntry},
...
static const u8 sPartyMenuAction_TossEgg[] = {MENU_TOSS_EGG, MENU_SUMMARY, MENU_CANCEL1};
...
static const u8 *const sPartyMenuActions[] =
{
    ...
    [ACTIONS_TOSSEGG]       = sPartyMenuAction_TossEgg,
};
...
static const u8 sPartyMenuActionCounts[] =
{
    ...
    [ACTIONS_TOSSEGG]       = ARRAY_COUNT(sPartyMenuAction_TossEgg),
};
