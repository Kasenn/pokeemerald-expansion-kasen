...
{
    {COMPOUND_STRING("    25 coins    ¥1,000")},
    {COMPOUND_STRING("  250 coins  ¥10,000")},
    {COMPOUND_STRING("1000 coins  ¥40,000")},
    {gText_Exit},
};
...
static const struct MenuAction MultichoiceList_ForcedStartMenu[] =
{
    ...
    {gText_Stats}, // blank because it's filled by the player's name
...
const u8 *const gStdStrings[] =
{
    ...
    [STDSTRING_FREESPACE] = gText_FreeSpace,
};
