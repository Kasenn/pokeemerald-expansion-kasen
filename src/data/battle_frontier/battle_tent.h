...
const struct BattleFrontierTrainer gSlateportBattleTentTrainers[NUM_BATTLE_TENT_TRAINERS] =
{
    [SLATEPORT_TENT_TRAINER_JOLIE] = {
        ...
        .speechBefore = COMPOUND_STRING("What will I be tomorrow?"),
           .speechWin = COMPOUND_STRING("I'm feeling like it's Friday!"),
          .speechLose = COMPOUND_STRING("I'm feeling like it's Monday…"),
    ...
    [SLATEPORT_TENT_TRAINER_MALACHI] = {
        ...
        .speechBefore = COMPOUND_STRING("Bad news! It's a Sand Tomb!"),
           .speechWin = COMPOUND_STRING("Yeehaw! I've done it!"),
    ...
    [SLATEPORT_TENT_TRAINER_DAVON] = {
        ...
        .trainerName = _("Davon"),
        .speechBefore = COMPOUND_STRING("Yeah yeah!!\nGreat Whirlpool, isn't it?"),
           .speechWin = COMPOUND_STRING("That was like a Whirlpool,\nyeah yeah!!"),
    ...
    [SLATEPORT_TENT_TRAINER_GLENDA] = {
        ...
        .speechBefore = COMPOUND_STRING("Conversation can wait until I win."),
           .speechWin = COMPOUND_STRING("Fabulous! I'm going to rock!"),
          .speechLose = COMPOUND_STRING("No! I wasn't serious!"),
    ...
    [SLATEPORT_TENT_TRAINER_HELENA] = {
        ...
        .speechBefore = COMPOUND_STRING("Does my beauty intimidate you?"),
           .speechWin = COMPOUND_STRING("I'm so sorry, but you're boring."),
    ...
    [SLATEPORT_TENT_TRAINER_DAVION] = {
        ...
        .speechBefore = COMPOUND_STRING("Graaah graaah!! Graaah graaah!!"),
           .speechWin = COMPOUND_STRING("Roar! Roar!!"),
          .speechLose = COMPOUND_STRING("Urgh waaah!!"),
    ...
    [SLATEPORT_TENT_TRAINER_IRVIN] = {
        ...
        .speechBefore = COMPOUND_STRING("Have a look at my Confuse Ray."),
           .speechWin = COMPOUND_STRING("Yahoo!\nMy Confuse Ray is the best!"),
          .speechLose = COMPOUND_STRING("Gwah!! I'm sorry!"),
    ...
    [SLATEPORT_TENT_TRAINER_SHAUN] = {
        ...
        .speechBefore = COMPOUND_STRING("Listen… You aren't very good."),
          ...
          .speechLose = COMPOUND_STRING("Yes yes…\nYou're quite something."),
    ...
    [SLATEPORT_TENT_TRAINER_MAGGIE] = {
        ...
        .speechBefore = COMPOUND_STRING("Vulpix, Xatu, Umbreon… Um…"),
           .speechWin = COMPOUND_STRING("Nosepass… Um, Seviper!"),
    ...
    [SLATEPORT_TENT_TRAINER_STEPHON] = {
        ...
        .speechBefore = COMPOUND_STRING("I'm going to enjoy an egg."),
           .speechWin = COMPOUND_STRING("I will enjoy this tasty victory."),
          .speechLose = COMPOUND_STRING("Awful!! Just awful!!"),
    ...
    [SLATEPORT_TENT_TRAINER_REGGIE] = {
        ...
        .speechBefore = COMPOUND_STRING("Pokémon come before money or family."),
           .speechWin = COMPOUND_STRING("That's what's making me strong."),
          .speechLose = COMPOUND_STRING("That's why I'm so thick…"),
    ...
    [SLATEPORT_TENT_TRAINER_JANAE] = {
        ...
        .speechBefore = COMPOUND_STRING("I just adore your tough look."),
           .speechWin = COMPOUND_STRING("I like how you struggle."),
    ...
    [SLATEPORT_TENT_TRAINER_CAIDEN] = {
        ...
        .speechBefore = COMPOUND_STRING("My curse will break your spirit!"),
          ...
          .speechLose = COMPOUND_STRING("My curse will last forever."),
    ...
    [SLATEPORT_TENT_TRAINER_KIRSTEN] = {
        ...
        .speechBefore = COMPOUND_STRING("Huh? A battle you said?"),
           .speechWin = COMPOUND_STRING("Huh? Strong, but not strong enough."),
          .speechLose = COMPOUND_STRING("Huh? I surrender to your strength."),
    ...
    [SLATEPORT_TENT_TRAINER_STEFAN] = {
        ...
        .speechBefore = COMPOUND_STRING("I only want cute Pokémon."),
           .speechWin = COMPOUND_STRING("What is it to you?"),
          .speechLose = COMPOUND_STRING("You're kind of awesome…"),
    ...
    [SLATEPORT_TENT_TRAINER_DWANE] = {
        ...
        .speechBefore = COMPOUND_STRING("Mmm, tasty… Wonder what?"),
          ...
          .speechLose = COMPOUND_STRING("Mmm mmm… Oh yeah, this is it!"),
    ...
    [SLATEPORT_TENT_TRAINER_MCKENNA] = {
        ...
        .speechBefore = COMPOUND_STRING("I dislike small talk. Let's go!"),
           .speechWin = COMPOUND_STRING("Yup, that's that."),
          .speechLose = COMPOUND_STRING("K thx, bye!"),
    ...
    [SLATEPORT_TENT_TRAINER_CAMRYN] = {
        ...
        .speechBefore = COMPOUND_STRING("Mr. Judge, you have your trust."),
           .speechWin = COMPOUND_STRING("Yes sir!\nWe're No. 1 in this contest!"),
    ...
    [SLATEPORT_TENT_TRAINER_NATASHA] = {
        ...
        .speechBefore = COMPOUND_STRING("Come over to my place, OK?"),
           .speechWin = COMPOUND_STRING("Come on over, it will be great."),
          .speechLose = COMPOUND_STRING("Aww, won't you come over?"),
    ...
    [SLATEPORT_TENT_TRAINER_DONOVAN] = {
        ...
        .speechBefore = COMPOUND_STRING("Oh, I'm feeling slimy all over."),
           .speechWin = COMPOUND_STRING("You're going down the\nMega Drain, hahaha!"),
          .speechLose = COMPOUND_STRING("I'm naturally slime,\nthat's what I am"),
    ...
    [SLATEPORT_TENT_TRAINER_TAMIA] = {
        ...
        .trainerName = _("Tamia"),
        .speechBefore = COMPOUND_STRING("I'm angry with my father…"),
...
const struct TrainerMon gSlateportBattleTentMons[NUM_SLATEPORT_TENT_MONS] =
{
    ...
    [SLATEPORT_TENT_MON_DRILBUR] = {
        ...
        .moves = {MOVE_RAPID_SPIN, MOVE_HONE_CLAWS, MOVE_DIG, MOVE_IRON_DEFENSE},
...
const struct BattleFrontierTrainer gVerdanturfBattleTentTrainers[NUM_BATTLE_TENT_TRAINERS] =
{
    ...
    [VERDANTURF_TENT_TRAINER_DC_BASEROCKET_2US] = {
        .facilityClass = FACILITY_CLASS_TUBER_M,
