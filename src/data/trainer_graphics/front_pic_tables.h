const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_AFICIONADO_M] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_AFICIONADO_F] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_SCIENTIST] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_CLAY] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_ROCKER] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_GEN4_SWIMMER_F] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_KORRINA] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_BW_ACE_TRAINER_F] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_BW_ACE_TRAINER_M] = {.size = 8, .y_offset = 1},
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(AFICIONADO_M, gTrainerFrontPic_AficionadoM, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(AFICIONADO_F, gTrainerFrontPic_AficionadoF, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(SCIENTIST, gTrainerFrontPic_Scientist, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(CLAY, gTrainerFrontPic_Clay, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(ROCKER, gTrainerFrontPic_Rocker, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(GEN4_SWIMMER_F, gTrainerFrontPic_Gen4SwimmerF, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(KORRINA, gTrainerFrontPic_Korrina, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(BW_ACE_TRAINER_F, gTrainerFrontPic_BWAceTrainerF, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(BW_ACE_TRAINER_M, gTrainerFrontPic_BWAceTrainerM, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(MAY_ORAS, gTrainerFrontPic_MayOras, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(BRENDAN_ORAS, gTrainerFrontPic_BrendanOras, TRAINER_PIC_SIZE),
};
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(AFICIONADO_M, gTrainerPalette_AficionadoM),
    TRAINER_PAL(AFICIONADO_F, gTrainerPalette_AficionadoF),
    ...
    TRAINER_PAL(GEN4_SWIMMER_F, gTrainerPalette_Gen4SwimmerF),
    TRAINER_PAL(KORRINA, gTrainerPalette_Korrina),
    TRAINER_PAL(BW_ACE_TRAINER_F, gTrainerPalette_BWAceTrainerF),
    TRAINER_PAL(BW_ACE_TRAINER_M, gTrainerPalette_BWAceTrainerM),
    TRAINER_PAL(MAY_ORAS, gTrainerPalette_MayOras),
    TRAINER_PAL(BRENDAN_ORAS, gTrainerPalette_BrendanOras),
};
