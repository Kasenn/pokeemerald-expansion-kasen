const u32 *const gItemIconTable[ITEMS_COUNT + 1][2] =
{
    ...
    [ITEM_TROPICAL_STONE] = {gItemIcon_TropicalStone, gItemIconPalette_TropicalStone},
    [ITEM_ANCIENT_STONE] = {gItemIcon_AncientStone, gItemIconPalette_AncientStone},
    [ITEM_SAMPLE_BOX] = {gItemIcon_SampleBox, gItemIconPalette_SampleBox},
    ...
    [ITEM_RESEARCH_PAPERS] = {gItemIcon_DevonParts, gItemIconPalette_DevonParts},
