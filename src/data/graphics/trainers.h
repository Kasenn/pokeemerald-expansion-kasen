...
const u32 gTrainerFrontPic_Senior[] = INCBIN_U32("graphics/trainers/front_pics/sr.4bpp.smol");
const u32 gTrainerFrontPic_Junior[] = INCBIN_U32("graphics/trainers/front_pics/jr.4bpp.smol");
...
const u32 gTrainerFrontPic_Swimmers[] = INCBIN_U32("graphics/trainers/front_pics/swimmers.4bpp.smol");
const u16 gTrainerPalette_Swimmers[] = INCBIN_U16("graphics/trainers/front_pics/swimmers.gbapal");
...
const u16 gTrainerFrontPicPalette_Brendan[] = INCBIN_U16("graphics/trainers/front_pics/brendan.gbapal");
const u16 gTrainerFrontPicPalette_May[] = INCBIN_U16("graphics/trainers/front_pics/may.gbapal");

const u32 gTrainerFrontPic_Empty[] = INCBIN_U32("graphics/trainers/front_pics/empty.4bpp.smol");
...
const u32 gTrainerFrontPic_Kasen[] = INCBIN_U32("graphics/trainers/front_pics/kasen.4bpp.smol");
const u16 gTrainerPalette_Kasen[] = INCBIN_U16("graphics/trainers/front_pics/kasen.gbapal");

const u32 gTrainerFrontPic_Blaine[] = INCBIN_U32("graphics/trainers/front_pics/leader_blaine.4bpp.smol");
const u16 gTrainerPalette_Blaine[] = INCBIN_U16("graphics/trainers/front_pics/leader_blaine.gbapal");

const u32 gTrainerFrontPic_Pryce[] = INCBIN_U32("graphics/trainers/front_pics/leader_pryce.4bpp.smol");
const u16 gTrainerPalette_Pryce[] = INCBIN_U16("graphics/trainers/front_pics/leader_pryce.gbapal");
...
const u32 gTrainerFrontPic_BW_ACE_TRAINER_F_SWIMMER[] = INCBIN_U32("graphics/trainers/front_pics/bw_ace_trainer_f_swimmer.4bpp.smol");
const u16 gTrainerPalette_BW_ACE_TRAINER_F_SWIMMER[] = INCBIN_U16("graphics/trainers/front_pics/bw_ace_trainer_f_swimmer.gbapal");
...
const u16 gTrainerFrontPicPalette_RubySapphireBrendan[] = INCBIN_U16("graphics/trainers/front_pics/brendan_rs.gbapal");
const u16 gTrainerFrontPicPalette_RubySapphireMay[] = INCBIN_U16("graphics/trainers/front_pics/may_rs.gbapal");
...
const u32 gTrainerFrontPic_AficionadoM[] = INCBIN_U32("graphics/trainers/front_pics/aficionado_m.4bpp.smol");
const u16 gTrainerPalette_AficionadoM[] = INCBIN_U16("graphics/trainers/front_pics/aficionado_m.gbapal");

const u32 gTrainerFrontPic_AficionadoF[] = INCBIN_U32("graphics/trainers/front_pics/aficionado_f.4bpp.smol");
const u16 gTrainerPalette_AficionadoF[] = INCBIN_U16("graphics/trainers/front_pics/aficionado_f.gbapal");
...
const u32 gTrainerFrontPic_Clay[] = INCBIN_U32("graphics/trainers/front_pics/leader_clay.4bpp.smol");
const u16 gTrainerPalette_Clay[] = INCBIN_U16("graphics/trainers/front_pics/leader_clay.gbapal");
...
const u32 gTrainerFrontPic_Korrina[] = INCBIN_U32("graphics/trainers/front_pics/leader_korrina.4bpp.smol");
const u16 gTrainerPalette_Korrina[] = INCBIN_U16("graphics/trainers/front_pics/leader_korrina.gbapal");
...
const u32 gTrainerFrontPic_BrendanContest[] =   INCBIN_U32("graphics/trainers/front_pics/brendan_contest.4bpp.smol");//wip
...
const u32 gTrainerFrontPic_Gen4SwimmerF[] = INCBIN_U32("graphics/trainers/front_pics/gen4swimmerf.4bpp.smol");
const u16 gTrainerPalette_Gen4SwimmerF[] = INCBIN_U16("graphics/trainers/front_pics/gen4swimmerf.gbapal");

const u32 gTrainerFrontPic_Acerola[] = INCBIN_U32("graphics/trainers/front_pics/acerola.4bpp.smol");
const u16 gTrainerPalette_Acerola[] = INCBIN_U16("graphics/trainers/front_pics/acerola.gbapal");

const u32 gTrainerFrontPic_Jasmine[] = INCBIN_U32("graphics/trainers/front_pics/leader_jasmine.4bpp.smol");
const u16 gTrainerPalette_Jasmine[] = INCBIN_U16("graphics/trainers/front_pics/leader_jasmine.gbapal");
...
const u8 gTrainerBackPic_BrendanOras[] = INCBIN_U8("graphics/trainers/back_pics/brendan_oras.4bpp");
const u8 gTrainerBackPic_MayOras[] = INCBIN_U8("graphics/trainers/back_pics/may_oras.4bpp");
const u8 gTrainerBackPic_MayContest[] = INCBIN_U8("graphics/trainers/back_pics/may_contest.4bpp");
const u8 gTrainerBackPic_BrendanContest[] = INCBIN_U8("graphics/trainers/back_pics/brendan_contest.4bpp");//wip
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_FRONT_LEADER_VOLKNER, gTrainerFrontPic_LeaderWattson, gTrainerPalette_LeaderWattson),
    ...
    TRAINER_SPRITE(TRAINER_PIC_FRONT_ELITE_SKYLA, gTrainerFrontPic_LeaderWinona, gTrainerPalette_LeaderWinona),
    ...
    TRAINER_SPRITE(TRAINER_PIC_FRONT_SENIOR, gTrainerFrontPic_Senior, gTrainerPalette_SrAndJr),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_JUNIOR, gTrainerFrontPic_Junior, gTrainerPalette_SrAndJr),
    ...
    TRAINER_SPRITE(TRAINER_PIC_FRONT_SWIMMERS, gTrainerFrontPic_Swimmers, gTrainerPalette_Swimmers),
    ...
    TRAINER_SPRITE(TRAINER_PIC_FRONT_BRENDAN, gTrainerFrontPic_Brendan, gTrainerFrontPicPalette_Brendan),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_MAY, gTrainerFrontPic_May, gTrainerFrontPicPalette_May),
    ...
    TRAINER_SPRITE(TRAINER_PIC_FRONT_BROTHER, gTrainerFrontPic_SalonMaidenAnabel, gTrainerPalette_SalonMaidenAnabel),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_DOME_ACE_TUCKER, gTrainerFrontPic_DomeAceTucker, gTrainerPalette_DomeAceTucker),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_LEADER_AARON, gTrainerFrontPic_PalaceMavenSpenser, gTrainerPalette_PalaceMavenSpenser),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_KASEN, gTrainerFrontPic_Kasen, gTrainerPalette_Kasen),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_BLAINE, gTrainerFrontPic_Blaine, gTrainerPalette_Blaine),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_PRYCE, gTrainerFrontPic_Pryce, gTrainerPalette_Pryce),
    ...
    TRAINER_SPRITE(TRAINER_PIC_FRONT_BW_ACE_TRAINER_F_SWIMMER, gTrainerFrontPic_BW_ACE_TRAINER_F_SWIMMER, gTrainerPalette_BW_ACE_TRAINER_F_SWIMMER),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_DRAYDEN, gTrainerFrontPic_Drayden, gTrainerPalette_Drayden),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_IRIS_CASUAL, gTrainerFrontPic_IrisCasual, gTrainerPalette_IrisCasual),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_MINA, gTrainerFrontPic_Mina, gTrainerPalette_Mina),
    ...
    TRAINER_SPRITE(TRAINER_PIC_FRONT_RS_BRENDAN, gTrainerFrontPic_RubySapphireBrendan, gTrainerFrontPicPalette_RubySapphireBrendan),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_RS_MAY, gTrainerFrontPic_RubySapphireMay, gTrainerFrontPicPalette_RubySapphireMay),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_AFICIONADO_M, gTrainerFrontPic_AficionadoM, gTrainerPalette_AficionadoM),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_AFICIONADO_F, gTrainerFrontPic_AficionadoF, gTrainerPalette_AficionadoF),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_SCIENTIST, gTrainerFrontPic_Scientist, gTrainerPalette_Scientist),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_CLAY, gTrainerFrontPic_Clay, gTrainerPalette_Clay),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_ROCKER, gTrainerFrontPic_Rocker, gTrainerPalette_Rocker),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_GEN4_SWIMMER_F, gTrainerFrontPic_Gen4SwimmerF, gTrainerPalette_Gen4SwimmerF),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_KORRINA, gTrainerFrontPic_Korrina, gTrainerPalette_Korrina),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_BW_ACE_TRAINER_F, gTrainerFrontPic_BWAceTrainerF, gTrainerPalette_BWAceTrainerF),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_BW_ACE_TRAINER_M, gTrainerFrontPic_BWAceTrainerM, gTrainerPalette_BWAceTrainerM),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_MAY_ORAS, gTrainerFrontPic_MayOras, gTrainerPalette_MayOras),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_BRENDAN_ORAS, gTrainerFrontPic_BrendanOras, gTrainerPalette_BrendanOras),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_ACEROLA, gTrainerFrontPic_Acerola, gTrainerPalette_Acerola),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_JASMINE, gTrainerFrontPic_Jasmine, gTrainerPalette_Jasmine),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_MAY_CONTEST, gTrainerFrontPic_MayContest, gTrainerPalette_MayContest),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_BRENDAN_CONTEST, gTrainerFrontPic_BrendanContest, gTrainerPalette_BrendanContest),
...
const struct TrainerBacksprite gTrainerBacksprites[] =
{
    ...
    TRAINER_BACK_SPRITE(TRAINER_PIC_BACK_BRENDAN_ORAS, 4, gTrainerBackPic_BrendanOras, gTrainerPalette_BrendanOras, sBackAnims_Hoenn),
    TRAINER_BACK_SPRITE(TRAINER_PIC_BACK_MAY_ORAS, 4, gTrainerBackPic_MayOras, gTrainerPalette_MayOras, sBackAnims_Hoenn),
    TRAINER_BACK_SPRITE(TRAINER_PIC_BACK_MAY_CONTEST, 4, gTrainerBackPic_MayContest, gTrainerPalette_MayContest, sBackAnims_Hoenn),
    TRAINER_BACK_SPRITE(TRAINER_PIC_BACK_BRENDAN_CONTEST, 4, gTrainerBackPic_BrendanContest, gTrainerPalette_BrendanContest, sBackAnims_Hoenn),
