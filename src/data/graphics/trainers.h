...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_LEADER_VOLKNER, gTrainerFrontPic_LeaderWattson, gTrainerPalette_LeaderWattson),
    ...
    TRAINER_SPRITE(TRAINER_PIC_ELITE_SKYLA, gTrainerFrontPic_LeaderWinona, gTrainerPalette_LeaderWinona),
    ...
    TRAINER_SPRITE(TRAINER_PIC_BRENDAN, gTrainerFrontPic_Brendan, gTrainerFrontPicPalette_Brendan),
    TRAINER_SPRITE(TRAINER_PIC_MAY, gTrainerFrontPic_May, gTrainerFrontPicPalette_May),
    ...
    TRAINER_SPRITE(TRAINER_PIC_BROTHER, gTrainerFrontPic_SalonMaidenAnabel, gTrainerPalette_SalonMaidenAnabel),
    TRAINER_SPRITE(TRAINER_PIC_DOME_ACE_TUCKER, gTrainerFrontPic_DomeAceTucker, gTrainerPalette_DomeAceTucker),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_AARON, gTrainerFrontPic_PalaceMavenSpenser, gTrainerPalette_PalaceMavenSpenser),
    ...
    TRAINER_SPRITE(TRAINER_PIC_IRIS_CASUAL, gTrainerFrontPic_IrisCasual, gTrainerPalette_IrisCasual),
    ...
    TRAINER_SPRITE(TRAINER_PIC_RS_BRENDAN, gTrainerFrontPic_RubySapphireBrendan, gTrainerFrontPicPalette_RubySapphireBrendan),
    TRAINER_SPRITE(TRAINER_PIC_RS_MAY, gTrainerFrontPic_RubySapphireMay, gTrainerFrontPicPalette_RubySapphireMay),
    TRAINER_SPRITE(TRAINER_PIC_AFICIONADO_M, gTrainerFrontPic_AficionadoM, gTrainerPalette_AficionadoM),
    ...
    TRAINER_SPRITE(TRAINER_PIC_MAY_ORAS, gTrainerFrontPic_MayOras, gTrainerPalette_MayOras),
    TRAINER_SPRITE(TRAINER_PIC_BRENDAN_ORAS, gTrainerFrontPic_BrendanOras, gTrainerPalette_BrendanOras),
    TRAINER_SPRITE(TRAINER_PIC_ACEROLA, gTrainerFrontPic_Acerola, gTrainerPalette_Acerola),
    TRAINER_SPRITE(TRAINER_PIC_JASMINE, gTrainerFrontPic_Jasmine, gTrainerPalette_Jasmine),
    TRAINER_SPRITE(TRAINER_PIC_MAY_CONTEST, gTrainerFrontPic_MayContest, gTrainerPalette_MayContest),
    TRAINER_SPRITE(TRAINER_PIC_BRENDAN_CONTEST, gTrainerFrontPic_BrendanContest, gTrainerPalette_BrendanContest),
};
...
const struct TrainerBacksprite gTrainerBacksprites[] =
{
    ...
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_BRENDAN_ORAS, 4, gTrainerBackPic_BrendanOras, gTrainerPalette_BrendanOras, sBackAnims_Hoenn),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_MAY_ORAS, 4, gTrainerBackPic_MayOras, gTrainerPalette_MayOras, sBackAnims_Hoenn),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_MAY_CONTEST, 4, gTrainerBackPic_MayContest, gTrainerPalette_MayContest, sBackAnims_Hoenn),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_BRENDAN_CONTEST, 4, gTrainerBackPic_BrendanContest, gTrainerPalette_BrendanContest, sBackAnims_Hoenn),
};
