...
const struct TrainerBacksprite gTrainerBacksprites[] =
{
    ...
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_BRENDAN_ORAS, 4, gTrainerBackPic_BrendanOras, gTrainerBackPicTable_BrendanOras, gTrainerPalette_BrendanOras, sBackAnims_Hoenn),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_MAY_ORAS, 4, gTrainerBackPic_MayOras, gTrainerBackPicTable_MayOras, gTrainerPalette_MayOras, sBackAnims_Hoenn),
};
