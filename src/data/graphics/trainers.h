...
const struct TrainerBacksprite gTrainerBacksprites[] =
{
    ...
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_RUBY_SAPPHIRE_BRENDAN, 4, gTrainerBackPicTable_RubySapphireBrendan, gTrainerPalette_RubySapphireBrendan, sBackAnims_Hoenn),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_RUBY_SAPPHIRE_MAY, 4, gTrainerBackPicTable_RubySapphireMay, gTrainerPalette_RubySapphireMay, sBackAnims_Hoenn),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_WALLY, 4, gTrainerBackPicTable_Wally, gTrainerPalette_Wally, sBackAnims_Hoenn),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_STEVEN, 4, gTrainerBackPicTable_Steven, gTrainerPalette_Steven, sBackAnims_Hoenn),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_BRENDAN_ORAS, 4, gTrainerBackPicTable_BrendanOras, gTrainerPalette_BrendanOras, sBackAnims_Hoenn),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_MAY_ORAS, 4, gTrainerBackPicTable_MayOras, gTrainerPalette_MayOras, sBackAnims_Hoenn),
};
