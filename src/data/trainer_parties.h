...
static const struct TrainerMon sParty_GruntWeatherInst3[] = {
    ...
    .iv = TRAINER_PARTY_IVS(4,4,4,31,4,4),
...
static const struct TrainerMon sParty_ShellyWeatherInstitute[] = {
    ...
    .ev = TRAINER_PARTY_EVS(24, 24, 24, 24, 24, 24),
    .moves = {MOVE_FOCUS_ENERGY, MOVE_VISE_GRIP, MOVE_REVENGE, MOVE_BULK_UP},
    }
};
...
static const struct TrainerMon sParty_Archie[] = {
    ...
    .moves = {MOVE_ROCK_TOMB, MOVE_BULLDOZE, MOVE_HEADBUTT, MOVE_SAND_ATTACK},
    },
};
...
static const struct TrainerMon sParty_Leah[] = {
    ...
    .moves = {MOVE_SUBSTITUTE, MOVE_PROTECT, MOVE_EARTHQUAKE, MOVE_TOXIC},
    }
};
...
static const struct TrainerMon sParty_Daisy[] = {
    ...
    .ev = TRAINER_PARTY_EVS(200, 150, 0, 0, 0, 0),
...
static const struct TrainerMon sParty_Rose1[] = {
    ...
    .ev = TRAINER_PARTY_EVS(12, 100, 0, 100, 0, 0),
...
static const struct TrainerMon sParty_GabbyAndTy1[] = {
    ...
    .species = SPECIES_CUTIEFLY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_U_TURN, MOVE_DRAINING_KISS, MOVE_SILVER_WIND, MOVE_STUN_SPORE}
    },
    {
    .iv = TRAINER_PARTY_IVS(8, 8, 8, 8, 8, 8),
    .lvl = 13,
    .species = SPECIES_KRICKETUNE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FURY_CUTTER, MOVE_ABSORB, MOVE_BIDE, MOVE_GROWL}
    },
    {
    .iv = TRAINER_PARTY_IVS(8, 8, 8, 8, 8, 8),
    .lvl = 13,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_GUST, MOVE_STRUGGLE_BUG, MOVE_POWDER, MOVE_LIGHT_SCREEN}
    },
    {
    .iv = TRAINER_PARTY_IVS(16, 16, 16, 16, 16, 16),
    .lvl = 15,
    ...
    .moves = {MOVE_U_TURN, MOVE_QUICK_ATTACK, MOVE_LEER, MOVE_FOCUS_ENERGY}
    }
};
...
static const struct TrainerMon sParty_Mary[] = {
    ...
    .lvl = 21,
    .species = SPECIES_FLAAFFY,
    .moves = {MOVE_WILD_CHARGE, MOVE_TAKE_DOWN, MOVE_THUNDER_WAVE, MOVE_GROWL}
    },
    {
    .iv = TRAINER_PARTY_IVS(16, 16, 16, 16, 16, 16),
    .lvl = 22,
    .species = SPECIES_JOLTEON,
    .moves = {MOVE_WILD_CHARGE, MOVE_DOUBLE_KICK, MOVE_THUNDER_WAVE, MOVE_SAND_ATTACK}
    },
    {
    .iv = TRAINER_PARTY_IVS(16, 16, 16, 16, 16, 16),
    .lvl = 22,
    ...
    .moves = {MOVE_BITE, MOVE_SWAGGER, MOVE_WILD_CHARGE, MOVE_ROAR}
    },
    {
    .iv = TRAINER_PARTY_IVS(16, 16, 16, 16, 16, 16),
    .lvl = 22,
    .species = SPECIES_EMOLGA,
    .moves = {MOVE_ELECTRO_BALL, MOVE_SHOCK_WAVE, MOVE_DOUBLE_TEAM, MOVE_PURSUIT}
    },
    {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_WILD_CHARGE, MOVE_SCREECH, MOVE_THUNDER_WAVE, MOVE_SWIFT}
...
static const struct TrainerMon sParty_WpvTr3Battlegirl[] = {
    ...
    .moves = {MOVE_BOUNCE, MOVE_PLUCK, MOVE_ANCIENT_POWER, MOVE_AGILITY}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 21,
    .species = SPECIES_HAWLUCHA,
    .moves = {MOVE_BOUNCE, MOVE_ENCORE, MOVE_AERIAL_ACE}
    }
};
...
static const struct TrainerMon sParty_WpvTr9Lass[] = {
    ...
    .moves = {MOVE_BOUNCE, MOVE_LEECH_SEED, MOVE_BULLET_SEED, MOVE_SLEEP_POWDER}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 21,
...
static const struct TrainerMon sParty_WpvTr14Skyla[] = {
    ...
    .iv = TRAINER_PARTY_IVS(20, 20, 20, 20, 20, 20),
    .lvl = 24,
    .moves = {MOVE_ENDEAVOR, MOVE_WHIRLWIND, MOVE_FLY, MOVE_QUICK_ATTACK},
    .species = SPECIES_STARAVIA,
    },
    {
    .iv = TRAINER_PARTY_IVS(20, 20, 20, 20, 20, 20),
    ...
    .lvl = 26,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FLY, MOVE_STEEL_WING, MOVE_SLASH, MOVE_SAND_ATTACK},
    .species = SPECIES_SKARMORY,
    },
    {
    .iv = TRAINER_PARTY_IVS(20, 20, 20, 20, 20, 20),
...
static const struct TrainerMon sParty_DC3F_Rocket_Proton[] = {
    ...
    .lvl = 31,
    .species = SPECIES_GOLBAT,
    .moves = {MOVE_CONFUSE_RAY, MOVE_MEAN_LOOK, MOVE_POISON_FANG, MOVE_BITE},
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 32,
    .species = SPECIES_TOXTRICITY,
    .moves = {MOVE_TOXIC, MOVE_SWAGGER, MOVE_VENOSHOCK, MOVE_DISCHARGE},
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 33,
    .species = SPECIES_KROKOROK,
    .moves = {MOVE_DIG, MOVE_CRUNCH, MOVE_SWAGGER, MOVE_FOUL_PLAY},
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 34,
    .species = SPECIES_WEEZING,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_GYRO_BALL, MOVE_SELF_DESTRUCT, MOVE_SMOKESCREEN},
    }
};
...
static const struct TrainerMon sParty_DesertTr14_Cooltrainer[] = {
    ...
    .moves = {MOVE_OMINOUS_WIND, MOVE_CURSE, MOVE_WILL_O_WISP, MOVE_PROTECT},
    },
    {
    .iv = TRAINER_PARTY_IVS(20, 20, 20, 20, 20, 20),
    .ev = TRAINER_PARTY_EVS(100, 0, 100, 0, 0, 100),
    ...
    .moves = {MOVE_LEECH_LIFE, MOVE_WING_ATTACK, MOVE_CROSS_POISON, MOVE_CONFUSE_RAY},
    },
    {
    .iv = TRAINER_PARTY_IVS(20, 20, 20, 20, 20, 20),
    .ev = TRAINER_PARTY_EVS(100, 0, 100, 0, 0, 100),
    .lvl = 35,
    .species = SPECIES_BRONZONG,
    .moves = {MOVE_FEINT_ATTACK, MOVE_FUTURE_SIGHT, MOVE_CONFUSE_RAY, MOVE_HYPNOSIS},
    },
    {
    .iv = TRAINER_PARTY_IVS(20, 20, 20, 20, 20, 20),
    .ev = TRAINER_PARTY_EVS(100, 0, 100, 0, 0, 100),
    ...
    .moves = {MOVE_SPIKY_SHIELD, MOVE_DESTINY_BOND, MOVE_SUCKER_PUNCH, MOVE_LEECH_SEED},
    },
    {
    .iv = TRAINER_PARTY_IVS(20, 20, 20, 20, 20, 20),
    .ev = TRAINER_PARTY_EVS(100, 0, 100, 0, 0, 100),
    ...
    .moves = {MOVE_BULLDOZE, MOVE_CRUNCH, MOVE_YAWN, MOVE_SAND_ATTACK},
    }
};
...
static const struct TrainerMon sParty_KG_Clay[] = {
    ...
    .moves = {MOVE_SUPERSONIC, MOVE_MUDDY_WATER, MOVE_STOMPING_TANTRUM, MOVE_UPROAR},
    ...
    .lvl = 38,
    .species = SPECIES_DONPHAN,
    .moves = {MOVE_ROLLOUT, MOVE_STOMPING_TANTRUM, MOVE_SCARY_FACE, MOVE_FIRE_FANG},
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 38,
    ...
    .moves = {MOVE_CRUNCH, MOVE_SWAGGER, MOVE_STOMPING_TANTRUM, MOVE_TORMENT},
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 40,
    .species = SPECIES_EXCADRILL,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_METAL_CLAW, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_SANDSTORM},
    },
};
...
static const struct TrainerMon sParty_HotelBirdKeeper[] = {
    ...
    .species = SPECIES_SKARMORY,
    .moves = {MOVE_TAILWIND, MOVE_SPIKES, MOVE_WHIRLWIND, MOVE_DRILL_PECK}
    },
    {
    .iv = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
    .lvl = 40,
    ...
    .moves = {MOVE_ACROBATICS, MOVE_REVELATION_DANCE, MOVE_TEETER_DANCE}
    }
};
...
static const struct TrainerMon sParty_LeaderKorrina[] = {
    ...
    .moves = {MOVE_BRICK_BREAK, MOVE_SWAGGER, MOVE_CRUNCH, MOVE_POWER_UP_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(22, 22, 22, 22, 22, 22),
    .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 0, 0),
    .lvl = 44,
    .species = SPECIES_TOXICROAK,
    .moves = {MOVE_POISON_JAB, MOVE_POWER_UP_PUNCH, MOVE_SUCKER_PUNCH, MOVE_DRAIN_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(22, 22, 22, 22, 22, 22),
    .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 0, 0),
    .lvl = 45,
    .species = SPECIES_BRELOOM,
    .moves = {MOVE_SPORE, MOVE_MACH_PUNCH, MOVE_POWER_UP_PUNCH, MOVE_SEED_BOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(22, 22, 22, 22, 22, 22),
    .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 0, 0),
    .lvl = 45,
    .species = SPECIES_HAWLUCHA,
    .moves = {MOVE_FLYING_PRESS, MOVE_POWER_UP_PUNCH, MOVE_U_TURN, MOVE_IRON_HEAD}
    },
    {
    .iv = TRAINER_PARTY_IVS(22, 22, 22, 22, 22, 22),
    .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 0, 0),
...
static const struct TrainerMon sParty_Route11Tr14_Acetrainer_F[] = {
    ...
    .moves = {MOVE_FLAME_WHEEL, MOVE_DRILL_RUN, MOVE_MEGAHORN, MOVE_BOUNCE},
    },
    {
    .iv = TRAINER_PARTY_IVS(22, 22, 22, 22, 22, 22),
    .ev = TRAINER_PARTY_EVS(0, 0, 100, 0, 0, 100),
    ...
    .species = SPECIES_ROSERADE,
    .ability = ABILITY_POISON_POINT,
    .moves = {MOVE_LEECH_LIFE, MOVE_GIGA_DRAIN, MOVE_PETAL_BLIZZARD, MOVE_TOXIC_SPIKES},
    },
    {
    .iv = TRAINER_PARTY_IVS(22, 22, 22, 22, 22, 22),
    .ev = TRAINER_PARTY_EVS(0, 0, 100, 0, 0, 100),
    ...
    .moves = {MOVE_NIGHT_SLASH, MOVE_AQUA_JET, MOVE_ICE_FANG, MOVE_POISON_FANG},
    },
    {
    .iv = TRAINER_PARTY_IVS(22, 22, 22, 22, 22, 22),
    .ev = TRAINER_PARTY_EVS(0, 0, 100, 0, 0, 100),
    ...
    .species = SPECIES_AGGRON,
    .ability = ABILITY_STURDY,
    .moves = {MOVE_IRON_HEAD, MOVE_ROCK_SLIDE, MOVE_STOMPING_TANTRUM, MOVE_CUT},
    },
    {
    .iv = TRAINER_PARTY_IVS(22, 22, 22, 22, 22, 22),
    .ev = TRAINER_PARTY_EVS(0, 0, 100, 0, 0, 100),
    ...
    .moves = {MOVE_DAZZLING_GLEAM, MOVE_CONFUSION, MOVE_PSYCHO_CUT, MOVE_FLASH},
    }
};
...
static const struct TrainerMon sParty_Route11Brendan_Rowlet[] = {
    ...
    .moves = {MOVE_BULLDOZE, MOVE_DOUBLE_KICK, MOVE_BOUNCE, MOVE_QUICK_ATTACK},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 38,
    ...
    .gender = TRAINER_MON_FEMALE,
    .nature = NATURE_MILD,
    .moves = {MOVE_DAZZLING_GLEAM, MOVE_CONFUSION, MOVE_WISH},
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 39,
    .species = SPECIES_MORPEKO,
    .moves = {MOVE_BITE, MOVE_SPARK},
    },
    {
    .iv = TRAINER_PARTY_IVS(13, 13, 13, 13, 13, 13),
    .lvl = 40,
    .species = SPECIES_LUCARIO,
    .nature = NATURE_IMPISH,
    .moves = {MOVE_BONE_RUSH, MOVE_POWER_UP_PUNCH, MOVE_METAL_SOUND},
    },
    {
    .iv = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
    .lvl = 41,
    .species = SPECIES_BLAZIKEN,
    .nature = NATURE_SERIOUS,
    .moves = {MOVE_FLAME_CHARGE, MOVE_DOUBLE_KICK, MOVE_BLAZE_KICK, MOVE_PECK}
    }
};
...
static const struct TrainerMon sParty_Route11Brendan_Torchic[] = {
    ...
    .species = SPECIES_EMPOLEON,
    .nature = NATURE_SERIOUS,
    .moves = {MOVE_METAL_CLAW, MOVE_AQUA_JET, MOVE_BRINE, MOVE_SWAGGER},
    }
};
...
static const struct TrainerMon sParty_Route11Brendan_Rowlet_Angry[] = {
    ...
    .lvl = 40,
    .species = SPECIES_MORPEKO,
    .moves = {MOVE_BITE, MOVE_SPARK, MOVE_FLATTER, MOVE_FOUL_PLAY},
    .gender = TRAINER_MON_MALE,
    },
    {
    .iv = TRAINER_PARTY_IVS(13, 13, 13, 13, 13, 13),
    ...
    .species = SPECIES_LUCARIO,
    .gender = TRAINER_MON_FEMALE,
    .moves = {MOVE_BONE_RUSH, MOVE_ROCK_SMASH, MOVE_METAL_CLAW, MOVE_AURA_SPHERE},
    .nature = NATURE_IMPISH,
    },
    {
    .iv = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
...
static const struct TrainerMon sParty_Route11May_Rowlet[] = {
    ...
    .species = SPECIES_LOPUNNY,
    .nature = NATURE_IMPISH,
    .moves = {MOVE_DIZZY_PUNCH, MOVE_AGILITY, MOVE_BATON_PASS, MOVE_JUMP_KICK}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 38,
    ...
    .gender = TRAINER_MON_MALE,
    .nature = NATURE_MILD,
    .moves = {MOVE_PSYCHO_CUT, MOVE_AERIAL_ACE, MOVE_NIGHT_SLASH, MOVE_SLASH}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 39,
...
static const struct TrainerMon sParty_SGTr1_CyclistM1[] = {
    ...
    .lvl = 42,
    .species = SPECIES_HAWLUCHA,
    .moves = {MOVE_BOUNCE, MOVE_SWORDS_DANCE, MOVE_ROOST, MOVE_BRICK_BREAK}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 0, 0),
...
static const struct TrainerMon sParty_SGTr3_CyclistF2[] = {
    ...
    .moves = {MOVE_RAIN_DANCE, MOVE_BUBBLE_BEAM, MOVE_POWER_UP_PUNCH, MOVE_EARTH_POWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 0, 0),
...
static const struct TrainerMon sParty_SGTr5_CyclistF3[] = {
    ...
    .moves = {MOVE_SWAGGER, MOVE_POISON_JAB, MOVE_TOXIC, MOVE_POWER_UP_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 0, 0),
...
static const struct TrainerMon sParty_SGTr6_CyclistM3[] = {
    ...
    .lvl = 43,
    .species = SPECIES_MEDITITE,
    .moves = {MOVE_REVERSAL, MOVE_ZEN_HEADBUTT, MOVE_ACUPRESSURE, MOVE_RECOVER}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .ev = TRAINER_PARTY_EVS(0, 0, 0, 252, 0, 0),
