...
static const u8 sSpikeBodyDescription[] = _("Contact hurts more.");
...
static const u8 sSearingRageDescription[] = _("Boosts Atk at low HP.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_SPIKE_BODY] = _("Spike Body"),
    ...
    [ABILITY_SEARING_RAGE] = _("Searing Rage"),
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_SPIKE_BODY] = sSpikeBodyDescription,
    ...
    [ABILITY_SEARING_RAGE] = sSearingRageDescription,
