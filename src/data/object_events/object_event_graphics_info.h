...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_SleepingYoshi = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_SLEEPING_YOSHI,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 512,
    .width = 32,
    .height = 32,
    ...
    .oam = &gObjectEventBaseOam_32x32,
    .subspriteTables = sOamTables_32x32,
    .anims = sAnimTable_SleepingYoshi,
    .images = sPicTable_SleepingYoshi,
    .affineAnims = gDummySpriteAffineAnimTable,
};

const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_KamekIntro = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_KAMEK_INTRO,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 1152,
    .width = 48,
    .height = 48,
    ...
    .oam = &gObjectEventBaseOam_32x32,
    .subspriteTables = sOamTables_48x48,
    .anims = sAnimTable_KamekIntro,
    .images = sPicTable_KamekIntro,
    .affineAnims = gDummySpriteAffineAnimTable,
};

#define BASE_OBJEVENT_INFO                              \
    .tileTag = TAG_NONE,                                \
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,     \
    .paletteSlot = PALSLOT_NPC_1,                       \
    .shadowSize = SHADOW_SIZE_M,                        \
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Machop2 = {
    BASE_OBJEVENT_INFO,
    .subspriteTables = sOamTables_32x32,
    .paletteTag = OBJ_EVENT_PAL_TAG_MACHOP2,
    .tracks = TRACKS_FOOT,
    .anims = sAnimTable_Standard,
    .images = sPicTable_Machop2,
};
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Kamek = {
    BASE_OBJEVENT_INFO,
    .subspriteTables = sOamTables_32x32,
    .paletteTag = OBJ_EVENT_PAL_TAG_KAMEK,
    .tracks = TRACKS_FOOT,
    .anims = sAnimTable_Standard,
    .images = sPicTable_Kamek,
};

const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_SuperMushroom = {
    BASE_OBJEVENT_INFO,
    .subspriteTables = sOamTables_32x32,
    .paletteTag = OBJ_EVENT_PAL_TAG_SUPERMUSHROOM,
    .tracks = TRACKS_FOOT,
    .anims = sAnimTable_Standard,
    .images = sPicTable_SuperMushroom,
};
...
#define GAME_OVER_INFO      \
    ...
    .tracks = TRACKS_FOOT,  \
    .oam = &gObjectEventBaseOam_32x32,  \
    .anims = sAnimTable_GameOver,   \
    .affineAnims = gDummySpriteAffineAnimTable

const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_GameOver1 = {
    GAME_OVER_INFO,
    .subspriteTables = sOamTables_48x48,
    .paletteTag = OBJ_EVENT_PAL_TAG_GAMEOVER_1,
    .images = sPicTable_GameOver1,
};

const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_GameOver2 = {
    GAME_OVER_INFO,
    .subspriteTables = sOamTables_48x48,
    .paletteTag = OBJ_EVENT_PAL_TAG_GAMEOVER_2,
    .images = sPicTable_GameOver2,
};

const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_GameOver3 = {
    GAME_OVER_INFO,
    .subspriteTables = sOamTables_48x48,
    .paletteTag = OBJ_EVENT_PAL_TAG_GAMEOVER_3,
    .images = sPicTable_GameOver3,
};

const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_GameOver4 = {
    GAME_OVER_INFO,
    .subspriteTables = sOamTables_48x48,
    .paletteTag = OBJ_EVENT_PAL_TAG_GAMEOVER_4,
    .images = sPicTable_GameOver4,
};

const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_GameOver5 = {
    GAME_OVER_INFO,
    .subspriteTables = sOamTables_48x48,
    .paletteTag = OBJ_EVENT_PAL_TAG_GAMEOVER_5,
    .images = sPicTable_GameOver5,
};
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Portal = {
    ...
    .affineAnims = sAffineAnimTable_Portal,
};

const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Kamek2 = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_KAMEK2,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_NONE,
    .size = 256,
    .width = 16,
    .height = 32,
    ...
    .subspriteTables = sOamTables_16x32,
    .anims = sAnimTable_Standard,
    .images = sPicTable_Kamek2,
    .affineAnims = gDummySpriteAffineAnimTable,
};

const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_WaterEgg = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_WATEREGG,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_BRIDGE_REFLECTION,
    .size = 512,
    .width = 32,
    .height = 32,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_EndingYoshi = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_ENDINGYOSHI,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_BRIDGE_REFLECTION,
    .size = 512,
    .width = 32,
    .height = 32,
    ...
    .oam = &gObjectEventBaseOam_32x32,
    .subspriteTables = sOamTables_32x32,
    .anims = sAnimTable_EndingYoshi,
    .images = sPicTable_EndingYoshi,
};

const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_TheEnd = {
    .tileTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_THEEND,
    .reflectionPaletteTag = OBJ_EVENT_PAL_TAG_BRIDGE_REFLECTION,
    .size = 2048,
    .width = 64,
    .height = 64,
