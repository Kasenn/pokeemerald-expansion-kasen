...
static const union AnimCmd sAnim_KamekTalk[] =
{
    ANIMCMD_FRAME(9, 2),
    ANIMCMD_FRAME(10, 6),
    ANIMCMD_FRAME(11, 2),
...
static const union AnimCmd *const sAnimTable_KamekIntro[] = {
    ...
    [ANIM_NURSE_BOW] = sAnim_KamekTalk,
};

static const union AnimCmd *const sAnimTable_SleepingYoshi[] = {
    [ANIM_STD_FACE_SOUTH] = sAnim_FaceSouth,
    [ANIM_STD_FACE_NORTH] = sAnim_FaceNorth,
    [ANIM_STD_FACE_WEST] = sAnim_FaceWest,
...
static const union AnimCmd sAnim_GameOver[] =
{
    ANIMCMD_FRAME(0, 2),
    ANIMCMD_FRAME(1, 2),
    ANIMCMD_FRAME(2, 2),
    ...
    ANIMCMD_FRAME(22, 2),
    ANIMCMD_FRAME(23, 2),
    ANIMCMD_FRAME(24, 8), // this is the start
    ANIMCMD_FRAME(25, 2),
    ANIMCMD_FRAME(26, 2),
    ANIMCMD_FRAME(27, 2),
    ANIMCMD_FRAME(28, 2),
...
static const union AnimCmd *const sAnimTable_GameOver[] = {
    [ANIM_STD_FACE_SOUTH] = sAnim_GameOver,
    [ANIM_STD_FACE_NORTH] = sAnim_GameOver,
    [ANIM_STD_FACE_WEST] = sAnim_GameOver,
    [ANIM_STD_FACE_EAST] = sAnim_GameOver,
    [ANIM_STD_GO_SOUTH] = sAnim_GameOver,
    [ANIM_STD_GO_NORTH] = sAnim_GameOver,
    [ANIM_STD_GO_WEST] = sAnim_GameOver,
    [ANIM_STD_GO_EAST] = sAnim_GameOver,
    [ANIM_STD_GO_FAST_SOUTH] = sAnim_GameOver,
    [ANIM_STD_GO_FAST_NORTH] = sAnim_GameOver,
    [ANIM_STD_GO_FAST_WEST] = sAnim_GameOver,
    [ANIM_STD_GO_FAST_EAST] = sAnim_GameOver,
    [ANIM_STD_GO_FASTER_SOUTH] = sAnim_GameOver,
    [ANIM_STD_GO_FASTER_NORTH] = sAnim_GameOver,
    [ANIM_STD_GO_FASTER_WEST] = sAnim_GameOver,
    [ANIM_STD_GO_FASTER_EAST] = sAnim_GameOver,
    [ANIM_STD_GO_FASTEST_SOUTH] = sAnim_GameOver,
    [ANIM_STD_GO_FASTEST_NORTH] = sAnim_GameOver,
    [ANIM_STD_GO_FASTEST_WEST] = sAnim_GameOver,
    [ANIM_STD_GO_FASTEST_EAST] = sAnim_GameOver,
};

static const union AnimCmd sAnim_DiglettDig[] =
{
    ANIMCMD_FRAME(0,  16),
    ANIMCMD_FRAME(9,  4),
    ANIMCMD_FRAME(10, 4),
...
static const union AnimCmd sAnim_WaterEggSink[] =
{
    ANIMCMD_FRAME(8, 1),
    ANIMCMD_FRAME(9, 1),
    ANIMCMD_FRAME(10, 1),
...
static const union AnimCmd *const sAnimTable_WaterEgg[] = {
    [ANIM_STD_FACE_SOUTH] = sAnim_FaceSouth,
    [ANIM_STD_FACE_NORTH] = sAnim_FaceNorth,
    [ANIM_STD_FACE_WEST] = sAnim_FaceWest,
    [ANIM_STD_FACE_EAST] = sAnim_FaceEast,
    ...
    [ANIM_STD_GO_FASTEST_WEST] = sAnim_GoFastestWest,
    [ANIM_STD_GO_FASTEST_EAST] = sAnim_GoFastestEast,
    [ANIM_NURSE_BOW] = sAnim_WaterEggSink,
};

static const union AnimCmd *const sAnimTable_Diglett[] = {
    [ANIM_STD_FACE_SOUTH] = sAnim_FaceSouth,
    [ANIM_STD_FACE_NORTH] = sAnim_FaceNorth,
    [ANIM_STD_FACE_WEST] = sAnim_FaceWest,
    [ANIM_STD_FACE_EAST] = sAnim_FaceEast,
    ...
    [ANIM_STD_GO_FASTEST_WEST] = sAnim_GoFastestWest,
    [ANIM_STD_GO_FASTEST_EAST] = sAnim_GoFastestEast,
    [ANIM_NURSE_BOW] = sAnim_DiglettDig,
};

#define LOOK_BACK_START_FRAME 8

static const union AnimCmd sAnim_EndingYoshi[] =
{
    // landing
    ANIMCMD_FRAME(1, 4),
    ANIMCMD_FRAME(2, 8),
    ...
    ANIMCMD_FRAME(6, 4),
    // look around back
    ANIMCMD_FRAME(LOOK_BACK_START_FRAME, 8),
    // ANIMCMD_FRAME(LOOK_BACK_START_FRAME + 1, 4),
    ANIMCMD_FRAME(LOOK_BACK_START_FRAME + 2, 8),
    ANIMCMD_FRAME(LOOK_BACK_START_FRAME + 3, 8),
    ANIMCMD_FRAME(LOOK_BACK_START_FRAME + 4, 8),
    ANIMCMD_FRAME(LOOK_BACK_START_FRAME + 5, 32),
    ANIMCMD_FRAME(LOOK_BACK_START_FRAME + 4, 8),
    ANIMCMD_FRAME(LOOK_BACK_START_FRAME + 3, 8),
    ANIMCMD_FRAME(LOOK_BACK_START_FRAME + 2, 8),
    // ANIMCMD_FRAME(LOOK_BACK_START_FRAME + 1, 4),
...
static const union AnimCmd *const sAnimTable_EndingYoshi[] = {
    [ANIM_STD_FACE_SOUTH] = sAnim_FaceSouth,
    [ANIM_STD_FACE_NORTH] = sAnim_FaceNorth,
    [ANIM_STD_FACE_WEST] = sAnim_FaceWest,
    [ANIM_STD_FACE_EAST] = sAnim_FaceEast,
    ...
    [ANIM_STD_GO_FASTEST_WEST] = sAnim_GoFastestWest,
    [ANIM_STD_GO_FASTEST_EAST] = sAnim_GoFastestEast,
    [ANIM_NURSE_BOW] = sAnim_EndingYoshi,
};
