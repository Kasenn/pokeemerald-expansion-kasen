static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_TOWN_WIP2 - 1] = {MAP_GROUP(TOWN_WIP2), MAP_NUM(TOWN_WIP2), 25, 10},
    ...
    [HEAL_LOCATION_KAOLISLE_CITY - 1] = {MAP_GROUP(KAOLISLE_CITY), MAP_NUM(KAOLISLE_CITY), 35, 30},
};
