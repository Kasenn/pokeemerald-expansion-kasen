static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_CORALGROVE_CITY - 1] = {MAP_GROUP(CORALGROVE_CITY), MAP_NUM(CORALGROVE_CITY), 26, 31},
    ...
    [HEAL_LOCATION_SANDSTONE_CITY - 1] = {MAP_GROUP(SANDSTONE_CITY), MAP_NUM(SANDSTONE_CITY), 25, 16},
};
