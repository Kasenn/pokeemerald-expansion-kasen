static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_FISHING_VILLAGE - 1] = {MAP_GROUP(FISHING_VILLAGE), MAP_NUM(FISHING_VILLAGE), 23, 11},
    [HEAL_LOCATION_DRISLEDGE_TOWN - 1] = {MAP_GROUP(DRISLEDGE_TOWN), MAP_NUM(DRISLEDGE_TOWN), 25, 25},
