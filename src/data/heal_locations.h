static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_ROCKLIFFE_TOWN - 1] = {MAP_GROUP(ROCKLIFFE_TOWN), MAP_NUM(ROCKLIFFE_TOWN), 23, 14},
    ...
    [HEAL_LOCATION_AMBEROCK_TOWN - 1] = {MAP_GROUP(AMBEROCK_TOWN), MAP_NUM(AMBEROCK_TOWN), 31, 30},
    [HEAL_LOCATION_BASALUFF_TOWN - 1] = {MAP_GROUP(BASALUFF_TOWN), MAP_NUM(BASALUFF_TOWN), 10, 10},
    [HEAL_LOCATION_EVERFROST_TOWN - 1] = {MAP_GROUP(EVERFROST_TOWN), MAP_NUM(EVERFROST_TOWN), 10, 10},
    [HEAL_LOCATION_FROSTFIRE_CITY - 1] = {MAP_GROUP(FROSTFIRE_CITY), MAP_NUM(FROSTFIRE_CITY), 10, 10},
    ...
    [HEAL_LOCATION_SNOWCREST_CITY - 1] = {MAP_GROUP(SNOWCREST_CITY), MAP_NUM(SNOWCREST_CITY), 10, 10},
    [HEAL_LOCATION_GALEWIND_CITY - 1] = {MAP_GROUP(GALEWIND_CITY), MAP_NUM(GALEWIND_CITY), 10, 10},
