...
const struct Tileset gTileset_Ranch =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Ranch,
    .palettes = gTilesetPalettes_Ranch,
    .metatiles = gMetatiles_Ranch,
    .metatileAttributes = gMetatileAttributes_Ranch,
    .callback = InitTilesetAnim_Lilycove,
};
...
const struct Tileset gTileset_gTileset_Birchseed =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_gTileset_Birchseed,
    .palettes = gTilesetPalettes_gTileset_Birchseed,
    .metatiles = gMetatiles_gTileset_Birchseed,
    .metatileAttributes = gMetatileAttributes_gTileset_Birchseed,
    .callback = NULL,
};
...
const struct Tileset gTileset_Pearlwood =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Pearlwood_Secondary,
    .palettes = gTilesetPalettes_Pearlwood_Secondary,
    .metatiles = gMetatiles_Pearlwood_Secondary,
    .metatileAttributes = gMetatileAttributes_Pearlwood_Secondary,
    .callback = InitTilesetAnim_General,
};
...
const struct Tileset gTileset_DarkForestSec =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_DarkForestSec,
...
const struct Tileset gTileset_CaveTiles =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_CaveTiles,
    .palettes = gTilesetPalettes_CaveTiles,
    .metatiles = gMetatiles_CaveTiles,
...
const struct Tileset gTileset_DrisledgeGym =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_DrisledgeGym,
    .palettes = gTilesetPalettes_DrisledgeGym,
    .metatiles = gMetatiles_DrisledgeGym,
    .metatileAttributes = gMetatileAttributes_DrisledgeGym,
    .callback = NULL,
};

const struct Tileset gTileset_HerbShop =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_HerbShop,
    .palettes = gTilesetPalettes_HerbShop,
    .metatiles = gMetatiles_HerbShop,
    .metatileAttributes = gMetatileAttributes_HerbShop,
    .callback = NULL,
};

const struct Tileset gTileset_Amberock =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Amberock,
...
const struct Tileset gTileset_Lab2 =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Lab2,
    .palettes = gTilesetPalettes_Lab2,
...
const struct Tileset gTileset_VictoryRoad =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_VictoryRoad,
    .palettes = gTilesetPalettes_VictoryRoad,
    .metatiles = gMetatiles_VictoryRoad,
...
const struct Tileset gTileset_LatiIsles =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_LatiIsles,
...
const struct Tileset gTileset_Nes =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_Nes,
    .palettes = gTilesetPalettes_Nes,
    .metatiles = gMetatiles_Nes,
...
const struct Tileset gTileset_Route2New =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Route2New,
    .palettes = gTilesetPalettes_Route2New,
    .metatiles = gMetatiles_Route2New,
