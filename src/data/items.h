...
// TMs/HMs. They don't have a set flingPower, as that's handled by GetFlingPowerFromItemId.
    ...
    [ITEM_TM_FOCUS_PUNCH] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "before launching a punch.\n"
            "It will fail if the user\n"
    ...
    [ITEM_TM_DRAGON_CLAW] =
    {
        ...
        .price = 3000,
        .description = COMPOUND_STRING(
            "Sharp, huge claws hook\n"
            "and slash the foe quickly\n"
    ...
    [ITEM_TM_CALM_MIND] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "its mind and calms its\n"
            "spirit to raise its Sp. Atk\n"
            "and Sp. Def stats."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
    ...
    [ITEM_TM_ROAR] =
    {
        ...
        .price = 8000,
        .description = COMPOUND_STRING(
            "The foe is made to switch\n"
            "out with an ally. In the\n"
    ...
    [ITEM_TM_HAIL] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "lasts for five turns. The\n"
            "hailstorm damages all\n"
            "types except Ice."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
    ...
    [ITEM_TM_BULLET_SEED] =
    {
        ...
        .description = COMPOUND_STRING(
            "The user forcefully\n"
            "shoots seeds at the foe.\n"
            "Two to five seeds are shot\n"
            "in rapid succession."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
    ...
    [ITEM_TM_TAUNT] =
    {
        ...
        .price = 3000,
        .description = COMPOUND_STRING(
            "The foe is taunted into a\n"
            "rage that allows it to use\n"
            "only attack moves for two\n"
            "to four turns."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
    ...
    [ITEM_TM_LIGHT_SCREEN] =
    {
        ...
        .price = 30000,
        .description = COMPOUND_STRING(
            "A wondrous wall of light\n"
            "is put up to suppress\n"
            "damage from special\n"
    ...
    [ITEM_TM_FRUSTRATION] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "grows more powerful the\n"
            "less the user likes its\n"
            "trainer."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
    ...
    [ITEM_TM_IRON_TAIL] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "sturdy tail of steel. It\n"
            "may also lower the target's\n"
            "Defense stat if it hits."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
    ...
    [ITEM_TM_DOUBLE_TEAM] =
    {
        ...
        .price = 2000,
        .description = COMPOUND_STRING(
            "The user begins moving so\n"
            "quickly that it creates\n"
            "illusory copies to\n"
    ...
    [ITEM_TM_REFLECT] =
    {
        ...
        .price = 30000,
        .description = COMPOUND_STRING(
            "A wondrous wall is put up\n"
            "to suppress damage from\n"
    ...
    [ITEM_TM_SHOCK_WAVE] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_SHOCK_WAVE, // Bp move
    },
    ...
    [ITEM_TM_SLUDGE_BOMB] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "filthy sludge at the foe.\n"
            "It may also poison the\n"
            "target."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
    ...
    [ITEM_TM_SANDSTORM] =
    {
        ...
        .price = 2000,
        .description = COMPOUND_STRING(
            "A five-turn sandstorm is\n"
            "summoned to hurt all\n"
            "Pokémon except the Rock,\n"
    ...
    [ITEM_TM_FIRE_BLAST] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "intense blast of all-\n"
            "consuming fire. It may also\n"
            "burn the target."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
    ...
    [ITEM_TM_AERIAL_ACE] =
    {
        ...
        .price = 3000,
        .description = COMPOUND_STRING(
            "The user confounds the foe\n"
            "with speed, then strikes.\n"
            "The attack lands without\n"
            "fail."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
    ...
    [ITEM_TM_TORMENT] =
    {
        ...
        .price = 3000,
        .description = COMPOUND_STRING(
            "The user torments and\n"
            "enrages the foe, making it\n"
            "incapable of using the same\n"
            "move twice in a row."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
    ...
    [ITEM_TM_FACADE] =
    {
        ...
        .description = COMPOUND_STRING(
            "An attack move that\n"
            "doubles its power if the\n"
            "user is poisoned, paralyzed,\n"
            "or has a burn."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
    ...
    [ITEM_TM_REST] =
    {
        ...
        .price = 3000,
        .description = COMPOUND_STRING(
            "The user sleeps for two\n"
            "turns to fully restore HP\n"
            "and heal any status\n"
            "problem."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM_THIEF] =
    {
        ...
        .price = 3000,
        .description = COMPOUND_STRING(
            "The user attacks and steals\n"
            "the foe's held item.\n"
            "It can't steal if the user\n"
            "holds an item."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
    ...
    [ITEM_TM_OVERHEAT] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "full power using fiery\n"
            "energy. It also sharply\n"
    ...
    [ITEM_TM_ENERGY_BALL] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_ENERGY_BALL, // Not In-Game Yet
    },
    ...
    [ITEM_TM_PSYSHOCK] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_PSYSHOCK, // Not In-Game Yet
    },
    ...
    [ITEM_TM_SKY_DROP] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_SKY_DROP, // Not In-Game Yet
    },
    ...
    [ITEM_TM_MEGAHORN] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_MEGAHORN, // Not In-Game Yet
    },
    ...
    [ITEM_TM_WILL_O_WISP] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_WILL_O_WISP, // Not In-Game Yet
    },
    ...
    [ITEM_TM_ACROBATICS] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_ACROBATICS, // Not In-Game Yet
    },
    ...
    [ITEM_TM_EMBARGO] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_EMBARGO, // Not In-Game Yet
    },
    ...
    [ITEM_TM_EXPLOSION] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_EXPLOSION, // Not In-Game Yet
    },
    ...
    [ITEM_TM_PAYBACK] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_PAYBACK, // Not In-Game Yet
    },
    ...
    [ITEM_TM_RECYCLE] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_RECYCLE, // Not In-Game Yet
    },
    ...
    [ITEM_TM_GIGA_IMPACT] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_GIGA_IMPACT, // Not In-Game Yet
    },
    ...
    [ITEM_TM_AURORA_VEIL] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_AURORA_VEIL, // Not In-Game Yet
    },
    ...
    [ITEM_TM_STONE_EDGE] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_STONE_EDGE, // Not In-Game Yet
    },
    ...
    [ITEM_TM_VOLT_SWITCH] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_VOLT_SWITCH, // Not In-Game Yet
    },
    ...
    [ITEM_TM_CROSS_POISON] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_CROSS_POISON, // Not In-Game Yet
    },
    ...
    [ITEM_TM_GYRO_BALL] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_GYRO_BALL, // Not In-Game Yet
    },
    ...
    [ITEM_TM_SWORDS_DANCE] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_SWORDS_DANCE, // Not In-Game Yet
    },
    ...
    [ITEM_TM_STRUGGLE_BUG] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_STRUGGLE_BUG, // Not In-Game Yet
    },
    ...
    [ITEM_TM_HEX] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_HEX, // Not In-Game Yet
    },
    ...
    [ITEM_TM_FROST_BREATH] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_FROST_BREATH, // Not In-Game Yet
    },
    ...
    [ITEM_TM_X_SCISSOR] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_X_SCISSOR, // Not In-Game Yet
    },
    ...
    [ITEM_TM_DRAGON_TAIL] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_DRAGON_TAIL, // Not In-Game Yet
    },
    ...
    [ITEM_TM_RAZOR_SHELL] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_RAZOR_SHELL, // Not In-Game Yet
    },
    ...
    [ITEM_TM_DREAM_EATER] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_DREAM_EATER, // Not In-Game Yet
    },
    ...
    [ITEM_TM_SWAGGER] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_SWAGGER, // Not In-Game Yet
    },
    ...
    [ITEM_TM_PLUCK] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_PLUCK, // Not In-Game Yet
    },
    ...
    [ITEM_TM_SPIKES] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_SPIKES, // Not In-Game Yet
    },
    ...
    [ITEM_TM_SNARL] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_SNARL, // Not In-Game Yet
    },
    ...
    [ITEM_TM_DARK_PULSE] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_DARK_PULSE, // Not In-Game Yet
    },
    ...
    [ITEM_TM_POWER_UP_PUNCH] =
    {
        ...
        .price = 3000,
        .description = COMPOUND_STRING(
            "Striking opponents over and\n"
            "over makes the user's fists\n"
            "harder. Hitting a target\n"
    ...
    [ITEM_TM_DAZZLING_GLEAM] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_DAZZLING_GLEAM, // Not In-Game Yet
    },
    ...
    [ITEM_TM_DRAGON_DANCE] =
    {
        ...
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        .secondaryId = MOVE_DRAGON_DANCE, // Not In-Game Yet
    },
    ...
    [ITEM_HM_FLY] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "It can also be used to fly\n"
            "to any familiar town."),
        .importance = 1,
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM,
...
// GEN 9 ITEMS
    ...
    [ITEM_HERBAL_MIX_QUEST] =
    {
        ...
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .iconPic = gItemIcon_HerbalMixQuest,
        .iconPalette = gItemIconPalette_HerbalMixQuest,
    },
    ...
    [ITEM_JASM_LETTER] =
    {
        ...
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .iconPic = gItemIcon_JasmLetter,
        .iconPalette = gItemIconPalette_JasmLetter,
    },
    ...
    [ITEM_COIN_PURSE] =
    {
        ...
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .iconPic = gItemIcon_CoinPurse,
        .iconPalette = gItemIconPalette_CoinPurse,
    },
    ...
    [ITEM_TALISMAN] =
    {
        ...
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .iconPic = gItemIcon_Talisman,
        .iconPalette = gItemIconPalette_Talisman,
    },
    ...
    [ITEM_LOST_KEY] =
    {
        ...
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .iconPic = gItemIcon_LostKey,
        .iconPalette = gItemIconPalette_LostKey,
    },
    ...
    [ITEM_ANCIENT_STONE] =
    {
        ...
        .effect = gItemEffect_EvoItem,
        .flingPower = 80,
        .iconPic = gItemIcon_AncientStone,
        .iconPalette = gItemIconPalette_AncientStone,
    },
    [ITEM_LOST_MEMENTO] =
    {
        .name = _("Lost Memento"),
        ...
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .iconPic = gItemIcon_LostMemento,
        .iconPalette = gItemIconPalette_LostMemento,
    },
    [ITEM_SAMPLE_BOX] =
    {
        .name = _("Sample Box"),
        ...
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_SampleBox,
        .iconPic = gItemIcon_SampleBox,
        .iconPalette = gItemIconPalette_SampleBox,
    },
    [ITEM_SPECIAL_SOUP] =
    {
        .name = _("Savory Soup"),
        ...
        .iconPic = gItemIcon_SpecialSoup,
        .iconPalette = gItemIconPalette_SpecialSoup,
        .flingPower = 30,
    },
    [ITEM_ROSTE_BERRY] =
    {
        ...
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 10,
        .iconPic = gItemIcon_RosteBerry,
        .iconPalette = gItemIconPalette_RosteBerry,
    },
    [ITEM_CURRY] =
    {
        .name = _("Curry"),
        ...
        .battleUsage = EFFECT_ITEM_HEAL_AND_CURE_STATUS,
        .flingPower = 30,
        .iconPic = gItemIcon_Curry,
        .iconPalette = gItemIconPalette_Curry,
    },
    [ITEM_EMPOLEONITE] =
    {
        .name = _("Empoleonite"),
    ...
    [ITEM_DECIDUEITE] =
    {
        ...
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 80,
        .iconPic = gItemIcon_Decidueite,
        .iconPalette = gItemIconPalette_Decidueite,
    },
    [ITEM_INCINEROARITE] =
    {
        .name = _("Incineroarite"),
        .price = 0,
        .holdEffect = HOLD_EFFECT_MEGA_STONE,
        .description = COMPOUND_STRING(
            "This stone enables\n"
    ...
    [ITEM_PROCESSOR] =
    {
        ...
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .flingPower = 80,
        .iconPic = gItemIcon_Processor,
        .iconPalette = gItemIconPalette_Processor,
    },
    [ITEM_CHESNAUGHTITE] =
    {
    ...
    [ITEM_STEEL_SPHERE] =
    {
        ...
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .iconPic = gItemIcon_SteelSphere,
        .iconPalette = gItemIconPalette_SteelSphere,
    },
    [ITEM_FAIRY_FEATHER] =
    {
    ...
    [ITEM_HISTORY_BOOK] =
    {
        ...
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
        .iconPic = gItemIcon_HistoryBook,
        .iconPalette = gItemIconPalette_HistoryBook,
    },
