...
// TMs/HMs. They don't have a set flingPower, as that's handled by GetFlingPowerFromItemId.
    ...
    [ITEM_TM_SHOCK_WAVE] =
    {
        ...
        .pocket = POCKET_TM_HM,
        .type = ITEM_USE_PARTY_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_TMHM, //wip, BP move
    },
...
// Story Key Items
    ...
    {
        .name = ITEM_NAME("Research Papers"),
        .pluralName = ITEM_PLURAL_NAME("Research Papers"),
        .price = 0,
        .description = COMPOUND_STRING(
            "A briefcase\n"
            "containing\n"
