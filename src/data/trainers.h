...
const struct Trainer gTrainers[TRAINERS_COUNT] =
{
    ...
    [TRAINER_R15_ACETRAINER_M] =    {BW_ACE_M,          ADV_AI,         NAME("Camden"),         TPARTY(sParty_TRAINER_R15_ACEsParty_TRAINER_M)},
    [TRAINER_R15_ACETRAINER_F] =    {BW_ACE_F,          ADV_AI | HPA,   NAME("Donny"),          TPARTY(sParty_TRAINER_R15_ACEsParty_TRAINER_F)},
