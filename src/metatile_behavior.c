...
static const u8 sTileBitAttributes[NUM_METATILE_BEHAVIORS] =
{
    ...
    [MB_BLOCK_STR_BOULDER]               = TILE_FLAG_UNUSED,
    ...
    [MB_RHH_ROCK_CLIMB]                         = TILE_FLAG_UNUSED,
};
...
{
    if (metatileBehavior == MB_TALL_GRASS || metatileBehavior == MB_LONG_GRASS || metatileBehavior == MB_TALL_GRASS_AUTUMN || metatileBehavior == MB_TALL_GRASS_RED || metatileBehavior == MB_CYCLING_ROAD_PULL_DOWN_GRASS)
        return TRUE;
    else
        return FALSE;
}
...
bool8 MetatileBehavior_IsBoulderBlocking(u8 metatileBehavior)
{
    if (metatileBehavior == MB_BLOCK_STR_BOULDER)
        return TRUE;
    else
        return FALSE;
}
...
{
    if (metatileBehavior == MB_TALL_GRASS || metatileBehavior == MB_TALL_GRASS_AUTUMN || metatileBehavior == MB_TALL_GRASS_RED || metatileBehavior == MB_CYCLING_ROAD_PULL_DOWN_GRASS)
        return TRUE;
    else
        return FALSE;
}
...
{
    if (metatileBehavior == MB_RHH_ROCK_CLIMB)
        return TRUE;
    else
        return FALSE;
}
