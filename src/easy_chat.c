...
static void TryAddInterviewObjectEvents(void)
{
    ...
    spriteId = CreateObjectGraphicsSprite(
        FEMALE == MALE ? OBJ_EVENT_GFX_RIVAL_BRENDAN_NORMAL : OBJ_EVENT_GFX_RIVAL_MAY_NORMAL,
        SpriteCallbackDummy,
        52,
        40,
        0);
...
static bool8 UNUSED CanPhraseFitInXRowsYCols(const u16 *easyChatWords, u8 numRows, u8 numColumns, u16 maxLength)
{
    u8 i, j;
