...
static bool8 ShouldJumpLongLedge(s16 x, s16 y, udir direction)
{
...
static bool8 TryPushBoulder(s16 x, s16 y, enum Direction direction)
{
    if (FlagGet(FLAG_SYS_USE_STRENGTH))
    {
        ...
        if (objectEventId != OBJECT_EVENTS_COUNT && (gObjectEvents[objectEventId].graphicsId == OBJ_EVENT_GFX_PUSHABLE_BOULDER || gObjectEvents[objectEventId].graphicsId == OBJ_EVENT_GFX_CRATE || gObjectEvents[objectEventId].graphicsId == OBJ_EVENT_GFX_PUSHABLE_BOULDER_FRLG))
        {
