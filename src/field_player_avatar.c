...
static const u16 sPlayerAvatarOrasGfxIds[][2] =
{
    ...
    [PLAYER_AVATAR_STATE_ROCK_CLIMBING] = {OBJ_EVENT_GFX_BRENDAN_SURFING_ORAS,      OBJ_EVENT_GFX_MAY_SURFING_ORAS},
    [PLAYER_AVATAR_STATE_UNDERWATER]    = {OBJ_EVENT_GFX_BRENDAN_UNDERWATER,        OBJ_EVENT_GFX_MAY_UNDERWATER_ORAS},
    [PLAYER_AVATAR_STATE_FIELD_MOVE]    = {OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE_ORAS,   OBJ_EVENT_GFX_MAY_FIELD_MOVE_ORAS},
...
static const u16 sPlayerAvatarGfxToStateFlagOras[GENDER_COUNT][10][2] =
{
    [MALE] =
    {
        {OBJ_EVENT_GFX_BRENDAN_NORMAL_ORAS,     PLAYER_AVATAR_FLAG_ON_FOOT},
    ...
    [FEMALE] =
    {
        {OBJ_EVENT_GFX_MAY_NORMAL_ORAS,         PLAYER_AVATAR_FLAG_ON_FOOT},
...
u8 GetPlayerAvatarGenderByGraphicsId(u16 gfxId)
{
    ...
    case OBJ_EVENT_GFX_MAY_NORMAL_ORAS:
    case OBJ_EVENT_GFX_MAY_ACRO_BIKE_ORAS:
    case OBJ_EVENT_GFX_MAY_SURFING_ORAS:
    case OBJ_EVENT_GFX_MAY_FIELD_MOVE_ORAS:
    case OBJ_EVENT_GFX_MAY_UNDERWATER_ORAS:
    case OBJ_EVENT_GFX_MAY_FISHING_ORAS:
