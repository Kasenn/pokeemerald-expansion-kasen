...
static bool8 ShouldJumpLongLedge(s16, s16, enum Direction);
...
static void PlayerWalkSuperSlow(enum Direction direction);
static void PlayerRunSuperSlow(enum Direction direction);
...
static const u16 sPlayerAvatarGfxIds[OUTFIT_COUNT][19][GENDER_COUNT] =
{
    [OUTFIT_RUBYSAPPHIRE] =
    {
        [PLAYER_AVATAR_STATE_NORMAL]        = {OBJ_EVENT_GFX_BRENDAN_RS_NORMAL,         OBJ_EVENT_GFX_MAY_RS_NORMAL},
        [PLAYER_AVATAR_STATE_BIKE]          = {OBJ_EVENT_GFX_BRENDAN_RS_BIKE,           OBJ_EVENT_GFX_MAY_RS_BIKE},
        [PLAYER_AVATAR_STATE_FIELD_MOVE]    = {OBJ_EVENT_GFX_BRENDAN_RS_FIELD_MOVE,     OBJ_EVENT_GFX_MAY_RS_FIELD_MOVE},
        [PLAYER_AVATAR_STATE_FISHING]       = {OBJ_EVENT_GFX_BRENDAN_RS_FISHING,        OBJ_EVENT_GFX_MAY_RS_FISHING},
        [PLAYER_AVATAR_STATE_WATERING]      = {OBJ_EVENT_GFX_BRENDAN_RS_WATERING,       OBJ_EVENT_GFX_MAY_RS_WATERING},
        [PLAYER_AVATAR_STATE_FERTILIZING]   = {OBJ_EVENT_GFX_BRENDAN_RS_FERTILIZING,    OBJ_EVENT_GFX_MAY_RS_FERTILIZING},
        ...
        [PLAYER_AVATAR_STATE_SURFING]       = {OBJ_EVENT_GFX_BRENDAN_RS_RIDE,           OBJ_EVENT_GFX_MAY_RS_RIDE},
        [PLAYER_AVATAR_STATE_ROCK_CLIMBING] = {OBJ_EVENT_GFX_BRENDAN_RS_RIDE,           OBJ_EVENT_GFX_MAY_RS_RIDE},
        [PLAYER_AVATAR_STATE_GOGOAT]        = {OBJ_EVENT_GFX_BRENDAN_RS_RIDE,           OBJ_EVENT_GFX_MAY_RS_RIDE},
    },
    [OUTFIT_EMERALD] =
    {
        ...
        [PLAYER_AVATAR_STATE_SURFING]       = {OBJ_EVENT_GFX_BRENDAN_RIDE,              OBJ_EVENT_GFX_MAY_RIDE},
        [PLAYER_AVATAR_STATE_ROCK_CLIMBING] = {OBJ_EVENT_GFX_BRENDAN_RIDE,              OBJ_EVENT_GFX_MAY_RIDE},
        [PLAYER_AVATAR_STATE_GOGOAT]        = {OBJ_EVENT_GFX_BRENDAN_RIDE,              OBJ_EVENT_GFX_MAY_RIDE},
    },
    [OUTFIT_ORAS] =
    {
        [PLAYER_AVATAR_STATE_NORMAL]        = {OBJ_EVENT_GFX_BRENDAN_ORAS_NORMAL,       OBJ_EVENT_GFX_MAY_ORAS_NORMAL},
        [PLAYER_AVATAR_STATE_BIKE]          = {OBJ_EVENT_GFX_BRENDAN_ORAS_BIKE,         OBJ_EVENT_GFX_MAY_ORAS_BIKE},
        [PLAYER_AVATAR_STATE_FIELD_MOVE]    = {OBJ_EVENT_GFX_BRENDAN_ORAS_FIELD_MOVE,   OBJ_EVENT_GFX_MAY_ORAS_FIELD_MOVE},
        [PLAYER_AVATAR_STATE_FISHING]       = {OBJ_EVENT_GFX_BRENDAN_ORAS_FISHING,      OBJ_EVENT_GFX_MAY_ORAS_FISHING},
        [PLAYER_AVATAR_STATE_WATERING]      = {OBJ_EVENT_GFX_BRENDAN_ORAS_WATERING,     OBJ_EVENT_GFX_MAY_ORAS_WATERING},
        [PLAYER_AVATAR_STATE_FERTILIZING]   = {OBJ_EVENT_GFX_BRENDAN_ORAS_FERTILIZING,  OBJ_EVENT_GFX_MAY_ORAS_FERTILIZING},
        ...
        [PLAYER_AVATAR_STATE_SURFING]       = {OBJ_EVENT_GFX_BRENDAN_ORAS_RIDE,         OBJ_EVENT_GFX_MAY_ORAS_RIDE},
        [PLAYER_AVATAR_STATE_ROCK_CLIMBING] = {OBJ_EVENT_GFX_BRENDAN_ORAS_RIDE,         OBJ_EVENT_GFX_MAY_ORAS_RIDE},
        [PLAYER_AVATAR_STATE_GOGOAT]        = {OBJ_EVENT_GFX_BRENDAN_ORAS_RIDE,         OBJ_EVENT_GFX_MAY_ORAS_RIDE},
    },
    [OUTFIT_CONTEST] =
    {
        [PLAYER_AVATAR_STATE_NORMAL]        = {OBJ_EVENT_GFX_BRENDAN_CONTEST_NORMAL,        OBJ_EVENT_GFX_MAY_CONTEST_NORMAL},
        [PLAYER_AVATAR_STATE_BIKE]          = {OBJ_EVENT_GFX_BRENDAN_CONTEST_BIKE,          OBJ_EVENT_GFX_MAY_CONTEST_BIKE},
        [PLAYER_AVATAR_STATE_FIELD_MOVE]    = {OBJ_EVENT_GFX_BRENDAN_CONTEST_FIELD_MOVE,    OBJ_EVENT_GFX_MAY_CONTEST_FIELD_MOVE},
        [PLAYER_AVATAR_STATE_FISHING]       = {OBJ_EVENT_GFX_BRENDAN_CONTEST_FISHING,       OBJ_EVENT_GFX_MAY_CONTEST_FISHING},
        [PLAYER_AVATAR_STATE_WATERING]      = {OBJ_EVENT_GFX_BRENDAN_CONTEST_WATERING,      OBJ_EVENT_GFX_MAY_CONTEST_WATERING},
        [PLAYER_AVATAR_STATE_FERTILIZING]   = {OBJ_EVENT_GFX_BRENDAN_CONTEST_FERTILIZING,   OBJ_EVENT_GFX_MAY_CONTEST_FERTILIZING},
        [PLAYER_AVATAR_STATE_4PX_SNOW]      = {OBJ_EVENT_GFX_BRENDAN_CONTEST_4PX_SNOW,      OBJ_EVENT_GFX_MAY_CONTEST_4PX_SNOW},
        [PLAYER_AVATAR_STATE_6PX_SNOW]      = {OBJ_EVENT_GFX_BRENDAN_CONTEST_6PX_SNOW,      OBJ_EVENT_GFX_MAY_CONTEST_6PX_SNOW},
        [PLAYER_AVATAR_STATE_8PX_SNOW]      = {OBJ_EVENT_GFX_BRENDAN_CONTEST_8PX_SNOW,      OBJ_EVENT_GFX_MAY_CONTEST_8PX_SNOW},
        [PLAYER_AVATAR_STATE_10PX_SNOW]     = {OBJ_EVENT_GFX_BRENDAN_CONTEST_10PX_SNOW,     OBJ_EVENT_GFX_MAY_CONTEST_10PX_SNOW},
        [PLAYER_AVATAR_STATE_SURFING]       = {OBJ_EVENT_GFX_BRENDAN_CONTEST_RIDE,          OBJ_EVENT_GFX_MAY_CONTEST_RIDE},
        [PLAYER_AVATAR_STATE_ROCK_CLIMBING] = {OBJ_EVENT_GFX_BRENDAN_CONTEST_RIDE,          OBJ_EVENT_GFX_MAY_CONTEST_RIDE},
        [PLAYER_AVATAR_STATE_GOGOAT]        = {OBJ_EVENT_GFX_BRENDAN_CONTEST_RIDE,          OBJ_EVENT_GFX_MAY_CONTEST_RIDE},
    }
};
...
} sPlayerAvatarGfxToStateFlag[OUTFIT_COUNT][GENDER_COUNT][10] =
{
    [OUTFIT_RUBYSAPPHIRE] =
    {
        [MALE] =
        {
            ...
            {OBJ_EVENT_GFX_BRENDAN_RS_BIKE,         PLAYER_AVATAR_FLAG_BIKE},
            {OBJ_EVENT_GFX_BRENDAN_RS_RIDE,         PLAYER_AVATAR_FLAG_SURFING},
        ...
        [FEMALE] =
        {
            ...
            {OBJ_EVENT_GFX_MAY_RS_BIKE,             PLAYER_AVATAR_FLAG_BIKE},
            {OBJ_EVENT_GFX_MAY_RS_RIDE,             PLAYER_AVATAR_FLAG_SURFING},
    ...
    [OUTFIT_EMERALD] =
    {
        [MALE] =
        {
            ...
            {OBJ_EVENT_GFX_BRENDAN_RIDE,            PLAYER_AVATAR_FLAG_SURFING},
        ...
        [FEMALE] =
        {
            ...
            {OBJ_EVENT_GFX_MAY_RIDE,                PLAYER_AVATAR_FLAG_SURFING},
    ...
    [OUTFIT_ORAS] =
    {
        [MALE] =
        {
            ...
            {OBJ_EVENT_GFX_BRENDAN_ORAS_BIKE,       PLAYER_AVATAR_FLAG_BIKE},
            {OBJ_EVENT_GFX_BRENDAN_ORAS_BIKE,       PLAYER_AVATAR_FLAG_BIKE},
            {OBJ_EVENT_GFX_BRENDAN_ORAS_RIDE,       PLAYER_AVATAR_FLAG_SURFING},
            {OBJ_EVENT_GFX_BRENDAN_UNDERWATER,      PLAYER_AVATAR_FLAG_UNDERWATER},
        ...
        [FEMALE] =
        {
            ...
            {OBJ_EVENT_GFX_MAY_ORAS_BIKE,           PLAYER_AVATAR_FLAG_BIKE},
            {OBJ_EVENT_GFX_MAY_ORAS_BIKE,           PLAYER_AVATAR_FLAG_BIKE},
            {OBJ_EVENT_GFX_MAY_ORAS_RIDE,           PLAYER_AVATAR_FLAG_SURFING},
    ...
    [OUTFIT_CONTEST] =
    {
        [MALE] =
        {
            {OBJ_EVENT_GFX_BRENDAN_CONTEST_NORMAL,      PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_BRENDAN_CONTEST_BIKE,        PLAYER_AVATAR_FLAG_BIKE},
            {OBJ_EVENT_GFX_BRENDAN_CONTEST_BIKE,        PLAYER_AVATAR_FLAG_BIKE},
            {OBJ_EVENT_GFX_BRENDAN_CONTEST_RIDE,        PLAYER_AVATAR_FLAG_SURFING},
            {OBJ_EVENT_GFX_BRENDAN_CONTEST_4PX_SNOW,    PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_BRENDAN_CONTEST_6PX_SNOW,    PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_BRENDAN_CONTEST_8PX_SNOW,    PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_BRENDAN_CONTEST_10PX_SNOW,   PLAYER_AVATAR_FLAG_ON_FOOT},
        },
        [FEMALE] =
        {
            {OBJ_EVENT_GFX_MAY_CONTEST_NORMAL,          PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_MAY_CONTEST_BIKE,            PLAYER_AVATAR_FLAG_BIKE},
            {OBJ_EVENT_GFX_MAY_CONTEST_BIKE,            PLAYER_AVATAR_FLAG_BIKE},
            {OBJ_EVENT_GFX_MAY_CONTEST_RIDE,            PLAYER_AVATAR_FLAG_SURFING},
            {OBJ_EVENT_GFX_MAY_CONTEST_4PX_SNOW,        PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_MAY_CONTEST_6PX_SNOW,        PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_MAY_CONTEST_8PX_SNOW,        PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_MAY_CONTEST_10PX_SNOW,       PLAYER_AVATAR_FLAG_ON_FOOT},
        }
    },
};
...
static bool8 ShouldJumpLongLedge(s16 x, s16 y, enum Direction direction)
{
...
static bool8 TryPushBoulder(s16 x, s16 y, enum Direction direction)
{
    if (FlagGet(FLAG_SYS_USE_STRENGTH))
    {
        ...
        if (objectEventId != OBJECT_EVENTS_COUNT && (gObjectEvents[objectEventId].graphicsId == OBJ_EVENT_GFX_PUSHABLE_BOULDER || gObjectEvents[objectEventId].graphicsId == OBJ_EVENT_GFX_PUSHABLE_BOULDER_FRLG || gObjectEvents[objectEventId].graphicsId == OBJ_EVENT_GFX_CRATE))
        {
...
void PlayerJumpLedgeLong(enum Direction direction)
{
    PlaySE(SE_LEDGE);
...
static u8 GetPlayerAvatarStateTransitionByGraphicsId(u16 graphicsId, u8 gender)
{
    ...
    {
        if (sPlayerAvatarGfxToStateFlag[outfit][gender][i].graphicsId == graphicsId)
            return sPlayerAvatarGfxToStateFlag[outfit][gender][i].playerFlag;
    }
...
u16 GetPlayerAvatarGraphicsIdByCurrentState(void)
{
    ...
    for (i = 0; i < ARRAY_COUNT(sPlayerAvatarGfxToStateFlag[0][0]); i++)
    {
        if (sPlayerAvatarGfxToStateFlag[outfit][gPlayerAvatar.gender][i].playerFlag & flags)
            return sPlayerAvatarGfxToStateFlag[outfit][gPlayerAvatar.gender][i].graphicsId;
    }
...
void SetPlayerAvatarFertilizing(enum Direction direction)
{
