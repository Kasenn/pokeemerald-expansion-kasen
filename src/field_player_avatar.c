...
static bool8 (*const sForcedMovementTestFuncs[NUM_FORCED_MOVEMENTS])(u8) =
{
    ...
    MetatileBehavior_IsJumpBikeHorizontal,
};
...
static const u16 sRivalAvatarGfxIds[][GENDER_COUNT] =
{
    ...
    [PLAYER_AVATAR_STATE_ROCK_CLIMBING] = {OBJ_EVENT_GFX_RIVAL_BRENDAN_SURFING,    OBJ_EVENT_GFX_RIVAL_MAY_SURFING},
...
static const u16 sPlayerAvatarGfxIds[OUTFIT_COUNT][19][GENDER_COUNT] =
{
    [OUTFIT_RUBYSAPPHIRE] =
    {
        ...
        [PLAYER_AVATAR_STATE_FERTILIZING]   = {OBJ_EVENT_GFX_RS_BRENDAN_FERTILIZING,    OBJ_EVENT_GFX_RS_MAY_FERTILIZING},
        [PLAYER_AVATAR_STATE_4PX_SNOW]      = {OBJ_EVENT_GFX_RS_BRENDAN_4PX_SNOW,       OBJ_EVENT_GFX_RS_MAY_4PX_SNOW},
        [PLAYER_AVATAR_STATE_6PX_SNOW]      = {OBJ_EVENT_GFX_RS_BRENDAN_6PX_SNOW,       OBJ_EVENT_GFX_RS_MAY_6PX_SNOW},
        [PLAYER_AVATAR_STATE_8PX_SNOW]      = {OBJ_EVENT_GFX_RS_BRENDAN_8PX_SNOW,       OBJ_EVENT_GFX_RS_MAY_8PX_SNOW},
        [PLAYER_AVATAR_STATE_10PX_SNOW]     = {OBJ_EVENT_GFX_RS_BRENDAN_10PX_SNOW,      OBJ_EVENT_GFX_RS_MAY_10PX_SNOW},
        [PLAYER_AVATAR_STATE_SURFING]       = {OBJ_EVENT_GFX_RS_BRENDAN_SURFING,        OBJ_EVENT_GFX_RS_MAY_SURFING},
        [PLAYER_AVATAR_STATE_ROCK_CLIMBING] = {OBJ_EVENT_GFX_RS_BRENDAN_SURFING,        OBJ_EVENT_GFX_RS_MAY_SURFING},
        [PLAYER_AVATAR_STATE_GOGOAT]        = {OBJ_EVENT_GFX_RS_BRENDAN_SURFING,        OBJ_EVENT_GFX_RS_MAY_SURFING},
    },
    [OUTFIT_EMERALD] =
    {
        ...
        [PLAYER_AVATAR_STATE_ROCK_CLIMBING] = {OBJ_EVENT_GFX_BRENDAN_SURFING,           OBJ_EVENT_GFX_MAY_SURFING},
        [PLAYER_AVATAR_STATE_GOGOAT]        = {OBJ_EVENT_GFX_BRENDAN_SURFING,           OBJ_EVENT_GFX_MAY_SURFING},
    },
    [OUTFIT_ORAS] =
    {
        [PLAYER_AVATAR_STATE_NORMAL]        = {OBJ_EVENT_GFX_ORAS_BRENDAN_NORMAL,       OBJ_EVENT_GFX_ORAS_MAY_NORMAL},
        [PLAYER_AVATAR_STATE_BIKE]          = {OBJ_EVENT_GFX_ORAS_BRENDAN_BIKE,         OBJ_EVENT_GFX_ORAS_MAY_BIKE},
        [PLAYER_AVATAR_STATE_FIELD_MOVE]    = {OBJ_EVENT_GFX_ORAS_BRENDAN_FIELD_MOVE,   OBJ_EVENT_GFX_ORAS_MAY_FIELD_MOVE},
        [PLAYER_AVATAR_STATE_FISHING]       = {OBJ_EVENT_GFX_ORAS_BRENDAN_FISHING,      OBJ_EVENT_GFX_ORAS_MAY_FISHING},
        [PLAYER_AVATAR_STATE_WATERING]      = {OBJ_EVENT_GFX_ORAS_BRENDAN_WATERING,     OBJ_EVENT_GFX_ORAS_MAY_WATERING},
        [PLAYER_AVATAR_STATE_FERTILIZING]   = {OBJ_EVENT_GFX_ORAS_BRENDAN_FERTILIZING,  OBJ_EVENT_GFX_ORAS_MAY_FERTILIZING},
        [PLAYER_AVATAR_STATE_4PX_SNOW]      = {OBJ_EVENT_GFX_ORAS_BRENDAN_4PX_SNOW,     OBJ_EVENT_GFX_ORAS_MAY_4PX_SNOW},
        [PLAYER_AVATAR_STATE_6PX_SNOW]      = {OBJ_EVENT_GFX_ORAS_BRENDAN_6PX_SNOW,     OBJ_EVENT_GFX_ORAS_MAY_6PX_SNOW},
        [PLAYER_AVATAR_STATE_8PX_SNOW]      = {OBJ_EVENT_GFX_ORAS_BRENDAN_8PX_SNOW,     OBJ_EVENT_GFX_ORAS_MAY_8PX_SNOW},
        [PLAYER_AVATAR_STATE_10PX_SNOW]     = {OBJ_EVENT_GFX_ORAS_BRENDAN_10PX_SNOW,    OBJ_EVENT_GFX_ORAS_MAY_10PX_SNOW},
        [PLAYER_AVATAR_STATE_SURFING]       = {OBJ_EVENT_GFX_ORAS_BRENDAN_SURFING,      OBJ_EVENT_GFX_ORAS_MAY_SURFING},
        [PLAYER_AVATAR_STATE_ROCK_CLIMBING] = {OBJ_EVENT_GFX_ORAS_BRENDAN_SURFING,      OBJ_EVENT_GFX_ORAS_MAY_SURFING},
        [PLAYER_AVATAR_STATE_GOGOAT]        = {OBJ_EVENT_GFX_ORAS_BRENDAN_SURFING,      OBJ_EVENT_GFX_ORAS_MAY_SURFING},
    },
    [OUTFIT_CONTEST] =
    {
        [PLAYER_AVATAR_STATE_NORMAL]        = {OBJ_EVENT_GFX_CONTEST_BRENDAN_NORMAL,        OBJ_EVENT_GFX_CONTEST_MAY_NORMAL},
        [PLAYER_AVATAR_STATE_BIKE]          = {OBJ_EVENT_GFX_CONTEST_BRENDAN_BIKE,          OBJ_EVENT_GFX_CONTEST_MAY_BIKE},
        [PLAYER_AVATAR_STATE_FIELD_MOVE]    = {OBJ_EVENT_GFX_CONTEST_BRENDAN_FIELD_MOVE,    OBJ_EVENT_GFX_CONTEST_MAY_FIELD_MOVE},
        [PLAYER_AVATAR_STATE_FISHING]       = {OBJ_EVENT_GFX_CONTEST_BRENDAN_FISHING,       OBJ_EVENT_GFX_CONTEST_MAY_FISHING},
        [PLAYER_AVATAR_STATE_WATERING]      = {OBJ_EVENT_GFX_CONTEST_BRENDAN_WATERING,      OBJ_EVENT_GFX_CONTEST_MAY_WATERING},
        [PLAYER_AVATAR_STATE_FERTILIZING]   = {OBJ_EVENT_GFX_CONTEST_BRENDAN_FERTILIZING,   OBJ_EVENT_GFX_CONTEST_MAY_FERTILIZING},
        [PLAYER_AVATAR_STATE_4PX_SNOW]      = {OBJ_EVENT_GFX_CONTEST_BRENDAN_4PX_SNOW,      OBJ_EVENT_GFX_CONTEST_MAY_4PX_SNOW},
        [PLAYER_AVATAR_STATE_6PX_SNOW]      = {OBJ_EVENT_GFX_CONTEST_BRENDAN_6PX_SNOW,      OBJ_EVENT_GFX_CONTEST_MAY_6PX_SNOW},
        [PLAYER_AVATAR_STATE_8PX_SNOW]      = {OBJ_EVENT_GFX_CONTEST_BRENDAN_8PX_SNOW,      OBJ_EVENT_GFX_CONTEST_MAY_8PX_SNOW},
        [PLAYER_AVATAR_STATE_10PX_SNOW]     = {OBJ_EVENT_GFX_CONTEST_BRENDAN_10PX_SNOW,     OBJ_EVENT_GFX_CONTEST_MAY_10PX_SNOW},
        [PLAYER_AVATAR_STATE_SURFING]       = {OBJ_EVENT_GFX_CONTEST_BRENDAN_SURFING,       OBJ_EVENT_GFX_CONTEST_MAY_SURFING},
        [PLAYER_AVATAR_STATE_ROCK_CLIMBING] = {OBJ_EVENT_GFX_CONTEST_BRENDAN_SURFING,       OBJ_EVENT_GFX_CONTEST_MAY_SURFING},
        [PLAYER_AVATAR_STATE_GOGOAT]        = {OBJ_EVENT_GFX_CONTEST_BRENDAN_SURFING,       OBJ_EVENT_GFX_CONTEST_MAY_SURFING},
    }
};
...
static const u16 sPlayerAvatarGfxToStateFlag[OUTFIT_COUNT][GENDER_COUNT][10][2] =
{
    [OUTFIT_RUBYSAPPHIRE] =
    {
        [MALE] =
        {
            ...
            {OBJ_EVENT_GFX_RS_BRENDAN_4PX_SNOW,     PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_RS_BRENDAN_6PX_SNOW,     PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_RS_BRENDAN_8PX_SNOW,     PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_RS_BRENDAN_10PX_SNOW,    PLAYER_AVATAR_FLAG_ON_FOOT},
        },
        [FEMALE] =
        {
            ...
            {OBJ_EVENT_GFX_RS_MAY_4PX_SNOW,         PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_RS_MAY_6PX_SNOW,         PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_RS_MAY_8PX_SNOW,         PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_RS_MAY_10PX_SNOW,        PLAYER_AVATAR_FLAG_ON_FOOT},
        }
    },
    [OUTFIT_EMERALD] =
    {
    ...
    [OUTFIT_ORAS] =
    {
        [MALE] =
        {
            {OBJ_EVENT_GFX_ORAS_BRENDAN_NORMAL,     PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_ORAS_BRENDAN_BIKE,       PLAYER_AVATAR_FLAG_BIKE},
            {OBJ_EVENT_GFX_ORAS_BRENDAN_BIKE,       PLAYER_AVATAR_FLAG_BIKE},
            {OBJ_EVENT_GFX_ORAS_BRENDAN_SURFING,    PLAYER_AVATAR_FLAG_SURFING},
            {OBJ_EVENT_GFX_BRENDAN_UNDERWATER,      PLAYER_AVATAR_FLAG_UNDERWATER},
            {OBJ_EVENT_GFX_ORAS_BRENDAN_4PX_SNOW,   PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_ORAS_BRENDAN_6PX_SNOW,   PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_ORAS_BRENDAN_8PX_SNOW,   PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_ORAS_BRENDAN_10PX_SNOW,  PLAYER_AVATAR_FLAG_ON_FOOT},
        },
        [FEMALE] =
        {
            {OBJ_EVENT_GFX_ORAS_MAY_NORMAL,         PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_ORAS_MAY_BIKE,           PLAYER_AVATAR_FLAG_BIKE},
            {OBJ_EVENT_GFX_ORAS_MAY_BIKE,           PLAYER_AVATAR_FLAG_BIKE},
            {OBJ_EVENT_GFX_ORAS_MAY_SURFING,        PLAYER_AVATAR_FLAG_SURFING},
            {OBJ_EVENT_GFX_ORAS_MAY_UNDERWATER,     PLAYER_AVATAR_FLAG_UNDERWATER},
            {OBJ_EVENT_GFX_ORAS_MAY_4PX_SNOW,       PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_ORAS_MAY_6PX_SNOW,       PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_ORAS_MAY_8PX_SNOW,       PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_ORAS_MAY_10PX_SNOW,      PLAYER_AVATAR_FLAG_ON_FOOT},
        }
    },
    [OUTFIT_CONTEST] =
    {
        [MALE] =
        {
            {OBJ_EVENT_GFX_CONTEST_BRENDAN_NORMAL,      PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_CONTEST_BRENDAN_BIKE,        PLAYER_AVATAR_FLAG_BIKE},
            {OBJ_EVENT_GFX_CONTEST_BRENDAN_BIKE,        PLAYER_AVATAR_FLAG_BIKE},
            {OBJ_EVENT_GFX_CONTEST_BRENDAN_SURFING,     PLAYER_AVATAR_FLAG_SURFING},
            {OBJ_EVENT_GFX_CONTEST_BRENDAN_4PX_SNOW,    PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_CONTEST_BRENDAN_6PX_SNOW,    PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_CONTEST_BRENDAN_8PX_SNOW,    PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_CONTEST_BRENDAN_10PX_SNOW,   PLAYER_AVATAR_FLAG_ON_FOOT},
        },
        [FEMALE] =
        {
            {OBJ_EVENT_GFX_CONTEST_MAY_NORMAL,          PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_CONTEST_MAY_BIKE,            PLAYER_AVATAR_FLAG_BIKE},
            {OBJ_EVENT_GFX_CONTEST_MAY_BIKE,            PLAYER_AVATAR_FLAG_BIKE},
            {OBJ_EVENT_GFX_CONTEST_MAY_SURFING,         PLAYER_AVATAR_FLAG_SURFING},
            {OBJ_EVENT_GFX_CONTEST_MAY_4PX_SNOW,        PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_CONTEST_MAY_6PX_SNOW,        PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_CONTEST_MAY_8PX_SNOW,        PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_CONTEST_MAY_10PX_SNOW,       PLAYER_AVATAR_FLAG_ON_FOOT},
        }
    },
};
...
static bool8 TryPushBoulder(s16 x, s16 y, u8 direction)
{
    if (FlagGet(FLAG_SYS_USE_STRENGTH))
    {
        ...
        if (objectEventId != OBJECT_EVENTS_COUNT && (gObjectEvents[objectEventId].graphicsId == OBJ_EVENT_GFX_PUSHABLE_BOULDER || gObjectEvents[objectEventId].graphicsId == OBJ_EVENT_GFX_CRATE))
        {
            ...
            if (GetCollisionAtCoords(&gObjectEvents[objectEventId], x, y, direction) == COLLISION_NONE
             ...
             && MetatileBehavior_IsBoulderBlocking(MapGridGetMetatileBehaviorAt(x, y)) == FALSE
             && MetatileBehavior_IsNorthArrowWarp(MapGridGetMetatileBehaviorAt(x, y)) == FALSE)
            {
...
{
    ObjectEventSetGraphicsId(objEvent, GetPlayerAvatarGraphicsIdByStateId(PLAYER_AVATAR_STATE_ROCK_CLIMBING));
}
...
{
    u32 outfit = VarGet(VAR_CHOSEN_OUTFIT);

    if (state == PLAYER_AVATAR_STATE_KROKOROK)
        return OBJ_EVENT_GFX_KROKOROK;
...
bool8 IsPlayerFacingFishableLava(void)
{
    ...
    if (GetCollisionAtCoords(playerObjEvent, x, y, playerObjEvent->facingDirection) == COLLISION_ELEVATION_MISMATCH
     && PlayerGetElevation() == 3
     && MetatileBehavior_IsFishableLava(MapGridGetMetatileBehaviorAt(x, y)))
        return TRUE;
    else
        return FALSE;
}
...
{
    u8 i;
    u16 outfit = VarGet(VAR_CHOSEN_OUTFIT);

    for (i = 0; i < ARRAY_COUNT(sPlayerAvatarGfxToStateFlag[0][0]); i++)
    {
        if (sPlayerAvatarGfxToStateFlag[outfit][gender][i][0] == graphicsId)
            return sPlayerAvatarGfxToStateFlag[outfit][gender][i][1];
    }
    if (graphicsId == OBJ_EVENT_GFX_KROKOROK)
        return PLAYER_AVATAR_FLAG_KROKOROK;
...
u16 GetPlayerAvatarGraphicsIdByCurrentState(void)
{
    ...
    for (i = 0; i < ARRAY_COUNT(sPlayerAvatarGfxToStateFlag[0][0]); i++)
    {
        if (sPlayerAvatarGfxToStateFlag[outfit][gPlayerAvatar.gender][i][1] & flags)
            return sPlayerAvatarGfxToStateFlag[outfit][gPlayerAvatar.gender][i][0];
    }
    if (flags & PLAYER_AVATAR_FLAG_KROKOROK)
        return OBJ_EVENT_GFX_KROKOROK;
    return 0;
}
