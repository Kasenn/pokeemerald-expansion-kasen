...
static bool8 ReturnGiveItemToBagOrPC(uit);
...
static u8 DisplaySelectionWindow(u8 windowType)
{
    ...
    case SELECTWINDOW_FOLLOWER:
        ...
        break;
    case SELECTWINDOW_FOLLOWER_SET:
        window = sFollowerSetWindowTemplate2;
        break;
...
static void CursorCb_Follower(u8 taskId)
{
    ...
    if (gSaveBlock1Ptr->followerIndex == gPartyMenu.slotId)
    {
        ...
        else
        {
            ...
            DisplaySelectionWindow(SELECTWINDOW_FOLLOWER_SET);
        }
    }
...
static void CB2_GiveHoldItem(void)
{
    ...
    else if (gSpecialVar_ItemId == ITEM_CURRY)
    {
...
bool32 UNUSED SetUpFieldMove_RockClimb2(void)
{
    s16 x, y;
...
void ItemUseCB_IncreaseFriendship(u8 taskId, TaskFunc task)
{
    ...
    if (friendship > 225){
        ...
        GetMonNickname(mon, gStringVar1);
        StringExpandPlaceholders(gStringVar4, gText_PkmnAdores);
        DisplayPartyMenuMessage(gStringVar4, TRUE);
        ScheduleBgCopyTilemapToVram(2);
        gTasks[taskId].func = task;
    }
