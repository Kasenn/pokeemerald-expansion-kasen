...
static const u8 sText_PlayerGotMoneyAndBP[] = _("{B_PLAYER_NAME} got ¥{B_BUFF1} and\n{B_BUFF2} BP for winning!\p");
...
static const u8 sText_ForestCurse[] = _("{B_ATK_NAME_WITH_PREFIX} laid the forest's\ncurse on {B_DEF_NAME_WITH_PREFIX}!");
...
static const u8 sText_SleepBerry[] = _("The Roste Berry is making\n{B_SCR_ACTIVE_NAME_WITH_PREFIX} drowsy!");
...
static const u8 sText_ItDodgedBall[] = _("The ball bounced back to you!\nThis Pokémon can't be caught!");
...
static const u8 sText_ItIsWindy[] = _("A strong wind blows across\nthe battlefield!");
...
static const u8 sText_NoWhiteoutLossText[];
...
static const u8 sText_WeatherWindActivation[] = _("{B_ATK_NAME_WITH_PREFIX} is able to perform its\nmove faster due to the strong winds!");
...
static const u8 sText_HiveLeader[] = _("{B_ATK_NAME_WITH_PREFIX} has been afflicted\nwith an infestation by {B_DEF_NAME_WITH_PREFIX}!");
...
static const u8 sText_AuraFlaredToLife[] = _("{B_DEF_NAME_WITH_PREFIX} is being affected\nby a menacing aura!");
...
static const u8 sText_MysteriousAirCurrent[] = _("The strong winds continue.");
static const u8 sText_StrongWindsDissipated[] = _("The mysterious strong winds\nhave dissipated!{PAUSE 64}");
static const u8 sText_MysteriousAirCurrentBlowsOn[] = _("The strong wind continues.");
static const u8 sText_AttackWeakenedByStrongWinds[] = _("The strong winds dampen\nthe power of the attack!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_FORESTCURSE - BATTLESTRINGS_TABLE_START] = sText_ForestCurse,
    ...
    [STRINGID_ITISWINDY - BATTLESTRINGS_TABLE_START] = sText_ItIsWindy,
    ...
    [STRINGID_SLEEPBERRY - BATTLESTRINGS_TABLE_START] = sText_SleepBerry,
    ...
    [STRINGID_NOWHITEOUT - BATTLESTRINGS_TABLE_START] = sText_NoWhiteoutLossText,
    ...
    [STRINGID_WEATHERWIND - BATTLESTRINGS_TABLE_START] = sText_WeatherWindActivation,
    ...
    [STRINGID_HIVE_LEADER - BATTLESTRINGS_TABLE_START] = sText_HiveLeader,
