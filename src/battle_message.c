...
static const u8 sText_FetchEggsGotAwaySafely[] = _("Yoshi scooped up any eggs it has tossed.\p{PLAY_SE SE_FLEE}Got away safely!\p");
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_YOSHIPICKEDUPEGGS]                    = COMPOUND_STRING("{B_BUFF1} scooped up any eggs it has tossed.\p"),
    ...
    [STRINGID_PLAYERGOTMONEY]                       = COMPOUND_STRING("Yoshi picked up any eggs it has tossed.\p"),
