...
static const u8 sText_FetchEggsGotAwaySafely[] = _("Yoshi scooped up any eggs it tossed.\p{PLAY_SE SE_FLEE}Got away safely!\p");
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_YOSHIPICKEDUPEGGS]                    = COMPOUND_STRING("Yoshi scooped up any eggs it tossed.\p"),
    [STRINGID_PKMNGREWTOLV]                         = COMPOUND_STRING("{B_BUFF1} grew stronger!{WAIT_SE}\p"),
    ...
    [STRINGID_PLAYERGOTMONEY]                       = COMPOUND_STRING("Yoshi picked up any eggs it tossed.\p"),
    [STRINGID_PLAYERWHITEOUT]                       = COMPOUND_STRING("Your party has whited out!\p"),
    ...
    [STRINGID_PLAYERWHITEOUT3]                      = COMPOUND_STRING("Yoshi was overwhelmed by its defeat!"),
    [STRINGID_PREVENTSESCAPE]                       = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} prevents escape with {B_SCR_ABILITY}!\p"),
    [STRINGID_HITXTIMES]                            = COMPOUND_STRING("The battler was hit {B_BUFF1} time(s)!"), //SV has dynamic plural here
    ...
    [STRINGID_PKMNMADEILLUSION]                     = COMPOUND_STRING("Kamek created an illusion!"),
    [STRINGID_PKMNHASILLUSION]                      = COMPOUND_STRING("Kamek already has an illusion!"),
    [STRINGID_ILLUSIONDAMAGED]                      = COMPOUND_STRING("The illusion took damage for Kamek!\p"),
    ...
    [STRINGID_PKMNILLUSIONFADED]                    = COMPOUND_STRING("Kamek's illusion faded!\p"),
    ...
    [STRINGID_SCOOPUPEGGS]                          = COMPOUND_STRING("{PLAY_SE SE_USE_ITEM}Yoshi scooped up any eggs it had tossed!\p"),
    [STRINGID_CANTSCOOPUPEGGS]                      = COMPOUND_STRING("Yoshi is unable to scoop up any eggs at the moment!\p"),
    [STRINGID_NOEGGSTOSCOOP]                        = COMPOUND_STRING("There are no eggs to fetch!\p"),
    ...
    [STRINGID_FAINTINTHREE]                         = COMPOUND_STRING("All battlers that heard the song will faint in three turns!"),
    ...
    [STRINGID_YOSHICALLEDDIGLETT]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} called Diglett for aid!"),
    ...
    [STRINGID_HELDITEMSLOSEEFFECTS]                 = COMPOUND_STRING("It created a bizarre area in which battlers' held items lose their effects!"),
    ...
    [STRINGID_POWDEREXPLODES]                       = COMPOUND_STRING("When the flame touched the powder on the battler, it exploded!"),
    ...
    [STRINGID_PKMNCANTUSEMOVETHROATCHOP]            = COMPOUND_STRING("The effects of the egg prevent {B_ATK_NAME_WITH_PREFIX2} from using certain moves!\p"),
    ...
    [STRINGID_AURAFLAREDTOLIFE]                     = COMPOUND_STRING("Kamek's magics greatly increased {B_ATK_NAME_WITH_PREFIX2}'s stats!"),
    ...
    [STRINGID_MYSTERIOUSAIRCURRENT]                 = COMPOUND_STRING("Mysterious strong winds are protecting Flying-type battlers!"),
    ...
    [STRINGID_ABILITYWEAKENEDSURROUNDINGMONSSTAT]   = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY} weakened the {B_BUFF1} of all surrounding battlers!\p"),
    ...
    [STRINGID_SHARPSTEELFLOATS]                     = COMPOUND_STRING("Sharp-pointed pieces of steel started floating around {B_DEF_TEAM2} battler!"),
    ...
    [STRINGID_SHARPSTEELDISAPPEAREDFROMTEAM]        = COMPOUND_STRING("The pieces of steel surrounding {B_ATK_TEAM2} battler disappeared!"),
    ...
    [STRINGID_PKMNHURTBYVORTEX]                     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is hurt by the vortex!"),
    ...
    [STRINGID_BIZARREARENACREATED]                  = COMPOUND_STRING("A bizarre area was created in which battlers' held items lose their effects!"),
    ...
    [STRINGID_STATCHANGESNORMALIZED]                = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} stats were normalized!"),
    [STRINGID_SCRCUREDPARALYSIS_CONFUSION]          = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} was cured of paralysis!\p{B_SCR_NAME_WITH_PREFIX} snapped out of its confusion!"),
    [STRINGID_SCRCUREDPOISON_CONFUSION]             = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} was cured of its poisoning!\p{B_SCR_NAME_WITH_PREFIX} snapped out of its confusion!"),
    [STRINGID_SCRCUREDBURN_CONFUSION]               = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s burn was cured!\p{B_SCR_NAME_WITH_PREFIX} snapped out of its confusion!"),
    [STRINGID_PKMNWASDEFROSTED_CONFUSION]           = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} thawed out!\p{B_SCR_NAME_WITH_PREFIX} snapped out of its confusion!"),
    [STRINGID_PKMNFROSTBITEHEALED_CONFUSION]        = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s frostbite was cured!\p{B_SCR_NAME_WITH_PREFIX} snapped out of its confusion!"),
    [STRINGID_SCRCUREDSLEEP_CONFUSION]              = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} woke up!\p{B_SCR_NAME_WITH_PREFIX} snapped out of its confusion!"),
};
...
const u16 gBigBossStringIds[] =
{
    ...
    [B_MSG_CURED_PARALYSIS_CONFUSION] = STRINGID_SCRCUREDPARALYSIS_CONFUSION,
    [B_MSG_CURED_POISON_CONFUSION] = STRINGID_SCRCUREDPOISON_CONFUSION,
    [B_MSG_CURED_BURN_CONFUSION] = STRINGID_SCRCUREDBURN_CONFUSION,
    [B_MSG_CURED_FREEZE_CONFUSION] = STRINGID_PKMNWASDEFROSTED_CONFUSION,
    [B_MSG_CURED_FROSTBITE_CONFUSION] = STRINGID_PKMNFROSTBITEHEALED_CONFUSION,
    [B_MSG_CURED_SLEEP_CONFUSION] = STRINGID_SCRCUREDSLEEP_CONFUSION,
};
