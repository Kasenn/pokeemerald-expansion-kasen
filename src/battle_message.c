...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_NOEGGSTOSCOOP]                        = COMPOUND_STRING("There are no eggs for Yoshi to fetch!\p"),
    ...
    [STRINGID_AURAFLAREDTOLIFE]                     = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s aura flared to life!"),//wip
