...
static const u8 sSpeciesToBackAnimSet[NUM_SPECIES] =
{
    ...
    [SPECIES_CHESNAUGHT_MEGA]                = BACK_ANIM_SHAKE_GLOW_GREEN,
    [SPECIES_INCINEROAR_MEGA]             = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_EMPOLEON_MEGA]               = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_DECIDUEYE_MEGA]                = BACK_ANIM_SHAKE_GLOW_GREEN,
