...
static const u8 sFrontierBrainObjEventGfx[NUM_FRONTIER_FACILITIES][2] =
{
    ...
    [FRONTIER_FACILITY_DOME]    = {OBJ_EVENT_GFX_ANABEL,  FALSE},
    [FRONTIER_FACILITY_PALACE]  = {OBJ_EVENT_GFX_ABRA, FALSE},
    [FRONTIER_FACILITY_ARENA]   = {OBJ_EVENT_GFX_SPHEAL,   TRUE},
    [FRONTIER_FACILITY_FACTORY] = {OBJ_EVENT_GFX_VOLCARONA,  FALSE},
    [FRONTIER_FACILITY_PIKE]    = {OBJ_EVENT_GFX_EXCADRILL,    TRUE},
