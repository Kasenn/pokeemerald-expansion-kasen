...
static void CreateCableCarSprites(void)
{
    ...
    u16 playerGraphicsIds[][2] = {
        [OUTFIT_RUBYSAPPHIRE] = {OBJ_EVENT_GFX_BRENDAN_RS_NORMAL, OBJ_EVENT_GFX_MAY_RS_NORMAL},
        [OUTFIT_EMERALD] = {OBJ_EVENT_GFX_RIVAL_BRENDAN_NORMAL, OBJ_EVENT_GFX_RIVAL_MAY_NORMAL},
        [OUTFIT_ORAS] = {OBJ_EVENT_GFX_BRENDAN_ORAS_NORMAL, OBJ_EVENT_GFX_MAY_ORAS_NORMAL},
        [OUTFIT_CONTEST] = {OBJ_EVENT_GFX_BRENDAN_CONTEST_NORMAL, OBJ_EVENT_GFX_MAY_CONTEST_NORMAL},
    };
    u16 rval = Random();
