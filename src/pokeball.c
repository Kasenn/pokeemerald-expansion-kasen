...
#define GFX_TAG_DIRE_BALL    55028
...
const struct PokeBallSprite gPokeBalls[POKEBALL_COUNT] =
{
    ...
    [BALL_DIRE] =
    {
        POKE_BALL_SPRITE(GFX_TAG_DIRE_BALL, gBallGfx_Dire, gBallPal_Dire),
        .itemId = ITEM_DIRE_BALL,
    },
};
...
void LoadBallGfx(enum PokeBall ballId, u8 inBattle)
{
    u16 var;
