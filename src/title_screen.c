...
static const u32 sTitleScreenYveltalGfx[] = INCGFX_U32("graphics/title_screen/yveltal.png", ".4bpp.smol");
static const u32 sTitleScreenYveltalTilemap[] = INCGFX_U32("graphics/title_screen/yveltal.bin", ".smolTM");
...
void CB2_InitTitleScreen(void)
{
    ...
    case 1:
        ...
        else
        {
            ...
            // bg3
            DecompressDataWithHeaderVram(sTitleScreenYveltalGfx, (void *)(BG_CHAR_ADDR(2)));
            DecompressDataWithHeaderVram(sTitleScreenYveltalTilemap, (void *)(BG_SCREEN_ADDR(26)));    
        }
        // bg1
...
static void UpdateLegendaryMarkingColorAlternative(u8 frameNum)
{
    if ((frameNum % 4) == 0) // Change color every 4th frame
    {
        ...
        s32 r = (11 * intensity) / 256;
        s32 g = 8 + (19 * intensity) / 256;
        s32 b = 11 + (20 * intensity) / 256;
