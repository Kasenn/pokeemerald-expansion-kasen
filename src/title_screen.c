...
static const u32 sTitleScreenRayquazaGfx[] = INCGFX_U32("graphics/title_screen/title_bg0.png", ".4bpp.smol");
static const u32 sTitleScreenRayquazaTilemap[] = INCGFX_U32("graphics/title_screen/title_bg0.bin", ".smolTM");
static const u32 sTitleScreenLogoShineGfx[] = INCGFX_U32("graphics/title_screen/logo_shine.png", ".4bpp.smol");
static const u32 sTitleScreenCloudsGfx[] = INCGFX_U32("graphics/title_screen/title_bg2.png", ".4bpp.smol");
...
static const struct SpritePalette sSpritePalette_Tarc3Project[] =
{
    {
        .data = gTitleScreenTarc3Project,
        .tag = TAG_LOGO_SHINE
    },
    {},
};
...
static void SpriteCB_PokemonLogoShine(struct Sprite *sprite)
{
    ...
    if (sprite->data[3] < DISPLAY_WIDTH + 32)
    {
        ...
        if (sprite->sMode != SHINE_MODE_SINGLE_NO_BG_COLOR)
        {
            ...
            if (sprite->data[3] < DISPLAY_WIDTH / 2)
            {
            ...
            if (sprite->data[3] == DISPLAY_WIDTH / 2 + (3 * SHINE_SPEED)
...
static void StartPokemonLogoShine(u8 mode)
{
    ...
    case SHINE_MODE_SINGLE:
        ...
        spriteId = CreateSprite(&sPokemonLogoShineSpriteTemplate, DISPLAY_WIDTH / 2, DISPLAY_HEIGHT / 2, 0);
...
void CB2_InitTitleScreen(void)
{
    ...
    case 1:
        ...
        LoadPalette(gTitleScreenBgPalettes, BG_PLTT_ID(0), 3 * PLTT_SIZE_4BPP);
        LoadPalette(gTitleScreenBgPalettes3, BG_PLTT_ID(8), PLTT_SIZE_4BPP);
        LoadPalette(gTitleScreenBgPalettes2, BG_PLTT_ID(14), PLTT_SIZE_4BPP);
        // bg3
        ...
        LoadSpritePalette(&sSpritePalette_Tarc3Project[0]);
        gMain.state = 2;
        break;
    case 2:
    {
    ...
    case 4:
        ...
        SetGpuReg(REG_OFFSET_BG1CNT, BGCNT_PRIORITY(1) | BGCNT_CHARBASE(3) | BGCNT_SCREENBASE(27) | BGCNT_16COLOR | BGCNT_TXT256x256);
        SetGpuReg(REG_OFFSET_BG2CNT, BGCNT_PRIORITY(2) | BGCNT_CHARBASE(0) | BGCNT_SCREENBASE(9) | BGCNT_256COLOR | BGCNT_AFF256x256);
...
static void Task_TitleScreenPhase1(u8 taskId)
{
    ...
    else
    {
        ...
        SetGpuReg(REG_OFFSET_DISPCNT, DISPCNT_MODE_1 | DISPCNT_OBJ_1D_MAP | DISPCNT_OBJ_ON);
...
static void Task_TitleScreenPhase2(u8 taskId)
{
    ...
    else
    {
        ...
        CreateCopyrightBanner(START_BANNER_X + 27, 148);
...
static void UNUSED CB2_GoToBerryFixScreen(void)
{
    if (!UpdatePaletteFade())
    {
        m4aMPlayAllStop();
