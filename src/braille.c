...
u16 FontFunc_Braille(struct TextPrinter *textPrinter)
{
    ...
    case RENDER_STATE_SCROLL:
        if (textPrinter->scrollDistance)
        {
            ...
            // else
            // {
                ScrollWindow(textPrinter->printerTemplate.windowId, 0, sScrollDistances[2], PIXEL_FILL(textPrinter->printerTemplate.bgColor));
                textPrinter->scrollDistance -= sScrollDistances[2];
            // }
