...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_TOWN_WIP1] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CITY_WIP1] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_TOWN_WIP2] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_TOWN_WIP3] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SHORESLATE_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CITY_WIP2] = MAPPOPUP_THEME_STONE,
