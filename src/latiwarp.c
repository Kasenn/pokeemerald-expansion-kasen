...
static void CreateLatiRideSprites(void)
{
    ...
    u16 playerGraphicsIds[][2] = {
        [OUTFIT_RUBYSAPPHIRE] = {OBJ_EVENT_GFX_RS_BRENDAN_SURFING, OBJ_EVENT_GFX_RS_MAY_SURFING},
        [OUTFIT_EMERALD] = {OBJ_EVENT_GFX_RIVAL_BRENDAN_SURFING, OBJ_EVENT_GFX_RIVAL_MAY_SURFING},
        [OUTFIT_ORAS] = {OBJ_EVENT_GFX_ORAS_BRENDAN_SURFING, OBJ_EVENT_GFX_ORAS_MAY_SURFING},
        [OUTFIT_CONTEST] = {OBJ_EVENT_GFX_CONTEST_BRENDAN_SURFING, OBJ_EVENT_GFX_CONTEST_MAY_SURFING},
    };
