...
static void CreateLatiRideSprites(void)
{
    ...
    u16 playerGraphicsIds[][2] = {
        [OUTFIT_RUBYSAPPHIRE] = {OBJ_EVENT_GFX_BRENDAN_SURFING_RS, OBJ_EVENT_GFX_MAY_SURFING_RS},
        [OUTFIT_EMERALD] = {OBJ_EVENT_GFX_RIVAL_BRENDAN_SURFING, OBJ_EVENT_GFX_RIVAL_MAY_SURFING},
        [OUTFIT_ORAS] = {OBJ_EVENT_GFX_BRENDAN_SURFING_ORAS, OBJ_EVENT_GFX_MAY_SURFING_ORAS},
    };
