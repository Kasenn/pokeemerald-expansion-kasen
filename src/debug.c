...
static const u8 sDebugText_Util_Script_2[] =               _("Fix starter");
static const u8 sDebugText_Util_Script_3[] =               _("Update 2");
static const u8 sDebugText_Util_Script_4[] =               _("Disable NO EXP flag");
