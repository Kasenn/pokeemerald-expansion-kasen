...
static const struct DebugMenuOption sDebugMenu_Actions_PCBag_Fill[] =
{
    ...
    { COMPOUND_STRING("Fill Pocket Mega Stones"),     DebugAction_PCBag_Fill_PocketMegaStone },
    { NULL }
};
...
{
    { COMPOUND_STRING("Set Team Level"), DebugAction_ExecuteScript, Debug_EventScript_Script_1 },
    { COMPOUND_STRING("Permanent night"), DebugAction_ExecuteScript, Debug_EventScript_Script_2 },
...
static const struct DebugMenuOption sDebugMenu_Actions_MainLimited[] =
{
    { COMPOUND_STRING("Unstuck"),       DebugAction_OpenUnstuckMenu},
    { COMPOUND_STRING("Enter Code"),    DebugAction_OpenEnterCodeMenu},
    { COMPOUND_STRING("Cancel"),        DebugAction_Cancel},
    { NULL }
};
...
static void DebugAction_Util_Fly(u8 taskId)
{
    ...
    FlagSet(FLAG_VISITED_PRIMROSE_TOWN);
    ...
    FlagSet(FLAG_VISITED_CORALGROVE_CITY);
    ...
    FlagSet(FLAG_VISITED_FISHING_VILLAGE);
    ...
    FlagSet(FLAG_VISITED_FROSTHEARTH);
...
{
    ZeroPlayerPartyMons();
    CreateNPCTrainerPartyFromTrainer(gParties[B_TRAINER_PLAYER], &sDebugTrainers[DEBUG_TRAINER_PLAYER], TRUE, BATTLE_TYPE_TRAINER);
    ScriptContext_Enable();
    Debug_DestroyMenu_Full(taskId);
}
