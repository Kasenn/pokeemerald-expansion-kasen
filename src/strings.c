...
const u8 gText_DefaultNameBrother[] = _("Thomas");
...
const u8 gText_ZygardeCells[] = _("The Zygarde Cube currently contains\n{STR_VAR_1} Zygarde Cells.");
const u8 gText_CantAccessBag[] = _("Cannot access bag at this time.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_TalkToPartner[] = _("Talk to partner to switch {PKMN}.");
const u8 gText_FollowMon[] = _("Your {PKMN} is now following you.");
const u8 gText_UnfollowMon[] = _("Returned {PKMN} to ball.");
...
const u8 gText_CheckMapOfHoenn[] = _("Check the map of the Sinko region.");
...
const u8 gText_MiracleSeed8BP[] = _("Miracle Seed{CLEAR_TO 0x5E}8BP");
const u8 gText_Charcoal8BP[] = _("Charcoal{CLEAR_TO 0x5E}8BP");
const u8 gText_MysticWater8BP[] = _("Mystic Water{CLEAR_TO 0x5E}8BP");
const u8 gText_SilkScarf8BP[] = _("Silk Scarf{CLEAR_TO 0x5E}8BP");
const u8 gText_SharpBeak8BP[] = _("Sharp Beak{CLEAR_TO 0x5E}8BP");
const u8 gText_BlackBelt8BP[] = _("Black Belt{CLEAR_TO 0x5E}8BP");
const u8 gText_HardStone8BP[] = _("Hard Stone{CLEAR_TO 0x5E}8BP");
const u8 gText_Magnet8BP[] = _("Magnet{CLEAR_TO 0x5E}8BP");
const u8 gText_PoisonBarb8BP[] = _("Poison Barb{CLEAR_TO 0x5E}8BP");
const u8 gText_DragonScale[] = _("Dragon Scale{CLEAR_TO 0x5E}24BP");
const u8 gText_Electirizer[] = _("Electirizer{CLEAR_TO 0x5E}24BP");
const u8 gText_KingsRock[] = _("King's Rock{CLEAR_TO 0x5E}24BP");
const u8 gText_Magmarizer[] = _("Magmarizer{CLEAR_TO 0x5E}24BP");
const u8 gText_MetalCoat[] = _("Metal Coat{CLEAR_TO 0x5E}24BP");
...
const u8 gText_ScopeLens[] = _("Scope Lens{CLEAR_TO 0x5E}16BP");
const u8 gText_ShellBell[] = _("Shell Bell{CLEAR_TO 0x5E}16BP");
const u8 gText_MuscleBand[] = _("Muscle Band{CLEAR_TO 0x5E}16BP");
const u8 gText_WiseGlasses[] = _("Wise Glasses{CLEAR_TO 0x5E}16BP");
const u8 gText_WideLens[] = _("Wide Lens{CLEAR_TO 0x5E}16BP");
const u8 gText_ZoomLens[] = _("Zoom Lens{CLEAR_TO 0x5E}16BP");
const u8 gText_PowerBracer[] = _("Power Bracer{CLEAR_TO 0x5E}16BP");
const u8 gText_PowerBelt[] = _("Power Belt{CLEAR_TO 0x5E}16BP");
const u8 gText_PowerLens[] = _("Power Lens{CLEAR_TO 0x5E}16BP");
const u8 gText_PowerBand[] = _("Power Band{CLEAR_TO 0x5E}16BP");
const u8 gText_PowerAnklet[] = _("Power Anklet{CLEAR_TO 0x5E}16BP");
const u8 gText_PowerWeight[] = _("Power Weight{CLEAR_TO 0x5E}16BP");
const u8 gText_DestinyKnot[] = _("Destiny Knot{CLEAR_TO 0x5E}32BP");
const u8 gText_Everstone[] = _("Everstone{CLEAR_TO 0x5E}32BP");
const u8 gText_LonelyMint[] = _("Lonely Mint{CLEAR_TO 0x5E}40BP");
const u8 gText_AdamantMint[] = _("Adamant Mint{CLEAR_TO 0x5E}40BP");
const u8 gText_NaughtyMint[] = _("Naughty Mint{CLEAR_TO 0x5E}40BP");
const u8 gText_BraveMint[] = _("Brave Mint{CLEAR_TO 0x5E}40BP");
const u8 gText_BoldMint[] = _("Bold Mint{CLEAR_TO 0x5E}40BP");
const u8 gText_ImpishMint[] = _("Impish Mint{CLEAR_TO 0x5E}40BP");
const u8 gText_LaxMint[] = _("Lax Mint{CLEAR_TO 0x5E}40BP");
const u8 gText_RelaxedMint[] = _("Relaxed Mint{CLEAR_TO 0x5E}40BP");
const u8 gText_ModestMint[] = _("Modest Mint{CLEAR_TO 0x5E}40BP");
const u8 gText_MildMint[] = _("Mild Mint{CLEAR_TO 0x5E}40BP");
const u8 gText_RashMint[] = _("Rash Mint{CLEAR_TO 0x5E}40BP");
const u8 gText_QuietMint[] = _("Quiet Mint{CLEAR_TO 0x5E}40BP");
const u8 gText_CalmMint[] = _("Calm Mint{CLEAR_TO 0x5E}40BP");
const u8 gText_GentleMint[] = _("Gentle Mint{CLEAR_TO 0x5E}40BP");
const u8 gText_CarefulMint[] = _("Careful Mint{CLEAR_TO 0x5E}40BP");
const u8 gText_SassyMint[] = _("Sassy Mint{CLEAR_TO 0x5E}40BP");
const u8 gText_TimidMint[] = _("Timid Mint{CLEAR_TO 0x5E}40BP");
const u8 gText_HastyMint[] = _("Hasty Mint{CLEAR_TO 0x5E}40BP");
const u8 gText_JollyMint[] = _("Jolly Mint{CLEAR_TO 0x5E}40BP");
const u8 gText_NaiveMint[] = _("Naive Mint{CLEAR_TO 0x5E}40BP");
const u8 gText_SeriousMint[] = _("Serious Mint{CLEAR_TO 0x5E}40BP");
...
const u8 gText_ThunderWave6BP[] = _("Thunder Wave{CLEAR_TO 0x4E}6BP");
...
const u8 gText_Tailwind10BP[] = _("Tailwind{CLEAR_TO 0x4E}10BP");
const u8 gText_IronTail14BP[] = _("Iron Tail{CLEAR_TO 0x4E}14BP");
...
const u8 gText_Uproar8BP[] = _("Uproar{CLEAR_TO 0x4E}8BP");
...
const u8 gText_IronDefense8BP[] = _("Iron Defense{CLEAR_TO 0x4E}8BP");
const u8 gText_MagnetRise8BP[] = _("Magnet Rise{CLEAR_TO 0x4E}8BP");
const u8 gText_MagicCoat8BP[] = _("Magic Coat{CLEAR_TO 0x4E}8BP");
const u8 gText_KnockOff10BP[] = _("Knock Off{CLEAR_TO 0x4E}10BP");
const u8 gText_SkillSwap10BP[] = _("Skill Swap{CLEAR_TO 0x4E}10BP");
const u8 gText_Synthesis10BP[] = _("Synthesis{CLEAR_TO 0x4E}10BP");
const u8 gText_StealthRock10BP[] = _("Stealth Rock{CLEAR_TO 0x4E}10BP");
const u8 gText_IcyWind12BP[] = _("Icy Wind{CLEAR_TO 0x4E}12BP");
const u8 gText_WaterPulse6BP[] = _("Water Pulse{CLEAR_TO 0x4E}6BP");
const u8 gText_FuryCutter8BP[] = _("Fury Cutter{CLEAR_TO 0x4E}8BP");
const u8 gText_MagicRoom8BP[] = _("Magic Room{CLEAR_TO 0x4E}8BP");
const u8 gText_MudSlap8BP[] = _("Mud Slap{CLEAR_TO 0x4E}8BP");
const u8 gText_Swift8BP[] = _("Swift{CLEAR_TO 0x4E}8BP");
const u8 gText_FoulPlay10BP[] = _("Foul Play{CLEAR_TO 0x4E}10BP");
const u8 gText_GunkShot10BP[] = _("Gunk Shot{CLEAR_TO 0x4E}10BP");
const u8 gText_Trick10BP[] = _("Trick{CLEAR_TO 0x4E}10BP");
const u8 gText_ZenHeadbutt10BP[] = _("Zen Headbutt{CLEAR_TO 0x4E}10BP");
const u8 gText_AncientPower12BP[] = _("Ancient Power{CLEAR_TO 0x4E}12BP");
const u8 gText_OminousWind12BP[] = _("Ominous Wind{CLEAR_TO 0x4E}12BP");
...
const u8 gText_DexHoenn[] = _("SINKO");
...
const u8 gText_BrotherName[] = _("BROTHER'S NAME?");
const u8 gText_BoxName[] = _("BOX NAME?");
const u8 gText_PkmnsNickname[] = _("{STR_VAR_1}'s nickname?");
const u8 gText_TellHimTheWords[] = _("Name the Pokémon.");
...
const u8 gText_DineHere[] = _("Dine here");
const u8 gText_ExplainBuffetRules[] = _("Explain rules");
const u8 gText_ComeBackLater[] = _("Come back later");
const u8 gText_Buy[] = _("Buy an outfit");
const u8 gText_Preview[] = _("Preview outfit");

const u8 gText_Decidueye[] = _("Decidueye");
const u8 gText_Blaziken[] = _("Blaziken");
const u8 gText_Empoleon[] = _("Empoleon");
const u8 gText_Chesnaught[] = _("Chesnaught");
const u8 gText_Incineroar[] = _("Incineroar");
