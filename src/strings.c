...
const u8 gText_NoMoreThanVar1Pkmn[] = _("No more than {STR_VAR_1} eggs\ncan be chosen.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnElevatedToLvVar2[] = _("{STR_VAR_1} grew stronger.");
...
const u8 gText_ChoosePokemon[] = _("Choose a battler.");
...
const u8 gText_DoWhatWithPokemon[] = _("Select an action.");
...
const u8 gText_NoPokemonForBattle[] = _("No eggs have been selected!");
...
const u8 gText_ChoosePokemonCancel[] = _("Choose battler or cancel.");
const u8 gText_ChoosePokemonConfirm[] = _("Choose eggs and confirm.");
...
const u8 gText_PkmnCantParticipate[] = _("That Pokémon is not an egg.{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnCantParticipate2[] = _("Yoshi must be the party leader.{PAUSE_UNTIL_PRESS}");
const u8 gText_CancelParticipation[] = _("Cancel participation?");
const u8 gText_CancelBattle[] = _("Cancel the selection?");
...
const u8 gText_EggWillTakeALongTime[] = _("It doesn't look like this\nEgg will hatch anytime soon.");
...
const u8 gText_HatchedFromEgg[] = _("Your egg(s) hatched into Pokémon!");
