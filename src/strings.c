...
const u8 gText_DexSearchColorCyan[] = _("Cyan");
...
{
    [POCKET_FREESPACE] =    gText_FreeSpace,
...
const u8 gText_XNatureProbablyMetAt[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1}{DYNAMIC 5} nature, probably\nmet {DYNAMIC 6} {DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1},\nat {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}.");
...
const u8 gText_FreeSpace[] = _("Free Space");
...
const u8 gText_TextSpeed[] = _("Time Format");
...
const u8 gText_TextSpeedSlow[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}12-hour");
const u8 gText_TextSpeedMid[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}24-hour");
...
const u8 gText_MenuPokenav[] = _("Journal");
...
const u8 gText_Display[] = _("DISPLAY");
