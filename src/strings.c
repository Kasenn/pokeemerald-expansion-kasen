...
const u8 gText_FollowMe[] = _("Set");
const u8 gText_UnfollowMe[] = _("Return");
const u8 gText_ResetFollow[] = _("Unset");
...
const u8 gText_FollowMon[] = _("{STR_VAR_1} is now\nyour preferred follower.{PAUSE_UNTIL_PRESS}");
const u8 gText_FollowMon0Hp[] = _("Cannot set a fainted Pokémon\nas your preferred follower!{PAUSE_UNTIL_PRESS}");
const u8 gText_UnfollowMon[] = _("Returned {STR_VAR_1} to its ball.{PAUSE_UNTIL_PRESS}");
