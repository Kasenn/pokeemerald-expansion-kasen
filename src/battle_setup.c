...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_ISAIAH] = REMATCH(TRAINER_BASALEK_MAY_ROWLET, TRAINER_BASALEK_BRENDAN_ROWLET, TRAINER_BASALEK_BRENDAN_TORCHIC, TRAINER_BASALEK_BRENDAN_PIPLUP, TRAINER_ISAIAH_5, ROUTE128),
