...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_ISABEL] = REMATCH(TRAINER_R15_TR9_BEAUTY, TRAINER_R15_TR10_FISHER, TRAINER_R15_TR11_CYCLINGM, TRAINER_R15_TR12_CYCLINGF, TRAINER_R15_TR13_COOLTRAINER, ROUTE110),
