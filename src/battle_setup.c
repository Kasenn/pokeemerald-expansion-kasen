...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_WINSTON] = REMATCH(TRAINER_R8_TR7_TRIATHLETE_M, TRAINER_R8_TR10_OLDCOUPLE, TRAINER_R8_TR11_BIRDKEEPER, TRAINER_SHORESLATE_NURSE, TRAINER_WINSTON_5, ROUTE104),
