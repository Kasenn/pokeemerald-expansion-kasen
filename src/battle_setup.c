...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_BROOKE] = REMATCH(TRAINER_WPV_TR5_BIRDKEEPER, TRAINER_WPV_TR12_BATTLEGIRL, TRAINER_WPV_TR13_BIRDKEEPER, TRAINER_WPV_TR14_SKYLA, TRAINER_BROOKE_5, ROUTE111),
