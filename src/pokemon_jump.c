...
static const struct PokemonJumpMons sPokeJumpMons[] =
{
    ...
    { .species = SPECIES_RATTATA_OUTSIDER,                     .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_RATICATE,                          .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_RATICATE_OUTSIDER,                    .jumpType = JUMP_TYPE_FAST, },
    ...
    { .species = SPECIES_MEOWTH_OUTSIDER,                      .jumpType = JUMP_TYPE_NORMAL, },
    ...
    { .species = SPECIES_WOOPER_OUTSIDER,                     .jumpType = JUMP_TYPE_SLOW, },
