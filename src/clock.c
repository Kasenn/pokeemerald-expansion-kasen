...
void UpdateVarsAndFlags(void)
{
    if (VarGet(VAR_DEBUG) == 0){
        ...
        PlantBerryTree(BERRY_TREE_ROUTE_110_YACHE_1, BERRY_ID_YACHE, BERRY_STAGE_BERRIES, FALSE);
        PlantBerryTree(BERRY_TREE_ROUTE_110_YACHE_2, BERRY_ID_YACHE, BERRY_STAGE_BERRIES, FALSE);
        VarSet(VAR_DEBUG, 1);
    }
