...
static void Task_HandleInfoScreenInput(u8 taskId)
{
    ...
    if ((JOY_NEW(DPAD_RIGHT) || (JOY_NEW(R_BUTTON) && gSaveBlock1Ptr->optionsButtonMode == OPTIONS_BUTTON_MODE_LR)))
    {
        sPokedexView->selectedScreen = AREA_SCREEN;
...
static void Task_HandleStatsScreenInput(u8 taskId)
{
    ...
    //Switch screens
    if ((JOY_NEW(DPAD_LEFT) || (JOY_NEW(L_BUTTON) && gSaveBlock1Ptr->optionsButtonMode == OPTIONS_BUTTON_MODE_LR)))
    {
...
static void Task_LoadSizeScreen(u8 taskId)
{
    ...
    case 3:
    {
        ...
        StringAppend(string, gText_Yoshi);
    ...
    case 4:
        ...
        break;
    case 5:
        spriteId = CreateSizeScreenTrainerPic(PlayerGenderToFrontTrainerPicId(FEMALE), 152, 56, 0);
        gSprites[spriteId].oam.affineMode = ST_OAM_AFFINE_NORMAL;
