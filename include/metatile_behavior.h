...
bool8 MetatileBehavior_IsBikeWarp(u8);
bool8 MetatileBehavior_IsRampNorth(u8);
bool8 MetatileBehavior_IsRampSouth(u8);
bool8 MetatileBehavior_IsRampEast(u8);
bool8 MetatileBehavior_IsRampWest(u8);
bool8 MetatileBehavior_IsJumpBikeHorizontal(u8);
bool8 MetatileBehavior_IsSnow(u8);
bool8 MetatileBehavior_IsNormalSnow(u8);
bool8 MetatileBehavior_IsMediumSnow(u8);
bool8 MetatileBehavior_IsDeepSnow(u8);
bool8 MetatileBehavior_IsSuperDeepSnow(u8);
bool8 MetatileBehavior_CreatesPileAroundPlayer(u8);
bool8 MetatileBehavior_IsMud(u8);
bool8 MetatileBehavior_IsMirror(u8);
bool8 MetatileBehavior_IsBoulderBlocking(u8);
...
bool8 MetatileBehavior_IsMudTreasure(u8);
bool8 MetatileBehavior_IsFishableLava(u8);
bool8 MetatileBehavior_IsNoFloor(u8);
bool8 MetatileBehavior_IsRunningDisallowed2(u8 metatileBehavior, u8 playerDir);
...
bool8 MetatileBehavior_IsBookcase2(u8);
