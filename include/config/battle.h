...
#define B_STEAL_WILD_ITEMS          GEN_7 // In Gen9+, Thief and Covet steal a wild pokemon's item and send it to the bag. In Gens2-8, the stolen item would be held by the Thief/Covet user.
...
#define B_FLAG_FORCE_DOUBLE_WILD    FLAG_SYSTEM_TOGGLE_DOUBLE_WILDS     // If this flag is set, all land and surfing wild battles will be double battles.
#define B_SMART_WILD_AI_FLAG        0     // If this flag is set, wild Pokémon will become smart, with all AI flags enabled.
#define B_FLAG_NO_CATCHING          FLAG_SYSTEM_NO_CATCHING     // If this flag is set, the ability to catch wild Pokémon is disabled.
