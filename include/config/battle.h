...
#define B_FLAG_FORCE_DOUBLE_WILD    0x27     // If this flag is set, all land and surfing wild battles will be double battles.
#define B_SMART_WILD_AI_FLAG        0     // If not 0, you can set this flag in a script to enable smart wild pokemon
#define B_FLAG_NO_BAG_USE           0x4BB     // If this flag is set, the ability to use the bag in battle is disabled.
#define B_FLAG_NO_CATCHING          0x25     // If this flag is set, the ability to catch wild Pokémon is disabled.
