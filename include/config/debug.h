...
// Battle Debug Menu
#define DEBUG_BATTLE_MENU               DEBUG_OVERWORLD_MENU    // If set to TRUE, enables a debug menu to use in battles by pressing the Select button.
...
// Pokémon Debug
#define DEBUG_POKEMON_MENU              DEBUG_OVERWORLD_MENU    // Enables a debug menu for pokemon sprites and icons, accessed by pressing SELECT in the summary screen.
