...
// Overworld Debug
#define DEBUG_OVERWORLD_MENU            TRUE // DISABLED_ON_RELEASE // Enables an overworld debug menu to change flags, variables, giving Pokémon and more, accessed by holding R and pressing START while in the overworld by default.
...
// Battle Debug Menu
#define DEBUG_BATTLE_MENU               DEBUG_OVERWORLD_IN_MENU    // If set to TRUE, enables a debug menu to use in battles by pressing the Select button.
...
// Pokémon Debug
#define DEBUG_POKEMON_SPRITE_VISUALIZER DEBUG_OVERWORLD_IN_MENU    // Enables a debug menu for Pokémon sprites and icons, accessed by pressing Select in the summary screen.
