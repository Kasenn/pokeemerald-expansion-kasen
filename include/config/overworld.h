...
#define OW_FLAG_NO_ENCOUNTER        FLAG_SYS_B_DASH  // If this flag is set, wild encounters will be disabled.
#define OW_FLAG_NO_TRAINER_SEE      FLAG_SYS_B_DASH  // If this flag is set, trainers will not battle the player unless they're talked to.
