...
#define INGAME_TRADE_MARSHTOMP 4
#define INGAME_TRADE_QUILLADIN 5
#define INGAME_TRADE_TORRACAT 6
#define INGAME_TRADE_GROWLITHE 7
#define INGAME_TRADE_VOLTORB 8
#define INGAME_TRADE_QWILFISH 9
#define INGAME_TRADE_SNEASEL 10
#define INGAME_TRADE_ZORUA 11
...
#define INGAME_TRADE_CHANSEY 16
