...
enum __attribute__((packed)) Item
{
    ...
    ITEM_DARKRANITE = 887,
    ITEM_ZERAORITE = 888,
    ITEM_RAICHUNITE_X = 889,
    ITEM_RAICHUNITE_Y = 890,
    ITEM_CHIMECHITE = 891,
    ITEM_ABSOLITE_Z = 892,
    ITEM_STARAPTITE = 893,
    ITEM_GARCHOMPITE_Z = 894,
    ITEM_LUCARIONITE_Z = 895,
    ITEM_GOLURKITE = 896,
    ITEM_MEOWSTICITE = 897,
    ITEM_CRABOMINITE = 898,
    ITEM_GOLISOPITE = 899,
    ITEM_MAGEARNITE = 900,
    ITEM_SCOVILLAINITE = 901,
    ITEM_BAXCALIBRITE = 902,
    ITEM_TATSUGIRINITE = 903,
    ITEM_GLIMMORANITE = 904,
