...
enum __attribute__((packed)) Item
{
    ...
    ITEM_LETTER = 732,
    ITEM_RESEARCH_PAPERS = 733,
    ITEM_DEVON_GOODS = ITEM_RESEARCH_PAPERS, // Pre-Gen VI name
    ITEM_GO_GOGGLES = 734,
    ...
    ITEM_HERBAL_MIX = 799,
    ITEM_HERBAL_MIX_QUEST = 800,
    ITEM_JASM_LETTER = 801,
    ITEM_COIN_PURSE = 802,
    ITEM_TALISMAN = 803,
    ITEM_LOST_KEY = 804,
    ITEM_STONE_SPHERE = 805,
    ITEM_TROPICAL_STONE = 806,
    ITEM_ANCIENT_STONE = 807,
    ITEM_LOST_MEMENTO = 808,
    ITEM_SPECIAL_SOUP = 809,
    ITEM_BLUK_BERRY = 810,
    ITEM_CURRY      = 811,
    ITEM_EMPOLEONITE = 812,
    ITEM_DECIDUEITE = 813,
    ITEM_INCINEROARITE  = 814,
    ITEM_CHESNAUGHTITE  = 815,
    ITEM_STEEL_SPHERE   = 816,

    ITEM_FAIRY_FEATHER = 817,
    ITEM_SYRUPY_APPLE = 818,
    ITEM_UNREMARKABLE_TEACUP = 819,
    ITEM_MASTERPIECE_TEACUP = 820,
    ITEM_CORNERSTONE_MASK = 821,
    ITEM_WELLSPRING_MASK = 822,
    ITEM_HEARTHFLAME_MASK = 823,
    ITEM_HEALTH_MOCHI = 824,
    ITEM_MUSCLE_MOCHI = 825,
    ITEM_RESIST_MOCHI = 826,
    ITEM_GENIUS_MOCHI = 827,
    ITEM_CLEVER_MOCHI = 828,
    ITEM_SWIFT_MOCHI = 829,
    ITEM_FRESH_START_MOCHI = 830,
    ITEM_GLIMMERING_CHARM = 831,
    ITEM_METAL_ALLOY = 832,
    ITEM_STELLAR_TERA_SHARD = 833,
    ITEM_JUBILIFE_MUFFIN = 834,
    ITEM_REMEDY = 835,
    ITEM_FINE_REMEDY = 836,
    ITEM_SUPERB_REMEDY = 837,
    ITEM_AUX_EVASION = 838,
    ITEM_AUX_GUARD = 839,
    ITEM_AUX_POWER = 840,
    ITEM_AUX_POWERGUARD = 841,
    ITEM_CHOICE_DUMPLING = 842,
    ITEM_SWAP_SNACK = 843,
    ITEM_TWICE_SPICED_RADISH = 844,
    ITEM_POKESHI_DOLL = 845,
    ITEM_ANTIVIRUS = 846,
    ITEM_PROCESSOR = 847,
    ITEM_PAINTBRUSH = 848,
    ITEM_HISTORY_BOOK = 849,
    ITEM_SAMPLE_BOX = 850,
    ITEM_TITANIUM_LINE = 851,
    ITEM_STRANGE_SEED = 852,
    ITEM_FERTILIZER = 853,
    ITEM_CHARGED_ORB = 854,
    ITEM_ARIADOSITE = 855,
    ITEM_DIRE_BALL = 856,

    ITEM_STRANGE_BALL = 857,
    ITEM_VERDANT_SPHERE = 858,
    ITEM_DISC_FRAGMENT  = 859,
    ITEM_BOND_ANKLET = 860,

    ITEM_CLEFABLITE = 861,
    ITEM_VICTREEBELITE = 862,
    ITEM_STARMINITE = 863,
    ITEM_DRAGONINITE = 864,
    ITEM_MEGANIUMITE = 865,
    ITEM_FERALIGITE = 866,
    ITEM_SKARMORITE = 867,
    ITEM_FROSLASSITE = 868,
    ITEM_EMBOARITE = 869,
    ITEM_EXCADRITE = 870,
    ITEM_SCOLIPITE = 871,
    ITEM_SCRAFTINITE = 872,
    ITEM_EELEKTROSSITE = 873,
    ITEM_CHANDELURITE = 874,
    ITEM_DELPHOXITE = 875,
    ITEM_GRENINJITE = 876,
    ITEM_PYROARITE = 877,
    ITEM_FLOETTITE = 878,
    ITEM_MALAMARITE = 879,
    ITEM_BARBARACITE = 880,
    ITEM_DRAGALGITE = 881,
    ITEM_HAWLUCHANITE = 882,
    ITEM_ZYGARDITE = 883,
    ITEM_DRAMPANITE = 884,
    ITEM_FALINKSITE = 885,

    ITEM_PIKACHU_BAIT   = 886,
    ITEM_PIKACHU_CAMERA = 887,

    // Legends Z-A: Mega Dimension DLC Mega Stones
    ITEM_HEATRANITE = 888,
    ITEM_DARKRANITE = 889,
    ITEM_ZERAORITE = 890,
    ITEM_RAICHUNITE_X = 891,
    ITEM_RAICHUNITE_Y = 892,
    ITEM_CHIMECHITE = 893,
    ITEM_ABSOLITE_Z = 894,
    ITEM_STARAPTITE = 895,
    ITEM_GARCHOMPITE_Z = 896,
    ITEM_LUCARIONITE_Z = 897,
    ITEM_GOLURKITE = 898,
    ITEM_MEOWSTICITE = 899,
    ITEM_CRABOMINITE = 900,
    ITEM_GOLISOPITE = 901,
    ITEM_MAGEARNITE = 902,
    ITEM_SCOVILLAINITE = 903,
    ITEM_BAXCALIBRITE = 904,
