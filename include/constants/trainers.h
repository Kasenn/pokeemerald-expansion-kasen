...
enum __attribute__((packed)) TrainerPicID
{
    ...
    TRAINER_PIC_FRONT_BROTHER,
    TRAINER_PIC_FRONT_DOME_ACE_TUCKER,
    TRAINER_PIC_FRONT_LEADER_AARON,
    ...
    TRAINER_PIC_FRONT_AFICIONADO_M,
    TRAINER_PIC_FRONT_AFICIONADO_F,
    TRAINER_PIC_FRONT_SCIENTIST,
    TRAINER_PIC_FRONT_CLAY,
    TRAINER_PIC_FRONT_ROCKER,
    TRAINER_PIC_FRONT_GEN4_SWIMMER_F,
    TRAINER_PIC_FRONT_KORRINA,
    TRAINER_PIC_FRONT_BW_ACE_TRAINER_F,
    TRAINER_PIC_FRONT_BW_ACE_TRAINER_M,
    TRAINER_PIC_FRONT_BRENDAN_ORAS,
    TRAINER_PIC_FRONT_MAY_ORAS,
    TRAINER_PIC_FRONT_ACEROLA,
    TRAINER_PIC_FRONT_JASMINE,
    TRAINER_PIC_FRONT_KASEN,
    TRAINER_PIC_FRONT_MINA,
    TRAINER_PIC_FRONT_DRAYDEN,
    TRAINER_PIC_FRONT_IRIS_CASUAL,
    TRAINER_PIC_FRONT_BW_ACE_TRAINER_F_SWIMMER,
    TRAINER_PIC_FRONT_PETREL,
    TRAINER_PIC_FRONT_BROCK,
    TRAINER_PIC_FRONT_BLAINE,
    TRAINER_PIC_FRONT_PRYCE,
    TRAINER_PIC_FRONT_SENIOR,
    TRAINER_PIC_FRONT_JUNIOR,
    TRAINER_PIC_FRONT_SWIMMERS,
    TRAINER_PIC_FRONT_BRENDAN_CONTEST,
    TRAINER_PIC_FRONT_MAY_CONTEST,
    ...
    TRAINER_PIC_BACK_BRENDAN_ORAS,
    TRAINER_PIC_BACK_MAY_ORAS,
    TRAINER_PIC_BACK_MAY_CONTEST,
    TRAINER_PIC_BACK_BRENDAN_CONTEST,
...
enum TrainerClassID
{
    ...
    TRAINER_CLASS_NURSE,
    TRAINER_CLASS_EV_NURSE,
    TRAINER_CLASS_GYMMEMBER,
    TRAINER_CLASS_GYMMEMBER_DOUBLE,
    TRAINER_CLASS_ELITE,
    TRAINER_CLASS_ENTHUSIAST,
    TRAINER_CLASS_PAINTER,
    TRAINER_CLASS_DANCER,
    TRAINER_CLASS_BROTHER,
    TRAINER_CLASS_SCIENTIST,
    TRAINER_CLASS_KASEN,
    TRAINER_CLASS_DARKNESS_ROCKET,
    TRAINER_CLASS_DARKNESS_ROCKET_ADMIN,
    TRAINER_CLASS_SWIMMERS,
