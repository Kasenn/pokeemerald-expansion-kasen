...
#define FACILITY_CLASS_BROTHER               0x77
#define FACILITY_CLASS_CONTEST_BRENDAN       0x78
#define FACILITY_CLASS_CONTEST_MAY           0x79
...
enum TrainerClassID
{
    ...
    TRAINER_CLASS_SENIOR,
    TRAINER_CLASS_JUNIOR,
