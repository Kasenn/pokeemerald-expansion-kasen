...
enum {
    ...
    MB_PUDDLE,
    MB_SHALLOW_WATER,
    MB_POINT_PLAYER_NORTH,
    MB_NO_SURFACING,
    MB_POINT_PLAYER_SOUTH,
    ...
    MB_JUMP_LEFTRIGHT,
    MB_JUMP_UPDOWN,
    MB_JUMP_BIKE_HORIZONTAL,
    MB_ROCK_WALL,
    MB_LONG_GRASS_SOUTH_EDGE_IMPASSABLE,
    MB_NO_FOLLOWER,
    MB_EASTWARD_CURRENT,
    MB_WESTWARD_CURRENT,
    ...
    MB_RAMP_WEST,
    MB_RAMP_SOUTH,
    MB_POINT_PLAYER_WEST,
    MB_POINT_PLAYER_EAST,
    MB_SIGNPOST,
    ...
    MB_FORTREE_BRIDGE,
    MB_SHALLOW_WATER_WITH_ENCOUNTERS,
