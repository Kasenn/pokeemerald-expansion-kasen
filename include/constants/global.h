...
#define TRAINER_CLASS_NAME_LENGTH 15
...
#define OPTIONS_NAMING_SCREEN_ABC 0
#define OPTIONS_NAMING_SCREEN_QWERTY 1

#define OPTIONS_12H_FORMAT 0
#define OPTIONS_24H_FORMAT 1
