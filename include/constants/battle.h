...
#define BATTLE_TYPE_BROTHER_BATTLE     (1 << 9) // Unused for now
...
#define BATTLE_TYPE_CATCH_TUTORIAL     (1 << 30)
...
#define B_WEATHER_PRIMAL_ANY    (B_WEATHER_RAIN_PRIMAL | B_WEATHER_SUN_PRIMAL)
...
#define STARTING_STATUS_DEFINITIONS(F) \
    ...
    F(STARTING_STATUS_ROCKY_TERRAIN,                  rockyTerrain,               (u32, 1)) /* Rocky Terrain (Permanent) */                \
