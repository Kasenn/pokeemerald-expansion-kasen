...
#define BATTLE_TYPE_JASMINE            (1 << 28)
#define BATTLE_TYPE_MON_WITHOUT_TRAINER    (1 << 29)
...
#define STATUS_FIELD_ROCKY_TERRAIN                  (1 << 12) 

#define STATUS_FIELD_TERRAIN_ANY        (STATUS_FIELD_GRASSY_TERRAIN | STATUS_FIELD_MISTY_TERRAIN | STATUS_FIELD_ELECTRIC_TERRAIN | STATUS_FIELD_PSYCHIC_TERRAIN | STATUS_FIELD_ROCKY_TERRAIN)
...
#define MOVE_RESULT_HIGH_EFFECTIVENESS     (MOVE_RESULT_SUPER_EFFECTIVE)
#define MOVE_RESULT_LOW_EFFECTIVENESS      (MOVE_RESULT_NOT_VERY_EFFECTIVE)
...
enum BattleEnvironments
{
    ...
    BATTLE_ENVIRONMENT_GYM_7,
    BATTLE_ENVIRONMENT_GYM_8,
...
#define STARTING_STATUS_DEFINITIONS(F) \
    ...
    F(STARTING_STATUS_ROCKY_TERRAIN,                  rockyTerrain,               (u32, 1))                                                \
