...
enum
{
    ...
    OBJ_EVENT_GFX_SLEEPING_YOSHI,
    OBJ_EVENT_GFX_KAMEK_INTRO,
    OBJ_EVENT_GFX_MACHOP2,
    OBJ_EVENT_GFX_MURKROW,
    OBJ_EVENT_GFX_DIGLETT,
    OBJ_EVENT_GFX_SANDSHREW,
    OBJ_EVENT_GFX_SKARMORY,
    OBJ_EVENT_GFX_SNORLAX2,
    OBJ_EVENT_GFX_PRIMEAPE,
    OBJ_EVENT_GFX_KAMEK,
    OBJ_EVENT_GFX_SUPERMUSHROOM,
    OBJ_EVENT_GFX_ITEMSPARKLE,
    OBJ_EVENT_GFX_HONCHKROW,
    OBJ_EVENT_GFX_GAMEOVER_1,
    OBJ_EVENT_GFX_GAMEOVER_2,
    OBJ_EVENT_GFX_GAMEOVER_3,
    OBJ_EVENT_GFX_GAMEOVER_4,
    OBJ_EVENT_GFX_GAMEOVER_5,
    OBJ_EVENT_GFX_PORTAL,
    OBJ_EVENT_GFX_KAMEK2,
    OBJ_EVENT_GFX_WATEREGG,
    OBJ_EVENT_GFX_WATEREGG_START_FROM_LEFT,
    OBJ_EVENT_GFX_WATEREGG_START_FROM_RIGHT,
    OBJ_EVENT_GFX_AWAKE_SNORLAX,
    OBJ_EVENT_GFX_GROUND_EGG,
    OBJ_EVENT_GFX_GEODUDE,
    OBJ_EVENT_GFX_ENDINGYOSHI,
    OBJ_EVENT_GFX_THEEND,
    NUM_OBJ_EVENT_GFX,
};
...
#define LOCALID_BERRY_BLENDER_PLAYER_END        244 // This will use 5 (MAX_RFU_PLAYERS) IDs ending at 240, i.e. 236-240
#define LOCALID_OW_ENCOUNTER_END                248 // This will use 4 (OWE_SPAWNS_MAX) IDs ending at 252, i.e. 249-252
#define OBJ_EVENT_ID_NPC_FOLLOWER               249
#define OBJ_EVENT_ID_FOLLOWER1                  250
#define OBJ_EVENT_ID_FOLLOWER2                  251
#define OBJ_EVENT_ID_FOLLOWER3                  252
#define OBJ_EVENT_ID_FOLLOWER4                  253
#define OBJ_EVENT_ID_FOLLOWER5                  254
...
#define OBJ_EVENT_PAL_TAG_SLEEPING_YOSHI          0x1134
#define OBJ_EVENT_PAL_TAG_KAMEK_INTRO             0x1135
#define OBJ_EVENT_PAL_TAG_MACHOP2                 0x1136
#define OBJ_EVENT_PAL_TAG_MURKROW                 0x1137
#define OBJ_EVENT_PAL_TAG_DIGLETT                 0x1138
#define OBJ_EVENT_PAL_TAG_SANDSHREW               0x1139
#define OBJ_EVENT_PAL_TAG_SKARMORY                0x113A
#define OBJ_EVENT_PAL_TAG_SNORLAX                 0x113B
#define OBJ_EVENT_PAL_TAG_PRIMEAPE                0x113C
#define OBJ_EVENT_PAL_TAG_KAMEK                   0x113D
#define OBJ_EVENT_PAL_TAG_SUPERMUSHROOM           0x113E
#define OBJ_EVENT_PAL_TAG_ITEMSPARKLE             0x113F
#define OBJ_EVENT_PAL_TAG_HONCHKROW               0x1140
#define OBJ_EVENT_PAL_TAG_GAMEOVER_1              0x1141
#define OBJ_EVENT_PAL_TAG_GAMEOVER_2              0x1142
...
#define OBJ_EVENT_PAL_TAG_KAMEK2                  0x1147
#define OBJ_EVENT_PAL_TAG_WATEREGG                0x1148
#define OBJ_EVENT_PAL_TAG_AWAKE_SNORLAX           0x1149
#define OBJ_EVENT_PAL_TAG_GROUND_EGG              0x114A
#define OBJ_EVENT_PAL_TAG_GEODUDE                 0x114B
#define OBJ_EVENT_PAL_TAG_ENDINGYOSHI             0x114C
#define OBJ_EVENT_PAL_TAG_THEEND                  0x114D
