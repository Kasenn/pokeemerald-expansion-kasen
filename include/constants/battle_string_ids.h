...
enum StringID
{
    ...
    STRINGID_PLAYERWHITEOUT_WILDMON,
    ...
    STRINGID_HELDITEMCURESTATUS_PARALYSIS,
    STRINGID_HELDITEMCURESTATUS_POISON,
    STRINGID_HELDITEMCURESTATUS_BURN,
    STRINGID_HELDITEMCURESTATUS_FREEZE,
    STRINGID_HELDITEMCURESTATUS_SLEEP,
    STRINGID_PKMNSTAYSAWAKE,
    STRINGID_HELDITEMCURESTATUS_CONFUSION,
    STRINGID_HELDITEMCURESTATUS_POISONCONFUSION,
    STRINGID_HELDITEMCURESTATUS_SLEEPCONFUSION,
    STRINGID_HELDITEMCURESTATUS_PARALYSISCONFUSION,
    STRINGID_HELDITEMCURESTATUS_BURNCONFUSION,
    STRINGID_HELDITEMCURESTATUS_FREEZECONFUSION,
    ...
    STRINGID_PKMNSXMADEYINEFFECTIVE2,
    ...
    STRINGID_PKMNFLEDUSINGSMOKEBALL,
    STRINGID_PKMNWASDRAGGEDOUT,
    STRINGID_HELDITEMCURESTATUS_NORMALIZE,
    ...
    STRINGID_PKMNSMISTWOREOFF,
    STRINGID_PKMNSSCREENWOREOFF,
    STRINGID_PKMNSSCREENWOREOFF2,
    ...
    STRINGID_TARGETIDENTIFIED,//wip
    STRINGID_PKMNSTOLEANDATEITEM,//wip
    ...
    STRINGID_SPIKESDISAPPEARED,
    STRINGID_TOXICSPIKESDISAPPEARED,
    STRINGID_TOXICSPIKESABSORBED,
    STRINGID_STEALTHROCKDISAPPEARED,
    STRINGID_BLEWAWAYSTICKYWEB,
    ...
    STRINGID_ITISWINDY,
    STRINGID_WEATHERWIND,
    STRINGID_PLAYERGOTMONEYANDBP,
    STRINGID_LAIDLOW,
    STRINGID_SLEEPBERRY,
    STRINGID_TARGETISHURTBYMEGAEXHAUSTION,
    STRINGID_FORESTCURSE,
    STRINGID_PLAYERWHITEOUT_NONE,
    STRINGID_NORUNNINGFROMGHOST,
    STRINGID_JASMINE_NOTGIVINGUPYET,
    STRINGID_JASMINE_AMPHY,
    STRINGID_HIVE_LEADER_GOT_HIT,
    STRINGID_ROCKYTERRAINDAMAGES,
    STRINGID_ROCKYTERRAINENDS,
    STRINGID_TERRAINBECOMESROCKY,
    STRINGID_ISCOVEREDWITHROCKS,
    STRINGID_ABILITYSHIELDPROTECTS,
    STRINGID_POKMNSXPREVENTSSWITCHING,
    STRINGID_ENIGMABERRY,
    STRINGID_BERRYSUFFIX,
    STRINGID_HAZARDSTR_1,
    STRINGID_HAZARDSTR_2,
    STRINGID_HAZARDSTR_3,
    STRINGID_HAZARDSTR_4,
    STRINGID_HAZARDSTR_5,
    STRINGID_HAZARDSTR_6,
    STRINGID_HAZARDSTR_7,
    STRINGID_HAZARDSTR_8,
    STRINGID_HAZARDSTR_9,
    STRINGID_DEF_CURE_POISON,
    STRINGID_DEF_CURE_SLEEP,
    STRINGID_DEF_CURE_FREEZE,
    STRINGID_DEF_CURE_PARALYSIS,
    STRINGID_DEF_CURE_CONFUSION,
    STRINGID_DEF_CURE_INFATUATION,
    STRINGID_DEF_CURE_BURN,
    STRINGID_DEF_CURE_TORMENT,
    STRINGID_ATK_CURE_POISON,
    STRINGID_ATK_CURE_SLEEP,
    STRINGID_ATK_CURE_FREEZE,
    STRINGID_ATK_CURE_PARALYSIS,
    STRINGID_ATK_CURE_CONFUSION,
    STRINGID_ATK_CURE_INFATUATION,
    STRINGID_ATK_CURE_BURN,
    STRINGID_ATK_CURE_TORMENT,
    STRINGID_SCR_CURE_POISON,
    STRINGID_SCR_CURE_SLEEP,
    STRINGID_SCR_CURE_FREEZE,
    STRINGID_SCR_CURE_PARALYSIS,
    STRINGID_SCR_CURE_CONFUSION,
    STRINGID_SCR_CURE_INFATUATION,
    STRINGID_SCR_CURE_BURN,
    STRINGID_SCR_CURE_TORMENT,
...
enum CureStatusBerryEffectStringID
{
    ...
    B_MSG_INFATUATION,
    B_MSG_TAUNT,
    B_MSG_POISONCONFUSION,
    B_MSG_SLEEPCONFUSION,
    B_MSG_PARALYSISCONFUSION,
    B_MSG_BURNCONFUSION,
    B_MSG_FREEZECONFUSION,
};
