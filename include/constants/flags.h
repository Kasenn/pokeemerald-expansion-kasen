...
#define FLAG_ZYGARDE_CELL_77			    (SPECIAL_FLAGS_END + 27) // up to here are finished
...
#define FLAG_WILD_TRAINER_MON			    (SPECIAL_FLAGS_END + 59)
#define FLAG_LATIAS_ROAMING			    (SPECIAL_FLAGS_END + 60)
#define FLAG_LATIOS_ROAMING			    (SPECIAL_FLAGS_END + 61)
#define FLAG_LANDMARK_BELLOWING_CAVE			    (SPECIAL_FLAGS_END + 62)
#define FLAG_LANDMARK_LEGENDARY_INSTITUTE			    (SPECIAL_FLAGS_END + 63)
#define FLAG_LANDMARK_SUNKEN_CAVERN			    (SPECIAL_FLAGS_END + 64)
#define FLAG_FRIGIDFRONTIER_ITEM1			    (SPECIAL_FLAGS_END + 65)
#define FLAG_FRIGIDFRONTIER_ITEM2			    (SPECIAL_FLAGS_END + 66)
#define FLAG_FRIGIDFRONTIER_ITEM3			    (SPECIAL_FLAGS_END + 67)
#define FLAG_FRIGIDFRONTIER_ITEM4			    (SPECIAL_FLAGS_END + 68)
#define FLAG_FRIGIDFRONTIER_ITEM5			    (SPECIAL_FLAGS_END + 69)
#define FLAG_FRIGIDFRONTIER_ITEM6			    (SPECIAL_FLAGS_END + 70)
#define FLAG_FRIGIDFRONTIERCAVE_HIDE_STEEL_SPHERE			    (SPECIAL_FLAGS_END + 71)
#define FLAG_FRIGIDFRONTIERCAVE_DOOR_OPEN			    (SPECIAL_FLAGS_END + 72)
#define FLAG_FRIGIDFRONTIERCAVE_VERDANT_SPHERE			    (SPECIAL_FLAGS_END + 73)
#define FLAG_PLACED_STONE_SPHERE			    (SPECIAL_FLAGS_END + 74)
#define FLAG_PLACED_STEEL_SPHERE			    (SPECIAL_FLAGS_END + 75)
#define FLAG_PLACED_VERDANT_SPHERE			    (SPECIAL_FLAGS_END + 76)
#define FLAG_DEFEATED_TERRAKION			    (SPECIAL_FLAGS_END + 77)
#define FLAG_DEFEATED_VIRIZION			    (SPECIAL_FLAGS_END + 78)
#define FLAG_DEFEATED_COBALION			    (SPECIAL_FLAGS_END + 79)
#define FLAG_HIDE_TERRAKION			    (SPECIAL_FLAGS_END + 80)
#define FLAG_HIDE_VIRIZION			    (SPECIAL_FLAGS_END + 81)
#define FLAG_HIDE_COBALION			    (SPECIAL_FLAGS_END + 82)
#define FLAG_LANDMARK_DESERT_CLIFFS			    (SPECIAL_FLAGS_END + 83)
#define FLAG_LANDMARK_HIDDEN_CLEARING			    (SPECIAL_FLAGS_END + 84)
#define FLAG_DESERT_CLIFFS_ITEM1			    (SPECIAL_FLAGS_END + 85)
#define FLAG_DESERT_CLIFFS_ITEM2			    (SPECIAL_FLAGS_END + 86)
#define FLAG_DESERT_CLIFFS_ITEM3			    (SPECIAL_FLAGS_END + 87)
