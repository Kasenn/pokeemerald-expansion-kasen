...
// VAR_HIDDEN_GROTTO_INTRO
#define STORY_HIDDEN_GROTTO_TALKED_TO_AIDE          1
#define STORY_HIDDEN_GROTTO_DIDNT_ENTER             2
#define STORY_HIDDEN_GROTTO_ENTERED_HIDDEN_GROTTO   3
#define STORY_HIDDEN_GROTTO_COMPLETE                4
