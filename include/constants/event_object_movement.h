...
#define MOVEMENT_TYPE_RUN_SEQUENCE_UP_RIGHT_DOWN_LEFT  0x51
#define MOVEMENT_TYPE_LEVITATE                         0x52
#define MOVEMENT_TYPE_FISH_DOWN                        0x53
#define MOVEMENT_TYPE_FOLLOW_PLAYER                    0x54
#define MOVEMENT_TYPE_WANDER_AROUND_SLOWER             0x55
#define MOVEMENT_TYPE_WANDER_AROUND_OWE                0x56
#define MOVEMENT_TYPE_CHASE_PLAYER_OWE                 0x57
#define MOVEMENT_TYPE_FLEE_PLAYER_OWE                  0x58
#define MOVEMENT_TYPE_WATCH_PLAYER_OWE                 0x59
#define MOVEMENT_TYPE_APPROACH_PLAYER_OWE              0x5A
#define MOVEMENT_TYPE_DESPAWN_OWE                      0x5B
...
#define MOVEMENT_ACTION_WALK_SUPER_SLOW_DOWN            0xB2
#define MOVEMENT_ACTION_WALK_SUPER_SLOW_UP              0xB3
#define MOVEMENT_ACTION_WALK_SUPER_SLOW_LEFT            0xB4
#define MOVEMENT_ACTION_WALK_SUPER_SLOW_RIGHT           0xB5
#define MOVEMENT_ACTION_RUN_DOWN_SUPER_SLOW             0xB6
#define MOVEMENT_ACTION_RUN_UP_SUPER_SLOW               0xB7
#define MOVEMENT_ACTION_RUN_LEFT_SUPER_SLOW             0xB8
#define MOVEMENT_ACTION_RUN_RIGHT_SUPER_SLOW            0xB9
#define MOVEMENT_ACTION_LATI_BALL                       0xBA

//fast diagonal movement
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_UP_LEFT      0xBB
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_UP_RIGHT     0xBC
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_DOWN_LEFT    0xBD
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_DOWN_RIGHT   0xBE
#define MOVEMENT_ACTION_SPIN_DOWN                       0xBF
#define MOVEMENT_ACTION_SPIN_UP                         0xC0
#define MOVEMENT_ACTION_SPIN_LEFT                       0xC1
#define MOVEMENT_ACTION_SPIN_RIGHT                      0xC2
...
#define ANIM_RUN_WEST  (ANIM_STD_COUNT + 2)
#define ANIM_RUN_EAST  (ANIM_STD_COUNT + 3)
#define ANIM_SKATE_SOUTH (ANIM_STD_COUNT + 4)
#define ANIM_SKATE_NORTH (ANIM_STD_COUNT + 5)
#define ANIM_SKATE_WEST (ANIM_STD_COUNT + 6)
#define ANIM_SKATE_EAST (ANIM_STD_COUNT + 7)
...
#define ANIM_LATI_BALL  (ANIM_STD_COUNT + 0)
