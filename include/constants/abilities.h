...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_SEARING_RAGE = 311,
    ABILITY_SPIKE_BODY = 312,
    ABILITY_DATA_BREACH = 313,
    ABILITY_HIVE_LEADER = 314,
    ABILITY_RAPID_FISTS = 315,
    ABILITY_FICKLE = 316,
    ABILITY_SNOW_WARNING_TEST = 317,
    ABILITY_PIERCING_DRILL = 318,
    ABILITY_DRAGONIZE = 319,
    ABILITY_EELEVATE = 320,
    ABILITY_314 = 321,
    ABILITY_MEGA_SOL = 322,
    ABILITY_FIRE_MANE = 323,
    ABILITY_317 = 324,
    ABILITY_SPICY_SPRAY = 325,
