...
void MovementType_FollowFollower1(struct Sprite *sprite);
void MovementType_FollowFollower2(struct Sprite *sprite);
void MovementType_FollowFollower3(struct Sprite *sprite);
void MovementType_FollowFollower4(struct Sprite *sprite);
...
u8 MovementType_FollowFollower1_Shadow(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_FollowFollower1_Active(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_FollowFollower2_Shadow(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_FollowFollower2_Active(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_FollowFollower3_Shadow(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_FollowFollower3_Active(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_FollowFollower4_Shadow(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_FollowFollower4_Active(struct ObjectEvent *objectEvent, struct Sprite *sprite);
...
bool8 FollowableFollowerMovement_Step(struct ObjectEvent *objectEvent, struct Sprite *sprite, enum Direction, bool8 tileCallback(u8));
