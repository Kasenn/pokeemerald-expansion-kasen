...
static const struct FollowerNPCSpriteGraphics gFollowerNPCAlternateSprites[] =
{
    ...
    {
        .normalId = OBJ_EVENT_GFX_MAY_ORAS_NORMAL,
        .machBikeId = OBJ_EVENT_GFX_MAY_ORAS_BIKE,
        .acroBikeId = OBJ_EVENT_GFX_MAY_ORAS_BIKE,
        .surfId = OBJ_EVENT_GFX_MAY_ORAS_RIDE,
        .underwaterId = OBJ_EVENT_GFX_MAY_ORAS_UNDERWATER,
        .hasRunningFrames = TRUE,
    },
    {
        .normalId = OBJ_EVENT_GFX_BRENDAN_ORAS_NORMAL,
        .machBikeId = OBJ_EVENT_GFX_BRENDAN_ORAS_BIKE,
        .acroBikeId = OBJ_EVENT_GFX_BRENDAN_ORAS_BIKE,
        .surfId = OBJ_EVENT_GFX_BRENDAN_ORAS_RIDE,
        .underwaterId = OBJ_EVENT_GFX_BRENDAN_UNDERWATER,
        .hasRunningFrames = TRUE,
    },
};
