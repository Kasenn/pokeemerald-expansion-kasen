...
static const struct FollowerNPCSpriteGraphics gFollowerNPCAlternateSprites[] =
{
    ...
    {
        .normalId = OBJ_EVENT_GFX_ORAS_MAY_NORMAL,
        .machBikeId = OBJ_EVENT_GFX_ORAS_MAY_BIKE,
        .acroBikeId = OBJ_EVENT_GFX_ORAS_MAY_BIKE,
        .surfId = OBJ_EVENT_GFX_ORAS_MAY_SURFING,
        .underwaterId = OBJ_EVENT_GFX_ORAS_MAY_UNDERWATER,
        .hasRunningFrames = TRUE,
    },
    {
        .normalId = OBJ_EVENT_GFX_ORAS_BRENDAN_NORMAL,
        .machBikeId = OBJ_EVENT_GFX_ORAS_BRENDAN_BIKE,
        .acroBikeId = OBJ_EVENT_GFX_ORAS_BRENDAN_BIKE,
        .surfId = OBJ_EVENT_GFX_ORAS_BRENDAN_SURFING,
        .underwaterId = OBJ_EVENT_GFX_BRENDAN_UNDERWATER,
        .hasRunningFrames = TRUE,
    },
};
