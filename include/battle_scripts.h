...
extern const u8 BattleScript_LocalBattleLost2[];
...
extern const u8 BattleScript_PrintCantRunFromGhost[];
...
extern const u8 BattleScript_ReflectLightScreenWoreOff[];
extern const u8 BattleScript_ReflectLightScreenWoreOffReturn[];
extern const u8 BattleScript_MistWoreOff[];
extern const u8 BattleScript_MistWoreOffReturn[];
...
extern const u8 BattleScript_HiveLeaderGotHit[];
extern const u8 BattleScript_HiveLeaderAttacks[];
...
extern const u8 BattleScript_BerrySleepHealEnd2[];
extern const u8 BattleScript_BerryConfuseHealRet[];
extern const u8 BattleScript_BerrySleepHealRet[];
...
extern const u8 BattleScript_RockyTerrainDamages[];
...
extern const u8 BattleScript_MegaExhaustion[];
...
extern const u8 BattleScript_EffectConfuseCamera[];
...
extern const u8 BattleScript_EffectSpeedDownCamera[];
extern const u8 BattleScript_EffectAccuracyDownCamera[];
...
extern const u8 BattleScript_EffectDisableCamera[];
...
extern const u8 BattleScript_WindStarter[];
...
extern const u8 BattleScript_EffectTauntCamera[];
...
extern const u8 BattleScript_EffectRockyTerrain[];
