...
extern const u8 BattleScript_PickupEggs[];
...
extern const u8 BattleScript_GotAwaySafelyEggs[];
extern const u8 BattleScript_WildMonFled[];
extern const u8 BattleScript_PrintCantRunFromTrainer[];
extern const u8 BattleScript_NoEggsToScoop[];
extern const u8 BattleScript_PrintFailedToRunString[];
extern const u8 BattleScript_ScoopUpEggs[];
extern const u8 BattleScript_CantScoopUpEggs[];
...
extern const u8 BattleScript_EndVortex[];
...
extern const u8 BattleScript_BigBossActivatesRevertStatsCureStatus[];
extern const u8 BattleScript_BigBossActivatesRevertStats[];
extern const u8 BattleScript_BigBossActivatesCureStatus[];
...
extern const u8 BattleScript_IllusionFade[];
