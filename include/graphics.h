...
extern const u32 gMonFrontPic_ExpBot[];
extern const u32 gMonFrontPic_HpBot[];
extern const u32 gMonFrontPic_AtkBot[];
extern const u32 gMonFrontPic_DefBot[];
extern const u32 gMonFrontPic_SpAtkBot[];
extern const u32 gMonFrontPic_SpDefBot[];
extern const u32 gMonFrontPic_SpeedBot[];
#endif
...
extern const u32 gMonBackPic_ExpBot[];
extern const u32 gMonBackPic_HpBot[];
extern const u32 gMonBackPic_AtkBot[];
extern const u32 gMonBackPic_DefBot[];
extern const u32 gMonBackPic_SpAtkBot[];
extern const u32 gMonBackPic_SpDefBot[];
extern const u32 gMonBackPic_SpeedBot[];
#endif
...
extern const u32 gMonPalette_ExpBot[];
extern const u32 gMonPalette_HpBot[];
extern const u32 gMonPalette_AtkBot[];
extern const u32 gMonPalette_DefBot[];
extern const u32 gMonPalette_SpAtkBot[];
extern const u32 gMonPalette_SpDefBot[];
extern const u32 gMonPalette_SpeedBot[];
#endif
...
extern const u32 gMonShinyPalette_ExpBot[];
extern const u32 gMonShinyPalette_HpBot[];
extern const u32 gMonShinyPalette_AtkBot[];
extern const u32 gMonShinyPalette_DefBot[];
extern const u32 gMonShinyPalette_SpAtkBot[];
extern const u32 gMonShinyPalette_SpDefBot[];
extern const u32 gMonShinyPalette_SpeedBot[];
#endif
...
extern const u8 gMonIcon_ExpBot[];
extern const u8 gMonIcon_HpBot[];
extern const u8 gMonIcon_AtkBot[];
extern const u8 gMonIcon_DefBot[];
extern const u8 gMonIcon_SpAtkBot[];
extern const u8 gMonIcon_SpDefBot[];
extern const u8 gMonIcon__SpeedBot[];
#endif
...
extern const u32 gTrainerFrontPic_BWAceTrainerF[];
extern const u32 gTrainerFrontPic_BWAceTrainerM[];
...
extern const u32 gTrainerPalette_Korrina[];
extern const u32 gTrainerPalette_BWAceTrainerF[];
extern const u32 gTrainerPalette_BWAceTrainerM[];
...
extern const u32 gItemIconPalette_HerbalMix[];
extern const u32 gItemIcon_HerbalMixQuest[];
extern const u32 gItemIconPalette_HerbalMixQuest[];
extern const u32 gItemIcon_JasmLetter[];
extern const u32 gItemIconPalette_JasmLetter[];
extern const u32 gItemIcon_CoinPurse[];
extern const u32 gItemIconPalette_CoinPurse[];
