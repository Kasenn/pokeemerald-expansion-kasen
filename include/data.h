...
struct Trainer
{
    ...
    const struct TrainerMon *partyGrass;
    const struct TrainerMon *partyFire;
    const struct TrainerMon *partyWater;
...
struct TrainerClass
{
    u8 name[TRAINER_CLASS_NAME_LENGTH];
    u8 money;
    u16 ball;
};
