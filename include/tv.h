...
void PutBattleUpdateOnTheAir(u8 opponentLinkPlayerId, umov move, u16 speciesPlayer, u16 speciesOpponent);
void BravoTrainerPokemonProfile_BeforeInterview1(umov move);
