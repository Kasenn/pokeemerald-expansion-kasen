...
extern const u8 gText_Birch_Brother[];
extern const u8 gText_Birch_WhatsYourName[];
extern const u8 gText_Birch_SoItsPlayer[];
extern const u8 gText_Birch_SoItsBrother[];
...
extern const u8 gText_DefaultNameBrother[];
...
extern const u8 gText_ShellBell[];
extern const u8 gText_MuscleBand[];
...
extern const u8 gText_WaterPulse6BP[];
extern const u8 gText_FuryCutter8BP[];
extern const u8 gText_MagicRoom8BP[];
extern const u8 gText_MudSlap8BP[];
extern const u8 gText_Swift8BP[];
extern const u8 gText_FoulPlay10BP[];
extern const u8 gText_GunkShot10BP[];
extern const u8 gText_Trick10BP[];
extern const u8 gText_ZenHeadbutt10BP[];
extern const u8 gText_AncientPower12BP[];
extern const u8 gText_OminousWind12BP[];
extern const u8 gText_ThunderWave6BP[];
...
extern const u8 gText_Tailwind10BP[];
extern const u8 gText_IronTail14BP[];
...
extern const u8 Sandstone_BPShop_LonelyMintDesc[];
extern const u8 Sandstone_BPShop_AdamantMintDesc[];
extern const u8 Sandstone_BPShop_NaughtyMintDesc[];
extern const u8 Sandstone_BPShop_BraveMintDesc[];
extern const u8 Sandstone_BPShop_BoldMintDesc[];
extern const u8 Sandstone_BPShop_ImpishMintDesc[];
extern const u8 Sandstone_BPShop_LaxMintDesc[];
extern const u8 Sandstone_BPShop_RelaxedMintDesc[];
extern const u8 Sandstone_BPShop_ModestMintDesc[];
extern const u8 Sandstone_BPShop_MildMintDesc[];
extern const u8 Sandstone_BPShop_RashMintDesc[];
extern const u8 Sandstone_BPShop_QuietMintDesc[];
extern const u8 Sandstone_BPShop_CalmMintDesc[];
extern const u8 Sandstone_BPShop_GentleMintDesc[];
extern const u8 Sandstone_BPShop_CarefulMintDesc[];
extern const u8 Sandstone_BPShop_SassyMintDesc[];
extern const u8 Sandstone_BPShop_TimidMintDesc[];
extern const u8 Sandstone_BPShop_HastyMintDesc[];
extern const u8 Sandstone_BPShop_JollyMintDesc[];
extern const u8 Sandstone_BPShop_NaiveMintDesc[];
extern const u8 Sandstone_BPShop_SeriousMintDesc[];
...
extern const u8 Coralgrove_BPShop_Text_SnoreDesc[];
extern const u8 Coralgrove_BPShop_Text_BindDesc[];
extern const u8 Coralgrove_BPShop_Text_ShockWaveDesc[];
extern const u8 Kaolisle_BPShop_Text_CovetDesc[];
extern const u8 Kaolisle_BPShop_Text_StringShotDesc[];
extern const u8 Sandstone_BPShop_Text_ThunderWaveDesc[];
extern const u8 Sandstone_BPShop_Text_FirePunchDesc[];
extern const u8 Sandstone_BPShop_Text_ThunderPunchDesc[];
extern const u8 Sandstone_BPShop_Text_IcePunchDesc[];
extern const u8 Sandstone_BPShop_Text_DrainPunchDesc[];
extern const u8 Sandstone_BPShop_Text_PsychUpDesc[];
extern const u8 Sandstone_BPShop_Text_PainSplitDesc[];
extern const u8 Sandstone_BPShop_Text_TailwindDesc[];
extern const u8 Sandstone_BPShop_Text_IronTailDesc[];
extern const u8 Sandstone_BPShop_Text_EndeavorDesc[];
extern const u8 Coralgrove_BPShop_Text_BugBiteDesc[];
extern const u8 Coralgrove_BPShop_Text_HealBellDesc[];
extern const u8 Coralgrove_BPShop_Text_ElectrowebDesc[];
extern const u8 Coralgrove_BPShop_Text_DefogDesc[];
extern const u8 Coralgrove_BPShop_Text_LowKickDesc[];
extern const u8 Kaolisle_BPShop_Text_UproarDesc[];
extern const u8 Coralgrove_BPShop_Text_HelpingHandDesc[];
extern const u8 Kaolisle_BPShop_Text_BlockDesc[];
extern const u8 Kaolisle_BPShop_Text_WorrySeedDesc[];
extern const u8 Kaolisle_BPShop_Text_SnatchDesc[];
extern const u8 Coralgrove_BPShop_Text_RecycleDesc[];
extern const u8 Kaolisle_BPShop_Text_LastResortDesc[];
...
extern const u8 Kaolisle_BPShop_Text_SynthesisDesc[];
extern const u8 Kaolisle_BPShop_Text_StealthRockDesc[];
extern const u8 Aldeleaf_BPShop_Text_IcyWindDesc[];
extern const u8 Shoreslate_BPShop_Text_WaterPulseDesc[];
extern const u8 Shoreslate_BPShop_Text_FuryCutterDesc[];
extern const u8 Shoreslate_BPShop_Text_MagicRoomDesc[];
extern const u8 Shoreslate_BPShop_Text_MudSlapDesc[];
extern const u8 Shoreslate_BPShop_Text_SwiftDesc[];
extern const u8 Shoreslate_BPShop_Text_FoulPlayDesc[];
extern const u8 Shoreslate_BPShop_Text_GunkShotDesc[];
extern const u8 Shoreslate_BPShop_Text_TrickDesc[];
extern const u8 Kaolisle_BPShop_Text_ZenHeadbuttDesc[];
extern const u8 Shoreslate_BPShop_Text_AncientPowerDesc[];
extern const u8 Shoreslate_BPShop_Text_OminousWindDesc[];
...
extern const u8 gText_SampleBox[];
...
extern const u8 gText_ZygardeCells[];
...
extern const u8 gText_FrustrationTM[];
extern const u8 gText_ReturnTM[];
extern const u8 gText_LightScreenTM[];
extern const u8 gText_ReflectTM[];
extern const u8 gText_SafeguardTM[];
extern const u8 gText_FocusPunchTm[];
extern const u8 gText_BlizzardTm[];
extern const u8 gText_HyperBeamTm[];
extern const u8 gText_SolarBeamTm[];
extern const u8 gText_ThunderTm[];
extern const u8 gText_FireBlastTm[];
extern const u8 gText_CalmMindTm[];
extern const u8 gText_RoarTm[];
extern const u8 gText_BulkUpTm[];
extern const u8 gText_ProtectTm[];
extern const u8 gText_AttractTm[];
...
extern const u8 gText_Castelia1[];
extern const u8 gText_Castelia4[];
...
extern const u8 gText_Decidueye[];
extern const u8 gText_Blaziken[];
extern const u8 gText_Empoleon[];
...
extern const u8 gText_BrotherName[];
