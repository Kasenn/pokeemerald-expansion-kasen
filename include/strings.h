...
extern const u8 gText_MovedFromFreeSpace[];
...
extern const u8 gText_PlayerCritFoe[];
extern const u8 gText_PlayerMissFoe[];
extern const u8 gText_FoeCritPlayer[];
extern const u8 gText_FoeMissPlayer[];
...
extern const u8 gText_NamingScreenKeyboard_numerals[];
extern const u8 gText_NamingScreenKeyboard_numeralsCaps[];
extern const u8 gText_NamingScreenKeyboard_qwerty[];
extern const u8 gText_NamingScreenKeyboard_asdfgh[];
extern const u8 gText_NamingScreenKeyboard_zxcvbn[];
extern const u8 gText_NamingScreenKeyboard_QWERTY[];
extern const u8 gText_NamingScreenKeyboard_ASDFGH[];
extern const u8 gText_NamingScreenKeyboard_ZXCVBN[];
